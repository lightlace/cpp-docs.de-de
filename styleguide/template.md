...
- **ms.devlang** definiert die Technologie. `dotnet`, `cpp`, `csharp`, `fsharp`, `vb` und `xml` sind einige der unterstützten Werte.
- **ms.assetid**: Dies ist die GUID des Artikels, die für interne Zwecke wie z.B. Business Intelligence (BI) verwendet wird. Wenn Sie eine neue Markdowndatei erstellen, rufen Sie eine GUID vom [Online GUID Generator](https://www.guidgenerator.com/) ab.
...
## <a name="markdown-editing-tools"></a>Markdownbearbeitungstools

Sie können [Visual Studio Code](https://code.visualstudio.com/) zum Bearbeiten von Markdowndokumenten verwenden. Visual Studio Code verfügt über viele hilfreiche Markdownerweiterungen, z. B.:

- [docs-markdown](https://marketplace.visualstudio.com/items?itemName=docsmsft.docs-markdown) von Microsoft
...
Vor und nach einer Überschrift sollte sich immer eine Leerzeile befinden (Überschriften der ersten Ebene ausgenommen).
...
*Kursiv*  
Verwenden Sie diesen Stil für vom Benutzer generierte Dateinamen, Ordner und Pfade (teilen Sie die Zeilen langer Elemente); neue Begriffe; Parameternamen; vom Benutzer eingegebene Werte und URLs (sofern nicht als Links gerendert, was der Standard ist).

**Fett**  
Verwenden Sie diesen Stil für die Elemente der Benutzeroberfläche und Schlüsselwörter der Programmiersprache.
...
### <a name="docs-links"></a>Docs-Links

Verwenden Sie zur Verknüpfung mit einer Datei in einem anderen Docs-Repository die zu docs.microsoft.com relative URL als Link. Das Suffix „.md“ wird nicht angegeben.

- Beispiel: [Dokumentation für die Universelle Windows-Plattform (UWP)](/windows/uwp)

### <a name="external-links"></a>Externe Links

Um auf eine externe Datei zu verlinken, verwenden Sie als Link die vollständige URL. Verwenden Sie die HTTPS-URL, falls zutreffend.

- Beispiel: [GitHub](https://www.github.com)

Wenn in einer Markdowndatei eine URL erscheint, wird diese in einen klickbaren Link verwandelt.

- Ein Beispiel: https://www.github.com
...
Listen sollten von leeren Zeilen umgeben sein.
...
Sie können ein [Markdowntool zum Generieren von Tabellen](https://www.tablesgenerator.com/markdown_tables) verwenden, um diese einfacher zu erstellen. Siehe auch [Markdownbearbeitungstools](#markdown-editing-tools).
...
Verwenden Sie Graviszeichen (&#96;) für `inline code`. Verwenden Sie Inlinecode für Befehlszeilenbefehle, Namen von Datenbanktabellen und -spalten sowie Sprachausdrücke und Funktionsnamen.
...
[![Larry Osterman – His one interaction with Bill Gates (over DOS networking stack) (Larry Osterman – seine eine Interaktion mit Bill Gates (über DOS-Netzwerkstapel))](https://sec.ch9.ms/ch9/caf5/f8657a22-5b83-47a3-9748-4c1be9fecaf5/Larry-Osterman-His-one-interaction-with-Bill-Gate_960.jpg)
...
[![On .NET 2/4/2016 – Scott Hunter (Über .NET 4.2.2016 – Scott Hunter)](https://img.youtube.com/vi/g2a4W6Q7aRw/0.jpg)
