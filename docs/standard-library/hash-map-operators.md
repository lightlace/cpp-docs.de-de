...
*linken* ein Objekt des Typs `hash_map`.

*richtige* ein Objekt des Typs `hash_map`.
...
*linken* ein Objekt des Typs `hash_multimap`.

*richtige* ein Objekt des Typs `hash_multimap`.
