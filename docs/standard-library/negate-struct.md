...
Das Ergebnis von `-Left`. Die spezialisierte Vorlage vervollkommnet die Weiterleitung des Ergebnisses, das den Typ aufweist, der vom unären zurückgegeben wird `operator-`.
