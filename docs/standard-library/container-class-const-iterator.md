---
title: Containerklasse::const_iterator | Microsoft-Dokumentation
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="container-classconstiterator"></a>Container-Klasse::const_iterator
> [!NOTE]
>  Dieses Thema ist in der Dokumentation zu Visual C++ als nicht funktionierendes Beispiel für Container, die in der C++-Standardbibliothek verwendet werden, aufgeführt. Weitere Informationen finden Sie unter [C++ Standard Library Containers (C++-Standardbibliothekcontainer)](../standard-library/stl-containers.md).  
 ...
 Beschreibt ein Objekt, das als konstanter Iterator für die gesteuerte Sequenz fungieren kann  
...
## <a name="remarks"></a>Hinweise  
 Sie wird hier als Synonym für den nicht angegebenen Typ **T6** beschrieben.  
