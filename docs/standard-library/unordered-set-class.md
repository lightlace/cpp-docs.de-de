...
|[unordered_set::allocator_type](#unordered_set__allocator_type)|Der Typ einer Zuweisung für die Speicherverwaltung.|  
|[unordered_set::const_iterator](#unordered_set__const_iterator)|Der Typ eines konstanten Iterators für die gesteuerte Sequenz.|  
|[unordered_set::const_local_iterator](#unordered_set__const_local_iterator)|Der Typ eines konstanten Bucketiterators für die gesteuerte Sequenz.|  
|[unordered_set::const_pointer](#unordered_set__const_pointer)|Der Typ eines konstanten Zeigers auf ein Element.|  
|[unordered_set::const_reference](#unordered_set__const_reference)|Der Typ eines konstanten Verweises auf ein Element.|  
|[unordered_set::difference_type](#unordered_set__difference_type)|Der Typ eines Abstands mit Vorzeichen zwischen zwei Elementen.|  
|[unordered_set::hasher](#unordered_set__hasher)|Der Typ der Hashfunktion.|  
|[unordered_set::iterator](#unordered_set__iterator)|Der Typ eines Iterators für die gesteuerte Sequenz.|  
|[unordered_set::key_equal](#unordered_set__key_equal)|Der Typ der Vergleichsfunktion.|  
|[unordered_set::key_type](#unordered_set__key_type)|Der Typ eines Sortierschlüssels.|  
|[unordered_set::local_iterator](#unordered_set__local_iterator)|Der Typ eines Bucketiterators für die gesteuerte Sequenz.|  
|[unordered_set::pointer](#unordered_set__pointer)|Der Typ eines Zeigers auf ein Element.|  
|[unordered_set::reference](#unordered_set__reference)|Der Typ eines Verweises auf ein Element.|  
|[unordered_set::size_type](#unordered_set__size_type)|Der Typ eines Abstands ohne Vorzeichen zwischen zwei Elementen.|  
|[unordered_set::value_type](#unordered_set__value_type)|Der Typ eines Elements.|  
  
|||  
|-|-|  
|Memberfunktion|Beschreibung|  
|[unordered_set::begin](#unordered_set__begin)|Legt den Anfang der kontrollierten Sequenz fest.|  
|[unordered_set::bucket](#unordered_set__bucket)|Ruft die Bucketnummer für einen Schlüsselwert ab.|  
|[unordered_set::bucket_count](#unordered_set__bucket_count)|Ruft die Anzahl von Buckets ab.|  
|[unordered_set::bucket_size](#unordered_set__bucket_size)|Ruft die Größe eines Buckets ab.|  
|[unordered_set::cbegin](#unordered_set__cbegin)|Legt den Anfang der kontrollierten Sequenz fest.|  
|[unordered_set::cend](#unordered_set__cend)|Legt das Ende der kontrollierten Sequenz fest.|  
|[unordered_set::clear](#unordered_set__clear)|Entfernt alle Elemente.|  
|[unordered_set::count](#unordered_set__count)|Sucht die Anzahl von Elementen, die einem angegebenen Schlüssel entsprechen.|  
|[unordered_set::emplace](#unordered_set__emplace)|Fügt ein Element hinzu, das direkt erstellt wird.|  
|[unordered_set::emplace_hint](#unordered_set__emplace_hint)|Fügt ein Element hinzu, das direkt mit Hinweis erstellt wird.|  
|[unordered_set::empty](#unordered_set__empty)|Testet, ob keine Elemente vorhanden sind.|  
|[unordered_set::end](#unordered_set__end)|Legt das Ende der kontrollierten Sequenz fest.|  
|[unordered_set::equal_range](#unordered_set__equal_range)|Sucht den Bereich, der einem angegebenen Schlüssel entspricht.|  
|[unordered_set::erase](#unordered_set__erase)|Entfernt Elemente an den angegebenen Positionen.|  
|[unordered_set::find](#unordered_set__find)|Sucht ein Element, das einem angegebenen Schlüssel entspricht.|  
|[unordered_set::get_allocator](#unordered_set__get_allocator)|Ruft das gespeicherte Zuweisungsobjekt ab.|  
|[unordered_set::hash_function](#unordered_set__hash_function)|Ruft das gespeicherte Hashfunktionsobjekt ab.|  
|[unordered_set::insert](#unordered_set__insert)|Fügt Elemente hinzu.|  
|[unordered_set::key_eq](#unordered_set__key_eq)|Ruft das gespeicherte Vergleichsfunktionsobjekt ab.|  
|[unordered_set::load_factor](#unordered_set__load_factor)|Zählt die durchschnittliche Anzahl von Elementen pro Bucket.|  
|[unordered_set::max_bucket_count](#unordered_set__max_bucket_count)|Ruft die maximale Anzahl von Buckets ab.|  
|[unordered_set::max_load_factor](#unordered_set__max_load_factor)|Ruft die maximale Anzahl von Elementen pro Bucket ab oder legt sie fest.|  
|[unordered_set::max_size](#unordered_set__max_size)|Ruft die maximale Größe der gesteuerten Sequenz ab.|  
|[unordered_set::rehash](#unordered_set__rehash)|Erstellt die Hashtabelle neu.|  
|[unordered_set::size](#unordered_set__size)|Ermittelt die Anzahl von Elementen.|  
|[unordered_set::swap](#unordered_set__swap)|Vertauscht den Inhalt von zwei Containern.|  
|[unordered_set::unordered_set](#unordered_set__unordered_set)|Erstellt ein container-Objekt.|  
  
|||  
|-|-|  
|Operatoren|Beschreibung|  
|[unordered_set::operator=](#unordered_set__operator_eq)|Kopiert eine Hashtabelle.|  
  
## <a name="remarks"></a>Hinweise  
 Das Objekt sortiert die Sequenz, die es steuert, indem es zwei gespeicherte Objekte aufruft, ein Vergleichsfunktionsobjekt des Typs [unordered_set::key_equal](#unordered_set__key_equal) und ein Hashfunktionsobjekt des Typs [unordered_set::hasher](#unordered_set__hasher). Sie greifen auf das zuerst gespeicherte Objekt zu, indem Sie die Memberfunktion [unordered_set::key_eq](#unordered_set__key_eq)`()` aufrufen. Auf das zweite gespeicherte Objekt greifen Sie zu, indem Sie die Memberfunktion [unordered_set::hash_function](#unordered_set__hash_function)`()` aufrufen. Insbesondere für alle Werte `X` und `Y` vom Typ `Key` gibt der Aufruf von `key_eq()(X, Y)` nur TRUE zurück, wenn die beiden Argumentwerte die entsprechende Reihenfolge aufweisen. Der Aufruf von `hash_function()(keyval)` ergibt eine Verteilung von Werten des Typs `size_t`. Im Gegensatz zur Vorlagenklasse [unordered_multiset-Klasse](../standard-library/unordered-multiset-class.md) stellt ein Objekt der Vorlagenklasse `unordered_set` sicher, dass `key_eq()(X, Y)` für zwei Elemente der gesteuerten Sequenz immer FALSE ist. (Schlüssel sind eindeutig.)  
  
 Das Objekt speichert auch einen Höchstlastfaktor, der die maximal erwünschte durchschnittliche Anzahl von Elementen pro Bucket angibt. Wenn durch Einfügen eines Elements der Wert [unordered_set::load_factor](#unordered_set__load_factor)`()` den Höchstlastfaktor überschreitet, erhöht der Container die Anzahl von Buckets und erstellt die Hashtabelle nach Bedarf neu.  
 ...
 Das Objekt belegt Speicher und gibt Speicher für die gesteuerte Sequenz durch ein gespeichertes Zuweisungsobjekt des Typs [unordered_set::allocator_type](#unordered_set__allocator_type) frei. Ein solches Zuweisungsobjekt muss die gleiche externe Schnittstelle wie ein Objekt der Vorlagenklasse `allocator` aufweisen. Beachten Sie, dass das gespeicherte Zuweisungsobjekt nicht kopiert wird, wenn das Containerobjekt zugewiesen wird.  
...
### <a name="remarks"></a>Hinweise  
 Der Typ stellt ein Synonym für den Vorlagenparameter `Alloc` dar.  
...
### <a name="remarks"></a>Hinweise  
 Die Memberfunktion gibt die Größe der Bucketnummer `nbucket` zurück.  
...
### <a name="return-value"></a>Rückgabewert  
 Ein `const`-Forward-Access-Iterator, der auf eine Position unmittelbar hinter dem Ende des Bereichs verweist.  
...
### <a name="remarks"></a>Hinweise  
 Die Memberfunktion ruft [unordered_set::erase](#unordered_set__erase)`(` [unordered_set::begin](#unordered_set__begin)`(),` [unordered_set::end](#unordered_set__end)`())` auf.  
...
### <a name="remarks"></a>Hinweise  
 Die Memberfunktion gibt die Anzahl von Elementen zurück, die sich in dem Bereich befinden, der durch [unordered_set::equal_range](#unordered_set__equal_range)`(keyval)` begrenzt ist.  
...
### <a name="remarks"></a>Hinweise  
 ...
 Ein Codebeispiel finden Sie unter [set::emplace](../standard-library/set-class.md#set__emplace).  
...
### <a name="remarks"></a>Hinweise  
 Die Memberfunktion gibt [unordered_set::equal_range](#unordered_set__equal_range)`(keyval).first` zurück.  
...
### <a name="remarks"></a>Hinweise  
 Der Typ stellt ein Synonym für den Vorlagenparameter `Hash` dar.  
...
|`ValTy`|Der Vorlagenparameter, mit dem der Argumenttyp angegeben wird, der vom unordered_set-Element verwendet werden kann, um ein Element von [value_type](../standard-library/map-class.md#map__value_type) zu erstellen und `Val` perfekt als Argument weiterzuleiten.|  
...
### <a name="return-value"></a>Rückgabewert  
 Die Einzelelement-Memberfunktionen (1) und (2) geben ein [Paar](../standard-library/pair-structure.md) zurück, dessen `bool`-Komponente TRUE lautet, wenn eine Einfügung durchgeführt wurde, und FALSE, wenn im unordered_set-Element bereits ein Element enthalten ist, dessen Schlüssel einen entsprechenden Wert in der Reihenfolge aufweist. Die Iteratorkomponente des Rückgabewertpaars zeigt auf das neu eingefügten Element, wenn die `bool`-Komponente TRUE lautet, oder auf das vorhandene Element, wenn die `bool`-Komponente FALSE lautet.  
...
### <a name="remarks"></a>Hinweise  
 ...
 Das [value_type](../standard-library/map-class.md#map__value_type)-Element eines Containers ist eine Typedef, die dem Container angehört, und beim Satz ist `unordered_set<V>::value_type` vom Typ `const V`.  
 ...
 Zum Einfügen eines lokal erstellten Elements. Das heißt, es wurden keine Kopier- oder Verschiebevorgänge ausgeführt. Informationen hierzu finden Sie unter [set::emplace](../standard-library/set-class.md#set__emplace) und [set::emplace_hint](../standard-library/set-class.md#set__emplace_hint).  
  
 Ein Codebeispiel finden Sie unter [set::insert](../standard-library/set-class.md#set__insert).  
...
### <a name="example"></a>Beispiel  
  Im Beispiel für [begin](../standard-library/set-class.md#set__begin) wird verdeutlicht, wie ein **Iterator** deklariert und verwendet wird.  
...
### <a name="remarks"></a>Hinweise  
 Der Typ stellt ein Synonym für den Vorlagenparameter `Pred` dar.  
...
### <a name="remarks"></a>Hinweise  
 Der Typ stellt ein Synonym für den Vorlagenparameter `Key` dar.  
...
### <a name="remarks"></a>Hinweise  
 Die Memberfunktion gibt `(float)`[unordered_set::size](#unordered_set__size)`() / (float)`[unordered_set::bucket_count](#unordered_set__bucket_count)`()` zurück, also die durchschnittliche Anzahl von Elementen pro Bucket.  
...
|-|-|  
|Parameter|Beschreibung|  
|` right`|Das [unordered_set](../standard-library/unordered-set-class.md), das in das `unordered_set` kopiert wird.|  
...
### <a name="remarks"></a>Hinweise  
 Die Memberfunktion tauscht die kontrollierten Sequenzen zwischen `*this` und `right` aus. Wenn [unordered_set::get_allocator](#unordered_set__get_allocator)`() == right.get_allocator()` gilt, führt sie dies in einer konstanten Zeit aus, sie löst eine Ausnahme nur als Reaktion auf das Kopieren des gespeicherter Merkmalobjekts vom Typ `Tr` aus, und sie macht keine Verweise, Zeiger oder Iteratoren ungültig, die Elemente in den beiden kontrollierten Sequenzen bestimmen. Andernfalls führt Sie proportional zur Anzahl der Elemente in den beiden kontrollierten Sequenzen eine Reihe von Elementzuweisungen und Konstruktoraufrufe aus.  
...
### <a name="remarks"></a>Hinweise  
 ...
 Das Vergleichsfunktionsobjekt ist das Argument `Comp`, falls es vorhanden ist. Andernfalls ist es `Comp()`.  
