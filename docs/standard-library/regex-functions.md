...
*BidIt*<br/> Der Itertatortyp für Teilübereinstimmungen. Allgemeine dies einer der Fällen `string::const_iterator`, `wstring::const_iterator`, `const char*` oder `const wchar_t*`.
