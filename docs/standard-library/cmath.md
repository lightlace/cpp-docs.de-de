...
Schließt den Standard-C-Bibliotheksheader \<math.h> ein und fügt die verknüpften Namen zum `std`-Namespace hinzu.
...
## <a name="mathematical-special-functions"></a>Mathematische spezielle Funktionen

### <a name="associated-laguerre-polynomials"></a>Zugeordnete Laguerre polynomials
...
### <a name="beta-function"></a>Beta-Funktion
