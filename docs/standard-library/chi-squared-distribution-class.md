---
title: chi_squared_distribution-Klasse | Microsoft-Dokumentation
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Ausführliche Informationen über die Chi-Quadrat-Verteilung finden Sie im Wolfram MathWorld-Artikel [Chi-Squared Distribution (Chi-Quadrat-Verteilung)](http://go.microsoft.com/fwlink/p/?linkid=400528).  
