...
*_Größe*\
Größe des Blocks, die bei beginnt *Ptr* , die keine nachweisbaren Zeiger enthält.
...
Wenn eine Ausnahme ausgelöst wird, können einige Objekte im Bereich in einem Zustand gültig, aber nicht festgelegt bleiben.
