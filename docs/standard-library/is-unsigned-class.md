...
Eine Instanz des typprädikats ist true, wenn der Typ *Ty* ein Integraltyp ohne Vorzeichen ist oder ein `cv-qualified` vorzeichenloser Ganzzahltyp ist, andernfalls er false enthält.
