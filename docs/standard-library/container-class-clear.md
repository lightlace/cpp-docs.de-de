---
title: Containerklasse::clear | Microsoft-Dokumentation
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
ms.locfileid: "33841823"
---
# <a name="container-classclear"></a>Container-Klasse::clear
...
Ruft [erase](../standard-library/container-class-erase.md)([begin](../standard-library/container-class-begin.md), [end](../standard-library/container-class-end.md)) auf.
