...
`left` Ein Objekt vom Typ `unordered_set`.

`right` Ein Objekt vom Typ `unordered_set`.
...
`left` Ein Objekt vom Typ `unordered_multiset`.

`right` Ein Objekt vom Typ `unordered_multiset`.
