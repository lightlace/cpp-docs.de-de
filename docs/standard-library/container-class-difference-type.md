---
title: 'Containerklasse:: difference_type | Microsoft-Dokumentation'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
Sie wird hier als Synonym für den nicht angegebenen Typ **T1** beschrieben (normalerweise **Alloc::difference_type**).
