...
Deklariert Vorwärtsverweise auf einigen Vorlagenklassen, die während der iostreams verwendet werden.  Alle diese Vorlagenklassen werden in anderen Standardkopfzeilen definiert.  Sie schließen diese Header explizit nur wenn Sie eine der Deklarationen benötigen, ohne dessen Definition ein.  
...
## Vorlagenklassen Vorwärtsdeklarationen\/  
