---
title: piecewise_constant_distribution-Klasse | Microsoft-Dokumentation
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
### <a name="parameters"></a>Parameter  
Siehe Konstruktorparameter für [piecewise_constant_distribution](#piecewise_constant_distribution__piecewise_constant_distribution).  
