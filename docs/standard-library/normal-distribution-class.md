---
title: "normal_distribution-Klasse | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
helpviewer_keywords: 
  ...
  - "normal_distribution-Klasse [TR1]"
...
|`normal_distribution::operator()`|`normal_distribution::stddev`|[normal\_distribution::param\_type](../Topic/normal_distribution::param_type.md)|  
 ...
 Ausführliche Informationen über die Normalverteilung finden Sie im Wolfram MathWorld\-Artikel [Normal Distribution](http://go.microsoft.com/fwlink/?LinkId=400924).  
