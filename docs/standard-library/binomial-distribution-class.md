---
title: "binomial_distribution-Klasse | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "binomial_distribution-Klasse"
  - "binomial_distribution-Klasse [TR1]"
...
|`binomial_distribution::operator()`|`binomial_distribution::p`|[binomial\_distribution::param\_type](../Topic/binomial_distribution::param_type.md)|  
 ...
 Ausführliche Informationen über die diskrete Wahrscheinlichkeitsfunktion zur Bernoulli\-Verteilung finden Sie im Wolfram MathWorld\-Artikel [Binomial Distribution](http://go.microsoft.com/fwlink/?LinkId=398469).  
