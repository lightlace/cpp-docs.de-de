...
`left` Ein Objekt vom Typ `unordered_map`.

`right` Ein Objekt vom Typ `unordered_map`.
...
`left` Ein Objekt vom Typ `unordered_multimap`.

`right` Ein Objekt vom Typ `unordered_multimap`.
