...
Eine Instanz des typprädikats ist "true",  wenn die typität ein Union- `cv-qualified` Typ oder ein Formular eines Union-Typs ist; andernfalls "false".
