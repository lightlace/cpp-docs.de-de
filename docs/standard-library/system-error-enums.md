---
title: '&lt;system_error&gt; enums | Microsoft-Dokumentation'
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
##  <a name="a-nameerrcenumerationa--errc-enumeration"></a><a name="errc_enumeration"></a> errc-Enumeration  
