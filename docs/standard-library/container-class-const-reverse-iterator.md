---
title: Containerklasse::const_reverse_iterator | Microsoft-Dokumentation
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
Beschreibt ein Objekt, das als konstanter Reverse-Iterator für die gesteuerte Sequenz fungieren kann
