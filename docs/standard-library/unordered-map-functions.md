...
### <a name="remarks"></a>Hinweise  
 Die Vorlagenfunktion führt `left.`[unordered_map::swap](../standard-library/unordered-map-class.md#unordered_map__swap)`(right)` aus.  
...
### <a name="remarks"></a>Hinweise  
 Die Vorlagenfunktion führt `left.`[unordered_multimap::swap](../standard-library/unordered-multimap-class.md#unordered_multimap__swap)`(right)` aus.  
