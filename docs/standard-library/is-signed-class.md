...
Eine Instanz des typprädikats ist "true",  wenn die typty ein ganzzahliger `cv-qualified` Typ mit Vorzeichen oder ein ganzzahliger Typ mit Vorzeichen ist; andernfalls "false".
