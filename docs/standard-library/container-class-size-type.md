---
title: Containerklasse::size_type | Microsoft-Dokumentation
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="container-classsizetype"></a>Container-Klasse::size_type
> [!NOTE]
>  Dieses Thema ist in der Dokumentation zu Visual C++ als nicht funktionierendes Beispiel für Container, die in der C++-Standardbibliothek verwendet werden, aufgeführt. Weitere Informationen finden Sie unter [C++ Standard Library Containers (C++-Standardbibliothekcontainer)](../standard-library/stl-containers.md).  
 ...
 Beschreibt ein Objekt, das die Länge einer beliebigen gesteuerten Sequenz darstellen kann  
...
## <a name="remarks"></a>Hinweise  
 Sie wird hier als Synonym für den nicht angegebenen Typ **T0** beschrieben (normalerweise **Alloc::size_type**).  
