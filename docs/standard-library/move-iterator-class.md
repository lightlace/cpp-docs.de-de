...
*richtige* der Iterator, der als den gespeicherten Iterator verwendet werden.
...
*_Off* ein Offset, der die aktuelle Position um die neue Position zu bestimmen, hinzugefügt.
