---
title: 'Datensatzfeldaustausch: Verwenden von RFX | Microsoft-Dokumentation'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
| Blättern Sie in das Recordset mit [CRecordset](../../mfc/reference/crecordset-class.md#move) oder einen Befehl im Menü oder Symbolleiste. | Aufrufe `DoFieldExchange` zum Übertragen von Daten aus der neuen aktuellen Datensatz, um den Felddatenmembern. |  
