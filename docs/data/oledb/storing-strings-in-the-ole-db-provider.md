...
ms.locfileid: "50053226"
---
# <a name="storing-strings-in-the-ole-db-provider"></a>Speichern von Zeichenfolgen im OLE DB-Anbieter

In CustomRS.h, erstellt der ATL-OLE DB-Anbieter-Assistent ein Standard-Benutzer-Eintrag namens `CWindowsFile`. Um die beiden Zeichenfolgen zu behandeln, ändern Sie entweder `CWindowsFile` oder Ihre eigenen Benutzerdatensatz hinzufügen, wie im folgenden Code gezeigt:
