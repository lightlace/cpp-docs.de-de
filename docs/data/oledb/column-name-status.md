...
ms.locfileid: "33092301"
---
# <a name="columnnamestatus"></a>COLUMN_NAME_STATUS
Stellt eine Bindung für das Rowset für die spezifische Spalte des Rowsets dar. Ähnlich wie [COLUMN_NAME](../../data/oledb/column-name.md), außer dass Sie dieses Makro nimmt auch Status in der Spalte.  
