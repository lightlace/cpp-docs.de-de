...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "CColumns-Typedefklassen"
  - "CColumnsInfo-Parameterklasse"
  - "CHARACTER_MAXIMUM_LENGTH"
  - "CHARACTER_OCTET_LENGTH"
  - "CHARACTER_SET_CATALOG"
  - "CHARACTER_SET_NAME"
...
Rufen Sie die typedef\-Klasse **CColumns** auf, um dessen Parameterklasse **CColumnsInfo** zu implementieren.  
...
## Hinweise  
 ...
 Diese Klasse identifiziert die Spalten in Tabellen, die im Katalog definiert werden, die für einen spezifischen Benutzer zugänglich sind.  
  
 Die folgende Tabelle zeigt die Klassendatenmember und ihre entsprechenden OLE DB Spalten auf.  Siehe [SPALTEN Rowset](https://msdn.microsoft.com/en-us/library/ms723052.aspx) in *der OLE DB\-Programmierreferenz* weitere Informationen über das Schema und Spalten.  
