...
ms.locfileid: "33090782"
---
# <a name="ccolumns-ccolumnsinfo"></a>CColumns, CColumnsInfo
Rufen Sie die-typedefklasse **CColumns** zum Implementieren der Parameterklasse **CColumnsInfo**.  
...
## <a name="remarks"></a>Hinweise  
 ...
 Diese Klasse identifiziert die Tabellenspalten im Katalog definierten Tabellen, die mit einem gegebenen Benutzer zugegriffen werden kann.  
  
 Die folgende Tabelle enthält die Datenmember der Klasse und ihre entsprechenden OLE DB-Spalten. Finden Sie unter [COLUMNS-Rowset](https://msdn.microsoft.com/en-us/library/ms723052.aspx) in der *OLE DB Programmer's Reference* für Weitere Informationen über das Schema und die Spalten.  
