...
Stellt eine Bindung im Rowset zur jeweiligen Spalte im Rowset dar.  Wie auch [COLUMN\_NAME](../../data/oledb/column-name.md), außer dass zu diesem Makro nimmt außerdem Genauigkeit und Skalierung.  
