...
#### <a name="parameters"></a>Parameter  
 Finden Sie unter [IDBProperties:: GetProperties](https://msdn.microsoft.com/library/ms714344.aspx) in die *OLE DB-Programmierreferenz*.  
...
#### <a name="parameters"></a>Parameter  
 Finden Sie unter [IDBProperties](https://msdn.microsoft.com/library/ms718175.aspx) in die *OLE DB-Programmierreferenz*.  
...
#### <a name="parameters"></a>Parameter  
 Finden Sie unter [IDBProperties:: SetProperties](https://msdn.microsoft.com/library/ms723049.aspx) in die *OLE DB-Programmierreferenz*.  
