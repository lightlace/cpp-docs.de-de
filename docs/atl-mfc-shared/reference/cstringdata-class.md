...
|[Lock](#lock)|Sperrt den Puffer mit den zugehörigen String-Objekt.|
|[Version](#release)|Gibt das angegebene String-Objekt frei.|
|[Unlock](#unlock)|Entsperrt den Puffer mit den zugehörigen String-Objekt.|
