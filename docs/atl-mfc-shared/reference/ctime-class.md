...
### <a name="parameters"></a>Parameter  
 ...
 In Visual C++-Version 6.0 und früher `time` wurde ein Wert von `time_t`. Visual C++ .NET und höher konvertiert eine `time_t` Parameter **__time64_t**.  
