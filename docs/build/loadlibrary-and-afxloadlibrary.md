...
> [!IMPORTANT]  
> Stellen Sie sicher, dass sämtliche DLLs der vollständige Pfadname angegeben. Das aktuelle Verzeichnis wird zuerst durchsucht, wenn Dateien geladen werden. Wenn Sie den Pfad für die Datei nicht qualifizieren, wird unter Umständen eine falsche Datei geladen. Um dies zu verhindern, dass eine andere Möglichkeit ist die Verwendung der [/DEPENDENTLOADFLAG](../build/reference/dependentloadflag.md) (Linkeroption).
