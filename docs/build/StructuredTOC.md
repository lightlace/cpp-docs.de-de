# [Konfigurieren von C++ 11-Programmen für Windows XP](configuring-programs-for-windows-xp.md)
...
## [Gewusst wie: Erstellen von COM-Komponenten ohne Registrierung](how-to-build-registration-free-com-components.md)
## [Gewusst wie: Erstellen von isolierten Anwendungen zur Verwendung von COM-Komponenten](how-to-build-isolated-applications-to-consume-com-components.md)
...
### [Gewusst wie: Einbetten eines Manifests in eine C/C++-Anwendung](how-to-embed-a-manifest-inside-a-c-cpp-application.md)
...
## [Gewusst wie: Konfigurieren von Visual C++-Projekten für 64-Bit-Zielplattformen](how-to-configure-visual-cpp-projects-to-target-64-bit-platforms.md)
## [Gewusst wie: Aktivieren eines 64-Bit-Visual C++-Toolsets auf der Befehlszeile](how-to-enable-a-64-bit-visual-cpp-toolset-on-the-command-line.md)
...
## [FAQ (Häufig gestellte Fragen) zu DLLs](dll-frequently-asked-questions.md)
### [Kann eine Multithreadanwendung auf eine MFC-DLL in unterschiedlichen Threads zugreifen?](can-a-multithreaded-application-access-an-mfc-dll-in-different-threads-q.md)
### [Kann eine MFC-DLL mehrere Threads erstellen?](can-an-mfc-dll-create-multiple-threads-q.md)
### [Gibt es MFC-Klassen oder -Funktionen, die nicht in einer MFC-DLL verwendet werden können?](are-there-any-mfc-classes-or-functions-that-cannot-be-used-in-an-mfc-dll-q.md)
### [Welche Optimierungstechniken sollten verwendet werden, um die Leistung der Clientanwendung beim Laden zu verbessern?](what-optimization-techniques-should-i-use.md)
### [In der regulären DLL tritt ein Speicherverlust auf, der Code scheint jedoch einwandfrei zu sein. Wie kann der Arbeitsspeicherverlust ermittelt werden?](memory-leak-in-my-dll.md)
...
## [Exemplarische Vorgehensweise: Kompilieren eines systemeigenen C++-Programms in der Befehlszeile](walkthrough-compiling-a-native-cpp-program-on-the-command-line.md)
...
##### [Vorrang bei Makrodefinitionen](precedence-in-macro-definitions.md)
...
#### [Direktiven für den Präprozessorlauf eines Makefiles](makefile-preprocessing-directives.md)
#### [Ausdrücke für den Präprozessorlauf eines Makefiles](expressions-in-makefile-preprocessing.md)
##### [Operatoren für den Präprozessorlauf eines Makefiles](makefile-preprocessing-operators.md)
##### [Ausführen eines Programms im Präprozessorlauf](executing-a-program-in-preprocessing.md)
...
### [Gewusst wie: Verwenden von Buildereignissen in MSBuild-Projekten](how-to-use-build-events-in-msbuild-projects.md)
### [Gewusst wie: Hinzufügen eines benutzerdefinierten Buildschritts zu MSBuild-Projekten](how-to-add-a-custom-build-step-to-msbuild-projects.md)
### [Gewusst wie: Hinzufügen von benutzerdefinierten Buildtools zu MSBuild-Projekten](how-to-add-custom-build-tools-to-msbuild-projects.md)
### [Gewusst wie: Integrieren von benutzerdefinierte Tools in die Projekteigenschaften](how-to-integrate-custom-tools-into-the-project-properties.md)
### [Gewusst wie: Ändern des Zielframeworks und des Plattformtoolsets](how-to-modify-the-target-framework-and-platform-toolset.md)
