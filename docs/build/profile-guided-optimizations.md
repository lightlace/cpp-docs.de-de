...
- Profilieren der Anwendung
   ...
   Während eines Testlaufs können Sie erzwingen, dass Schließen der aktuell geöffneten PGC-Datei und das Erstellen einer neuen PGC-Datei mit den [Pgosweep](pgosweep.md) -Dienstprogramms (z. B., wenn das Ende eines Testszenarios nicht mit Herunterfahren der Anwendung einhergeht).
