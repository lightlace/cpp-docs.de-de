...
## <a name="walkthrough-using-the-pgo-plug-in-to-optimize-an-app"></a>Exemplarische Vorgehensweise: Verwenden-Plug-In für die profilgesteuerte Optimierung, um eine App zu optimieren.
...
1. In der **Configuration Manager** Dialogfeld auf die **aktive Projektmappenkonfiguration** Dropdown-Schaltfläche, und wählen **Version**. Wählen Sie die Schaltfläche **Schließen** .
...
![Profilgesteuerte Optimierung im Leistungs- und Diagnosehub](media/pgofig0hub.png "PGO im Leistungs- und Diagnosehub")
...
![PGO-Einführungsseite](media/pgofig1start.png "PGO-Einführungsseite")
...
![PGO-instrumentierungsseite](media/pgofig2instrument.png "PGO-instrumentierungsseite")

In der **Instrumentation** Abschnitt, die Sie verwenden die **Training wird anfänglich aktiviert** Option zu entscheiden, ob die Anlaufphase der app als Teil des Trainings enthalten. Wenn diese Option nicht ausgewählt ist, werden die Trainingsdaten nicht in einer ausgeführten instrumentierten App aufgezeichnet, bis Sie das Training explizit aktivieren.
...
![PGO-Seite über instrumentierte Builds](media/pgofig3build.PNG "PGO-Seite über instrumentierte Builds")
...
![PGO-Trainingsseite](media/pgofig4training.PNG "PGO-Trainingsseite")
...
![PGO-Analyseseite](media/pgofig5analyze.png "PGO-Analyseseite")
...
![PGO-Datendatei im Projektmappen-Explorer](media/pgofig6data.png "PGO-Datendatei im Projektmappen-Explorer")
...
![PGO-Ausgabe Diagnose](media/pgofig7diagnostics.png "PGO Ausgabe der Diagnose")
