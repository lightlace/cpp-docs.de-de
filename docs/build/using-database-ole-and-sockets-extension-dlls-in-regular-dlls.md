---
title: Verwenden Datenbank-, OLE- und Sockets-MFC-Erweiterungs-DLLs in regulären MFC-DLLs | Microsoft-Dokumentation
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
- Wenn in der MFC-Erweiterungs-DLL, die Nachricht definiert ein Objekt eines Typs der Klasse zu deserialisieren versucht, "Warnung: CYourClass kann nicht geladen werden, aus dem Archiv. Klasse nicht definiert". wird im Debugfenster ABLAUFVERFOLGUNG und das Objekt kann nicht serialisiert.
