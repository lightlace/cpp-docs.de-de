...
ms.locfileid: "32368056"
---
# <a name="importing-into-an-application"></a>Importieren in eine Anwendung
Sie können Funktionen in einer Anwendung, die über zwei Methoden importieren:  
  
-   Verwenden Sie die Schlüsselwörter **von "__declspec(dllimport)" "** in einer Funktionsdefinition in die Hauptassembly der Anwendung  
