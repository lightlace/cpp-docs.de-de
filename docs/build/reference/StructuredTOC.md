...
#### [/EP (Vorverarbeitung an "stdout" ohne #line-Direktiven)](ep-preprocess-to-stdout-without-hash-line-directives.md)
...
##### [/Oi (Systeminterne Funktionen erstellen)](oi-generate-intrinsic-functions.md)
...
#### [/w, /Wn, /WX, /Wall, /wln, /wdn, /wen, /won (Warnstufe)](compiler-option-warning-level.md)
...
##### [/Yc (Datei der vorkompilierten Header erstellen)](yc-create-precompiled-header-file.md)
...
##### [/Zc:wchar_t (wchar_t ist der systemeigene Typ)](zc-wchar-t-wchar-t-is-native-type.md)
##### [/Zc:auto (Variablentyp ableiten)](zc-auto-deduce-variable-type.md)
##### [/Zc:trigraphs (Trigraphen-Ersetzung)](zc-trigraphs-trigraphs-substitution.md)
...
### [LINK-Optionen, die über den Compiler gesteuert werden](compiler-controlled-link-options.md)
...
### [/VERBOSE (Statusmeldungen ausgeben)](verbose-print-progress-messages.md)
...
## [Gewusst wie: Erstellen eines Releasebuilds](how-to-create-a-release-build.md)
...
### [Gewusst wie: Debuggen eines Releasebuilds](how-to-debug-a-release-build.md)
...
#### [Gewusst wie: Festlegen der LIB.EXE-Optionen in der Visual Studio-Entwicklungsumgebung](how-to-set-lib-exe-options-in-the-visual-studio-development-environment.md)
...
## [Profilgesteuerte Optimierungen (PGO)](profile-guided-optimizations.md)
...
### [Tools für die profilgesteuerte Optimierung (PGO)](tools-for-manual-profile-guided-optimization.md)
...
### [Gewusst wie: Zusammenführen mehrerer PGO-Profile in einem einzigen Profil](how-to-merge-multiple-pgo-profiles-into-a-single-profile.md)
