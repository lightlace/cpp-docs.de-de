---
title: Tool zum Generieren von XML-Daten (Eigenschaftenseite)
ms.date: 11/04/2016
f1_keywords:
...
Informationen zum Zugreifen auf die **Tool zum Generieren von XML-Daten** auf der Seite finden Sie unter [Festlegen von C++-Compiler und die Build-Eigenschaften in Visual Studio](../working-with-project-properties.md).
