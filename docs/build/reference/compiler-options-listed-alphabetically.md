...
|[\/Tc](../../build/reference/tc-tp-tc-tp-specify-source-file-type.md)<br /><br /> [\/TC](../../build/reference/tc-tp-tc-tp-specify-source-file-type.md)|Gibt eine C\-Quelldatei an.|  
|[\/Tp](../../build/reference/tc-tp-tc-tp-specify-source-file-type.md)<br /><br /> [\/TP](../../build/reference/tc-tp-tc-tp-specify-source-file-type.md)|Gibt eine C\+\+\-Quelldatei an.|  
...
|[\/Zc](../../build/reference/zc-conformance.md)|Legt Standardverhalten unter [\/Ze](../../build/reference/za-ze-disable-language-extensions.md) fest.[\/Za, \/Ze \(Spracherweiterungen deaktivieren\)](../../build/reference/za-ze-disable-language-extensions.md)|  
