...
#### [-await (Aktivieren der Coroutineunterstützung)](await-enable-coroutine-support.md)
...
#### [-constexpr (Steuerung der constexpr-Evaluation)](constexpr-control-constexpr-evaluation.md)
...
##### [-Zc:sizedDealloc (Zuordnungsaufhebungsfunktionen globaler Größe aktivieren)](zc-sizeddealloc-enable-global-sized-dealloc-functions.md)
...
##### [-Zc:threadSafeInit (Initialisierung threadsicherer lokaler statischer Elemente)](zc-threadsafeinit-thread-safe-local-static-initialization.md)
##### [-Zc:throwingNew (Annahme von new-Auslösungen des Operators)](zc-throwingnew-assume-operator-new-throws.md)
...
### [-NATVIS (Natvis zu PDB hinzufügen)](natvis-add-natvis-to-pdb.md)
