...
In der Standardeinstellung **/OPT: ICF** vom Linker aktiviert ist, es sei denn, **NOICF** oder [/DEBUG](debug-generate-debug-info.md) angegeben ist. Um diesen Standardwert überschreiben, und verhindern, dass COMDATs im Programm gefaltet wird, geben Sie **NOICF**.
...
Können Sie die [/VERBOSE](verbose-print-progress-messages.md) Linkeroption, um die Funktionen, die entfernt werden, finden Sie unter **/OPT: REF** sowie Funktionen, die von gefalteten **/OPT: ICF**.
