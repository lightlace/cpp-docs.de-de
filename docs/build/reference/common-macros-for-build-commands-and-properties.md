...
|**$ (PublishDir)**|Der Ausgabe Speicherort für das Veröffentlichungsziel. schließt den nachfolgenden umgekehrten Schrägstrich '\\' ein. Der Standardwert ist der **$ (OutDir)-app. Publish\\** -Ordner.|
