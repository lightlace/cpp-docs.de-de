...
helpviewer_keywords: 
  ...
  - "_lsearch-Funktion"
  - "Hintergrundaufgaben"
  - "Bewährte Methoden, Zeitkritischer Code"
  - "bsearch-Funktion"
  - "cache [C++], Treffer und fehlgeschlagene Zugriffe"
  - "Taktzyklusverluste"
  - "Code, Zeitkritisch"
  - "Ausführung, Geschwindigkeitsverbesserungen"
  - "Heapzuordnung, Zeitkritischer Code – Leistung"
  - "Lineare Suche – Leistung"
  - "Listen, Sortieren"
  - "Lokaler Heap – Leistung"
  - "Speicher [C++], Überwachen der Verwendung"
  - "MFC [C++], Leistung"
  - "Optimierung [C++], Zeitkritischer Code"
  - "Seitenfehler"
  - "Leistung [C++], Zeitkritischer Code"
  - "Programme [C++], Leistung"
  - "qsort-Funktion"
  - "Suchen [C++], Verbessern der Leistung"
  - "Sortierroutinen"
  - "Sortieren von Daten, Verbessern der Leistung"
  - "Standardsortierroutinen"
  - "Threading [C++], Hintergrundaufgaben"
...
-   Verzögern der Sortierung bis zu einer Zeit, die für die Leistung nicht kritisch ist  
...
##  <a name="_core_heaps"></a> Heaps  
 ...
 Messen Sie Ihre Heaps, damit Sie jede Zuordnung im Heap erklären können.  Verwenden Sie die [Debugheaproutinen](../Topic/CRT%20Debug%20Heap%20Details.md) der C\-Laufzeit, um einen Prüfpunkt und Dump für Ihren Heap festzulegen.  Sie können die Ausgabe in ein Tabellenkalkulationsprogramm wie Microsoft Excel lesen und Pivottables verwenden, um die Ergebnisse anzuzeigen.  Beachten Sie die Gesamtanzahl, die Größe und die Verteilung der Zuordnungen.  Vergleichen Sie diese mit der Größe der Workingsets.  Sehen Sie sich auch das Clustering der Objekte verwandter Größe an.  
...
-   Zum Festlegen der oberen und unteren Grenzen für das Workingset verwenden Sie [SetProcessWorkingSetSize](http://msdn.microsoft.com/library/windows/desktop/ms683226.aspx).  
  
-   Zum Abrufen der oberen und unteren Grenzen für das Workingset verwenden Sie [GetProcessWorkingSetSize](http://msdn.microsoft.com/library/windows/desktop/ms686234.aspx).  
