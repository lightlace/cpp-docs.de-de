...
Standardmäßig wird eine Assembly erstellt. Sie können auch die [/ln (Create MSIL Module)](ln-create-msil-module.md) -Compileroption verwenden, um ein Modul zu erstellen.
