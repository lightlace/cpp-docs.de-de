...
Der Kosinus von *z*im Bogenmaße.

## <a name="remarks"></a>Hinweise

Da C++ das überladen zulässt, können Sie über Ladungen von **CCOs** aufzurufen, die **_Fcomplex** -und **_Lcomplex** -Werte verwenden und zurückgeben. In einem C-Programm nimmt **CCOs** immer einen **_Dcomplex** -Wert an und gibt diesen zurück.
