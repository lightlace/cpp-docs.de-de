...
> [!IMPORTANT]
>  `_mbsdup` kann nicht in Anwendungen verwendet werden, die in der Windows-Runtime ausgeführt. Weitere Informationen finden Sie unter [CRT-Funktionen, die in universellen Windows-Plattform-apps nicht unterstützt](../../cppcx/crt-functions-not-supported-in-universal-windows-platform-apps.md).  
