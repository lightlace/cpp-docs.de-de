...
> [!IMPORTANT]
>  `_mbsdup`kann nicht in Anwendungen verwendet werden, die in der Windows-Runtime ausgeführt. Weitere Informationen finden Sie unter                  [In /ZW nicht unterstützte CRT-Funktionen](http://msdn.microsoft.com/library/windows/apps/jj606124.aspx).  
