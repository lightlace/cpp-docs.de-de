...
## <a name="remarks"></a>Hinweise  
 Die `puts`-Funktion schreibt `str` in den Standardausgabestream **stdout** und ersetzt das abschließende NULL-Zeichen ('\0') im Ausgabestream durch ein Zeilenumbruchzeichen ('\n').  
