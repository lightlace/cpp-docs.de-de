...
Jede Funktion gibt die **__int64** Wert erzeugt, indem die Eingabezeichen als Zahl interpretiert. Der Rückgabewert ist 0 für **_atoi64** , wenn die Eingabe in einen Wert dieses Typs konvertiert werden kann.

Bei einem Überlauf mit großen positiven ganzzahligen Werten **_atoi64** gibt **I64_MAX** und **I64_MIN** bei einem Überlauf mit großen negativen ganzzahligen Werten.
...
Die *str* Argument **_atoi64** weist folgende Form:
...
Dieses Programm zeigt, wie als Zeichenfolgen gespeicherte Zahlen in numerische Werte mit konvertiert werden können die **_atoi64** Funktionen.
