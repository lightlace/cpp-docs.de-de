...
Öffnet eine Datei.  Diese Funktionen sind veraltet, da sichere Versionen verfügbar sind, siehe [\_sopen\_s, \_wsopen\_s](../../c-runtime-library/reference/sopen-s-wsopen-s.md).  
...
|`_topen`|`_open`|`_open`|`_wopen`|  
 ...
 `_O_CREAT` &#124; `_O_EXCL`  
 Gibt einen Fehlerwert zurück, wenn die von `filename` angegebene Datei vorhanden ist.  Gilt nur in Verwendung mit `_O_CREAT`.  
