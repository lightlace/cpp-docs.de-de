...
helpviewer_keywords: 
  ...
  - "_fgetwc_nolock-Funktion"
  - "Zeichen, Lesen"
  - "fgetc_nolock-Funktion"
  - "fgettc_nolock-Funktion"
  - "fgetwc_nolock-Funktion"
...
## Rückgabewert  
 Siehe [fgetc, fgetwc](../../c-runtime-library/reference/fgetc-fgetwc.md).  
...
## Eingabe: crt\_fgetc\_nolock.txt  
