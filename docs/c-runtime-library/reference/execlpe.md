---
title: execlpe | Microsoft-Dokumentation
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Diese POSIX-Funktion ist veraltet. Verwenden Sie stattdessen das ISO C++-konforme [_execlpe](../../c-runtime-library/reference/execlpe-wexeclpe.md).  
