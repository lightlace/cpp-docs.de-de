 ...
 **Microsoft\-spezifisch**  
 ...
 Weitere Informationen zum CRT\-Debuggen finden Sie unter [CRT\-Debugverfahren](../Topic/CRT%20Debugging%20Techniques.md).  
...
```  
  ...
  **Datei konnte nicht geöffnet werden: Die Datei oder das Verzeichnis sind nicht vorhanden**   
