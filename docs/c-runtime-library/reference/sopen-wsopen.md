...
Die **_sopen** -Funktion öffnet die durch *filename* angegebene Datei und bereitet die Datei für das gemeinsame lesen oder schreiben vor, wie von *Oflag* und *shflag*definiert. **_wsopen** ist eine breit Zeichen Version von **_sopen**. Das *filename* -Argument von **_wsopen** ist eine Zeichenfolge mit breit Zeichen. **_wsopen** und **_sopen** Verhalten sich andernfalls identisch.
