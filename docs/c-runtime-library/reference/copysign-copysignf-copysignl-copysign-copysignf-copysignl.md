...
Die **Copysign** Funktionen geben einen Gleitkommawert, der die Größe der kombiniert zurück *x* und das Vorzeichen des *y*. Es gibt keine Fehlerrückgabe.
