...
|`_tstat64i32`|`_stat64i32`|`_stat64i32`|`_wstat64i32`|  
 ...
 Wenn `path` auf ein Gerät verweist, haben die Felder `st_size`, die verschiedenen Zeitfelder, `st_dev`und `st_rdev` in der `_stat` -Struktur keine Bedeutung. Da „STAT.H“ den [_dev_t](../../c-runtime-library/standard-types.md)-Typ verwendet, der in „TYPES.H“ definiert ist, müssen Sie „TYPES.H“ vor „STAT.H“ in Ihrem Code einschließen.  
