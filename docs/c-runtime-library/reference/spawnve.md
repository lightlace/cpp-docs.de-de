---
title: spawnve | Microsoft-Dokumentation
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Diese POSIX-Funktion ist veraltet. Verwenden Sie stattdessen das ISO C++-konforme [_spawnve](../../c-runtime-library/reference/spawnve-wspawnve.md).  
