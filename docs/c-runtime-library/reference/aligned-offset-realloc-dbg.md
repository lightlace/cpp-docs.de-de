...
*filename*<br/>
Zeiger auf den Namen der Quelldatei, die angeforderte der **Aligned_offset_realloc** Vorgang oder **NULL**.

*linenumber*<br/>
Zeilennummer in der Quelldatei, in dem die **Aligned_offset_realloc** angefordert wurde oder **NULL**.
