...
dev_langs: 
  ...
  - "C"
helpviewer_keywords: 
  - "_ftcsncicmp-Funktion"
  - "_ftcsnicmp-Funktion"
  - "_mbsnicmp-Funktion"
  - "_mbsnicmp_l-Funktion"
  - "_strnicmp-Funktion"
...
> [!IMPORTANT]
>  `_mbsnicmp` und `_mbsnicmp_l` können in Anwendungen, die in [!INCLUDE[wrt](../../atl/reference/includes/wrt_md.md)] ausgeführt werden, nicht verwendet werden.  Weitere Informationen finden Sie unter [CRT\-Funktionen nicht mit \/ZW unterstützt](http://msdn.microsoft.com/library/windows/apps/jj606124.aspx).  
...
|\> 0|Die untergeordnete Zeichenfolge `string1` ist größer als die untergeordnete Zeichenfolge `string2`.|  
 ...
 Bei einem Parametervalidierungsfehler geben diese Funktionen `_NLSCMPERROR` zurück \(\<string.h\> und \<mbstring.h\> definiert\).  
