...
Da C++ das Überladen zulässt, können Sie Überladungen von Aufrufen **runden** verwenden und zurückgeben **"float"** und **lange** **doppelte** Werte. In einem C-Programm **runden** immer Double und gibt eine **doppelte**.
