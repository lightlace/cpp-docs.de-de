...
## Hinweise  
 ...
 `atan` ist eine Implementierung, die SIMD\-Streamingerweiterungen 2 \(SSE2\) verwendet.  Informationen und Einschränkungen zur Verwendung der SSE2\-Implementierung finden Sie unter [\_set\_SSE2\_enable](../../c-runtime-library/reference/set-sse2-enable.md).  
...
```  
  ...
  **Arkustangens von 5,000000: 1,373401**  
**Arkustangens von 0,500000 \/ 5,000000: 0,099669**   
