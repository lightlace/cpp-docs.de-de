...
#### Parameter  
 ...
 Die `filename`\- und `linenumber`\-Parameter sind nur verfügbar, wenn `_calloc_dbg` explizit aufgerufen wurde oder die [\_CRTDBG\_MAP\_ALLOC](../../c-runtime-library/crtdbg-map-alloc.md)\-Präprozessorkonstante definiert wurde.  
