...
ms.locfileid: "70940164"
---
# <a name="_ismbc-routines"></a>_ismbc-Routinen
...
|-------------|--------------------|---------------------------|
|[_ismbcalnum, _ismbcalnum_l](../c-runtime-library/reference/ismbcalnum-functions.md)|Alphanumerisches Zeichen|Gibt nur dann einen Wert ungleich null zurück, wenn `c` eine Einzelbytedarstellung eines lateinischen ASCII-Buchstabens ist: Mehr dazu finden Sie in den Beispielen zu `_ismbcdigit` und `_ismbcalpha`.|
|[_ismbcalpha, _ismbcalpha_l](../c-runtime-library/reference/ismbcalnum-functions.md)|Alphabetisch|Gibt nur dann einen Wert ungleich null zurück, wenn `c` eine Einzelbytedarstellung eines lateinischen ASCII-Buchstabens ist: Mehr dazu finden Sie in den Beispielen zu `_ismbcupper` oder `_ismbclower`. Andernfalls ein Katakana-Zeichen: 0xA6<=`c`<=0xDF.|
...
|[_ismbcprint, _ismbcprint_l](../c-runtime-library/reference/ismbcgraph-functions.md)|Druckbar|Gibt einen Wert ungleich 0 (null) zurück, wenn `c` eine Einzelbytedarstellung eines beliebigen ASCII- oder druckbaren Katakana-Zeichens einschließlich Leerzeichen ( ) ist: Mehr dazu finden Sie in den Beispielen zu `_ismbcspace`, `_ismbcdigit`, `_ismbcalpha` und `_ismbcpunct`.|
...
|[_ismbcupper, _ismbcupper_l](../c-runtime-library/reference/ismbclower-ismbclower-l-ismbcupper-ismbcupper-l.md)|Großbuchstaben alphabetisch|Gibt nur dann einen Wert ungleich null zurück, wenn `c` eine Einzelbytedarstellung eines lateinischen ASCII-Großbuchstabens ist: 0x41<=`c`<=0x5A.|
...
|-------------|-------------------------------------------|
|[_ismbchira, _ismbchira_l](../c-runtime-library/reference/ismbchira-ismbchira-l-ismbckata-ismbckata-l.md)|Doppelbyte-Hiragana-Zeichen: 0x829F<=`c`<=0x82F1.|
|[_ismbckata, _ismbckata_l](../c-runtime-library/reference/ismbchira-ismbchira-l-ismbckata-ismbckata-l.md)|Doppelbyte-Katakana-Zeichen: 0x8340<=`c`<=0x8396.|
...
|[_ismbcl1, _ismbcl1_l](../c-runtime-library/reference/ismbcl0-ismbcl0-l-ismbcl1-ismbcl1-l-ismbcl2-ismbcl2-l.md)|JIS-Bereich 1: 0x889F<=`c`<=0x9872.|
|[_ismbcl2, _ismbcl2_l](../c-runtime-library/reference/ismbcl0-ismbcl0-l-ismbcl1-ismbcl1-l-ismbcl2-ismbcl2-l.md)|JIS-Bereich 2: 0x989F<=`c`<=0xEA9E.|
