...
|[fgetc, fgetwc](../c-runtime-library/reference/fgetc-fgetwc.md)|Zeichen aus Stream lesen (Funktionsversionen von `getc` und `getwc`)|  
...
|[_fputchar, _fputwchar](../c-runtime-library/reference/fputc-fputwc.md)|Zeichen in `stdout` schreiben (Funktionsversionen von `putchar` und `putwchar`)|  
...
|[freopen, _wfreopen](../c-runtime-library/reference/freopen-wfreopen.md), [freopen_s, _wfreopen_s](../c-runtime-library/reference/freopen-s-wfreopen-s.md)|`FILE` -Streamzeiger für neue Datei oder neues Gerät zuweisen|  
...
|[_putw](../c-runtime-library/reference/putw.md)|Binäres `int` in Stream schreiben|  
