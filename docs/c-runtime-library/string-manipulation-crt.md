...
|[strcmp, wcscmp, _mbscmp](../c-runtime-library/reference/strcmp-wcscmp-mbscmp.md)|Vergleichen von zwei Zeichenfolgen|[System::String::CompareOrdinal](https://msdn.microsoft.com/library/system.string.compareordinal.aspx)|
...
|[_strnset, _strnset_l, _wcsnset, _wcsnset_l, _mbsnset, _mbsnset_l](../c-runtime-library/reference/strnset-strnset-l-wcsnset-wcsnset-l-mbsnset-mbsnset-l.md)|Festlegen der ersten *n* Zeichen einer Zeichenfolge auf ein bestimmtes Zeichen|[System::String::Replace](https://msdn.microsoft.com/library/system.string.replace.aspx)|
