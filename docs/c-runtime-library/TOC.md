...
### [UWP-Apps, die Windows-Runtime und die C-Runtime](windows-store-apps-the-windows-runtime-and-the-c-run-time.md)
...
# [Universelle C-Laufzeitroutinen nach Kategorie](run-time-routines-by-category.md)
...
## [Unterstützung für komplexe Matehmatik](complex-math-support.md)
...
### [Using Generic-Text Mappings (Verwenden von Zuordnungen für generischen Text)](using-generic-text-mappings.md)
...
## [is, isw Routines (is- und isw-Routinen)](is-isw-routines.md)
