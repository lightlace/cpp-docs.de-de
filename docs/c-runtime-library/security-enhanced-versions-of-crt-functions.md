---
title: CRT-Funktionsversionen mit erweiterter Sicherheit | Microsoft-Dokumentation
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
|Veraltete Funktion|[_cgets_s, _cgetws_s](../c-runtime-library/reference/cgets-s-cgetws-s.md)|Ruft eine Zeichenfolge aus der Konsole ab|  
...
|Veraltete Funktion|[gets_s, _getws_s](../c-runtime-library/reference/gets-s-getws-s.md)|Ruft eine Zeile aus dem `stdin` -Stream ab|  
...
|[_itoa, _i64toa, _ui64toa, _itow, _i64tow, _ui64tow](../c-runtime-library/reference/itoa-i64toa-ui64toa-itow-i64tow-ui64tow.md)|[_itoa_s, _i64toa_s, _ui64toa_s, _itow_s, _i64tow_s, _ui64tow_s](../c-runtime-library/reference/itoa-s-i64toa-s-ui64toa-s-itow-s-i64tow-s-ui64tow-s.md)|Konvertiert eine ganze Zahl in eine Zeichenfolge|  
...
|[_ltoa, _ltow](../c-runtime-library/reference/ltoa-ltow.md)|[_ltoa_s, _ltow_s](../c-runtime-library/reference/ltoa-s-ltow-s.md)|Konvertiert eine lange ganze Zahl in eine Zeichenfolge|  
...
|[_mbsnbcat, _mbsnbcat_l](../c-runtime-library/reference/mbsnbcat-mbsnbcat-l.md)|[_mbsnbcat_s, _mbsnbcat_s_l](../c-runtime-library/reference/mbsnbcat-s-mbsnbcat-s-l.md)|Anhängen höchstens der ersten `n` Bytes einer Multibytezeichenfolge an eine andere|  
...
|[_ultoa, _ultow](../c-runtime-library/reference/ultoa-ultow.md)|[_ultoa_s, _ultow_s](../c-runtime-library/reference/ultoa-s-ultow-s.md)|Konvertieren einer langen ganzen Zahl ohne Vorzeichen in eine Zeichenfolge|  
