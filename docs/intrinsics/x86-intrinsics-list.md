...
ms.locfileid: "74163498"
---
# <a name="x86-intrinsics-list"></a>Liste der intrinsischen Funktionen für x86

Dieses Dokument listet systeminterne Funktionen auf, die derC++ Microsoft C/Compiler unterstützt, wenn x86 Ziel ist.
...
|[__addfsbyte](addfsbyte-addfsword-addfsdword.md)||intrin.h|void-__addfsbyte (Ganzzahl ohne Vorzeichen long, Ganzzahl ohne Vorzeichen Char)|
|[__addfsdword](addfsbyte-addfsword-addfsdword.md)||intrin.h|void-__addfsdword (Ganzzahl ohne Vorzeichen long, Ganzzahl ohne Vorzeichen long)|
|[__addfsword](addfsbyte-addfsword-addfsdword.md)||intrin.h|void-__addfsword (Ganzzahl ohne Vorzeichen long, Ganzzahl ohne Vorzeichen Short)|
|[_AddressOfReturnAddress](addressofreturnaddress.md)||intrin.h|void \* _AddressOfReturnAddress (void)|
|[_andn_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_andn_u32)|BMI [1]|ammintrin.h|Ganzzahl ohne Vorzeichen int _andn_u32 (Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int)|
...
|[_mm_set_pi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_set_pi16)|MMX|intrin.h|__m64 _mm_set_pi16 (kurze, kurze, kurze, kurze)|
...
|[_mm_setr_pi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_setr_pi16)|MMX|intrin.h|__m64 _mm_setr_pi16 (kurze, kurze, kurze, kurze)|
...
|[__readfsbyte](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|Ganzzahl ohne Vorzeichen char __readfsbyte (Ganzzahl ohne Vorzeichen long)|
|[__readfsdword](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|Ganzzahl ohne Vorzeichen long-__readfsdword (Ganzzahl ohne Vorzeichen long)|
|[__readfsword](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|kurz__readfsword ohne Vorzeichen (Ganzzahl ohne Vorzeichen long)|
...
|[__writedr](writedr.md)||intrin.h|void-__writedr (ohne Vorzeichen, unsigniert)|
|[__writeeflags](writeeflags.md)||intrin.h|void __writeeflags(unsigned)|
|[__writefsbyte](writefsbyte-writefsdword-writefsqword-writefsword.md)||intrin.h|void-__writefsbyte (Ganzzahl ohne Vorzeichen long, Ganzzahl ohne Vorzeichen Char)|
|[__writefsdword](writefsbyte-writefsdword-writefsqword-writefsword.md)||intrin.h|void-__writefsdword (Ganzzahl ohne Vorzeichen long, Ganzzahl ohne Vorzeichen long)|
|[__writefsword](writefsbyte-writefsdword-writefsqword-writefsword.md)||intrin.h|void-__writefsword (Ganzzahl ohne Vorzeichen long, Ganzzahl ohne Vorzeichen Short)|
...
[systeminterne x64-Funktionen (amd64)](x64-amd64-intrinsics-list.md)
