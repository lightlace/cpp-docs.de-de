---
title: X86 Liste der intrinsischen Funktionen
ms.date: 04/18/2019
helpviewer_keywords:
...
ms.locfileid: "62389644"
---
# <a name="x86-intrinsics-list"></a>X86 Liste der intrinsischen Funktionen

Dieses Dokument listet systeminterne Funktionen, die Microsoft C /C++ Compiler unterstützt, wenn X86 ausgerichtet ist.
...
## <a name="x86-intrinsics"></a>X86 systeminterne Funktionen
...
|[_andn_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_andn_u32)|BMI [1]|ammintrin.h|unsigned Int _andn_u32 (ganze Zahl ohne Vorzeichen, ganze Zahl ohne Vorzeichen)|
...
|[_mm_monitor](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_monitor)|SSE3|intrin.h|"void" _mm_monitor ("void" Const *, ganze Zahl ohne Vorzeichen, ganze Zahl ohne Vorzeichen)|
...
|[__readfsbyte](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|vorzeichenloses __readfsbyte(unsigned long)|
...
[X64 (amd64) systeminterne Funktionen](x64-amd64-intrinsics-list.md)
