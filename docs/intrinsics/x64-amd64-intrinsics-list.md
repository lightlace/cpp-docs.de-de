...
ms.locfileid: "74163526"
---
# <a name="x64-amd64-intrinsics-list"></a>Liste der intrinsischen Funktionen für x64 (amd64)

Dieses Dokument listet systeminterne Funktionen auf, C++ die der Microsoft-Compiler unterstützt, wenn x64 (auch als amd64 bezeichnet) als Ziel fest steht.
...
- [Einführung in Intel Advanced Vector Extensions](https://software.intel.com/articles/introduction-to-intel-advanced-vector-extensions)

- [AMD-Entwickler Handbücher, Handbücher & ISA-Dokumenten](https://developer.amd.com/resources/developer-guides-manuals/)

## <a name="x64-intrinsics"></a>systeminterne x64-Funktionen
...
|--------------------|----------------|------------|------------------------|
|_addcarry_u16||intrin.h|Ganzzahl ohne Vorzeichen char _addcarry_u16 (Ganzzahl ohne Vorzeichen Char, Ganzzahl ohne Vorzeichen Short, Ganzzahl ohne Vorzeichen Short, Ganzzahl ohne Vorzeichen Short \*)|
|[_addcarry_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarry_u32)||intrin.h|Ganzzahl ohne Vorzeichen char _addcarry_u32 (Ganzzahl ohne Vorzeichen Char, Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int \*)|
|[_addcarry_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarry_u64)||intrin.h|Ganzzahl ohne Vorzeichen char _addcarry_u64 (unsigniertes Char, Ganzzahl ohne Vorzeichen \__int64, Ganzzahl ohne Vorzeichen \__int64, Ganzzahl ohne Vorzeichen \__int64 \*)|
|_addcarry_u8||intrin.h|Ganzzahl ohne Vorzeichen char _addcarry_u8 (Ganzzahl ohne Vorzeichen Char, Ganzzahl ohne Vorzeichen Char, Ganzzahl ohne Vorzeichen Char, Ganzzahl ohne Vorzeichen char \*)|
|[_addcarryx_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarryx_u32)|ADX [2]|immintrin.h|Ganzzahl ohne Vorzeichen char _addcarryx_u32 (Ganzzahl ohne Vorzeichen Char, Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int \*)|
|[_addcarryx_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarryx_u64)|ADX [2]|immintrin.h|Ganzzahl ohne Vorzeichen char _addcarryx_u64 (unsigniertes Char, Ganzzahl ohne Vorzeichen \__int64, Ganzzahl ohne Vorzeichen \__int64, Ganzzahl ohne Vorzeichen \__int64 \*)|
|[__addgsbyte](addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void-__addgsbyte (Ganzzahl ohne Vorzeichen long, Ganzzahl ohne Vorzeichen Char)|
|[__addgsdword](addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void-__addgsdword (Ganzzahl ohne Vorzeichen long, Ganzzahl ohne Vorzeichen int)|
|[__addgsqword](addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void __addgsqword (unsignierte lange, unsignierte \__int64)|
|[__addgsword](addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void-__addgsword (Ganzzahl ohne Vorzeichen long, Ganzzahl ohne Vorzeichen Short)|
|[_AddressOfReturnAddress](addressofreturnaddress.md)||intrin.h|void \* _AddressOfReturnAddress (void)|
|_andn_u32|BMI [1]|ammintrin.h|Ganzzahl ohne Vorzeichen int _andn_u32 (Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int)|
|_andn_u64|BMI [1]|ammintrin.h|nicht signierte __int64 _andn_u64 (unsignierte \__int64, nicht signierte \__int64)|
|[_bextr_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_bextr_u32)|BMI|ammintrin.h, immintrin.h|Ganzzahl ohne Vorzeichen int _bextr_u32 (Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int)|
|[_bextr_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_bextr_u64)|BMI|ammintrin.h, immintrin.h|nicht signierte __int64 _bextr_u64 (unsignierte \__int64, Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int)|
|_bextri_u32|ABM [1]|ammintrin.h|Ganzzahl ohne Vorzeichen int _bextri_u32 (Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int)|
|_bextri_u64|ABM [1]|ammintrin.h|nicht signierte __int64 _bextri_u64 (unsignierte \__int64, Ganzzahl ohne Vorzeichen int)|
|[_BitScanForward](bitscanforward-bitscanforward64.md)||intrin.h|Ganzzahl ohne Vorzeichen char _BitScanForward (Ganzzahl ohne Vorzeichen long\*, Ganzzahl ohne Vorzeichen long)|
|[_BitScanForward64](bitscanforward-bitscanforward64.md)||intrin.h|Ganzzahl ohne Vorzeichen char _BitScanForward64 (Ganzzahl ohne Vorzeichen long\*, Ganzzahl ohne Vorzeichen \__int64)|
|[_BitScanReverse](bitscanreverse-bitscanreverse64.md)||intrin.h|Ganzzahl ohne Vorzeichen char _BitScanReverse (Ganzzahl ohne Vorzeichen long\*, Ganzzahl ohne Vorzeichen long)|
|[_BitScanReverse64](bitscanreverse-bitscanreverse64.md)||intrin.h|Ganzzahl ohne Vorzeichen char _BitScanReverse64 (Ganzzahl ohne Vorzeichen long\*, Ganzzahl ohne Vorzeichen \__int64)|
|[_bittest](bittest-bittest64.md)||intrin.h|Ganzzahl ohne Vorzeichen char _bittest (Long Konstanten \*, Long)|
|[_bittest64](bittest-bittest64.md)||intrin.h|Ganzzahl ohne Vorzeichen char _bittest64 (\__int64 Konstanten \*, \__int64)|
|[_bittestandcomplement](bittestandcomplement-bittestandcomplement64.md)||intrin.h|Ganzzahl ohne Vorzeichen char _bittestandcomplement (Long \*, Long)|
|[_bittestandcomplement64](bittestandcomplement-bittestandcomplement64.md)||intrin.h|Ganzzahl ohne Vorzeichen char _bittestandcomplement64 (\__int64 \*, \__int64)|
|[_bittestandreset](bittestandreset-bittestandreset64.md)||intrin.h|Ganzzahl ohne Vorzeichen char _bittestandreset (Long \*, Long)|
|[_bittestandreset64](bittestandreset-bittestandreset64.md)||intrin.h|Ganzzahl ohne Vorzeichen char _bittestandreset64 (\__int64 \*, \__int64)|
|[_bittestandset](bittestandset-bittestandset64.md)||intrin.h|Ganzzahl ohne Vorzeichen char _bittestandset (Long \*, Long)|
|[_bittestandset64](bittestandset-bittestandset64.md)||intrin.h|Ganzzahl ohne Vorzeichen char _bittestandset64 (\__int64 \*, \__int64)|
|_blcfill_u32|ABM [1]|ammintrin.h|unsigned int _blcfill_u32(unsigned int)|
|_blcfill_u64|ABM [1]|ammintrin.h|nicht signierte __int64 _blcfill_u64 (unsignierte \__int64)|
|_blci_u32|ABM [1]|ammintrin.h|unsigned int _blci_u32(unsigned int)|
|_blci_u64|ABM [1]|ammintrin.h|nicht signierte __int64 _blci_u64 (unsignierte \__int64)|
|_blcic_u32|ABM [1]|ammintrin.h|unsigned int _blcic_u32(unsigned int)|
|_blcic_u64|ABM [1]|ammintrin.h|nicht signierte __int64 _blcic_u64 (unsignierte \__int64)|
|_blcmsk_u32|ABM [1]|ammintrin.h|unsigned int _blcmsk_u32(unsigned int)|
|_blcmsk_u64|ABM [1]|ammintrin.h|nicht signierte __int64 _blcmsk_u64 (unsignierte \__int64)|
|_blcs_u32|ABM [1]|ammintrin.h|unsigned int _blcs_u32(unsigned int)|
|_blcs_u64|ABM [1]|ammintrin.h|nicht signierte __int64 _blcs_u64 (unsignierte \__int64)|
|_blsfill_u32|ABM [1]|ammintrin.h|unsigned int _blsfill_u32(unsigned int)|
|_blsfill_u64|ABM [1]|ammintrin.h|nicht signierte __int64 _blsfill_u64 (unsignierte \__int64)|
...
|[_blsi_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsi_u64)|BMI|ammintrin.h, immintrin.h|nicht signierte __int64 _blsi_u64 (unsignierte \__int64)|
|_blsic_u32|ABM [1]|ammintrin.h|unsigned int _blsic_u32(unsigned int)|
|_blsic_u64|ABM [1]|ammintrin.h|nicht signierte __int64 _blsic_u64 (unsignierte \__int64)|
...
|[_blsmsk_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsmsk_u64)|BMI|ammintrin.h, immintrin.h|nicht signierte __int64 _blsmsk_u64 (unsignierte \__int64)|
...
|[_blsr_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsr_u64)|BMI|ammintrin.h, immintrin.h|nicht signierte __int64 _blsr_u64 (unsignierte \__int64)|
|[_bzhi_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_bzhi_u32)|BMI [2]|immintrin.h|Ganzzahl ohne Vorzeichen int _bzhi_u32 (Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int)|
|[_bzhi_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_bzhi_u64)|BMI [2]|immintrin.h|nicht signierte __int64 _bzhi_u64 (unsignierte \__int64, Ganzzahl ohne Vorzeichen int)|
...
|[__emulu](emul-emulu.md)||intrin.h|Ganzzahl ohne Vorzeichen __int64 [Pascal/cdecl]\__emulu (Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int)|
...
|[_fxrstor](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_fxrstor)|FXSR [2]|immintrin.h|void-_fxrstor (void Konstanten\*)|
|[_fxrstor64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_fxrstor64)|FXSR [2]|immintrin.h|void-_fxrstor64 (void Konstanten\*)|
...
|[__inbyte](inbyte.md)||intrin.h|Ganzzahl ohne Vorzeichen char __inbyte (Ganzzahl ohne Vorzeichen Short)|
|[__inbytestring](inbytestring.md)||intrin.h|void-__inbytestring (Ganzzahl ohne Vorzeichen Short, Ganzzahl ohne Vorzeichen char \*, Ganzzahl ohne Vorzeichen long)|
...
|[__indword](indword.md)||intrin.h|Ganzzahl ohne Vorzeichen long-__indword (Ganzzahl ohne Vorzeichen Short)|
|[__indwordstring](indwordstring.md)||intrin.h|void-__indwordstring (Ganzzahl ohne Vorzeichen Short, Ganzzahl ohne Vorzeichen long \*, Ganzzahl ohne Vorzeichen long)|
|[__int2c](int2c.md)||intrin.h|void __int2c(void)|
|[_InterlockedAnd](interlockedand-intrinsic-functions.md)||intrin.h|Long-_InterlockedAnd (langes flüchtiges \*, Long)|
|[_InterlockedAnd_HLEAcquire](interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|Long-_InterlockedAnd_HLEAcquire (langes flüchtiges \*, Long)|
|[_InterlockedAnd_HLERelease](interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|Long-_InterlockedAnd_HLERelease (langes flüchtiges \*, Long)|
|[_InterlockedAnd_np](interlockedand-intrinsic-functions.md)||intrin.h|Long-_InterlockedAnd_np (Long \*, Long)|
|[_InterlockedAnd16](interlockedand-intrinsic-functions.md)||intrin.h|kurz_InterlockedAnd16 (kurzes flüchtiges \*, kurz)|
|[_InterlockedAnd16_np](interlockedand-intrinsic-functions.md)||intrin.h|kurz_InterlockedAnd16_np (kurz\*, kurz)|
...
|[_interlockedbittestandreset](interlockedbittestandreset-intrinsic-functions.md)||intrin.h|Ganzzahl ohne Vorzeichen char _interlockedbittestandreset (Long \*, Long)|
|[_interlockedbittestandreset_HLEAcquire](interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|Ganzzahl ohne Vorzeichen char _interlockedbittestandreset_HLEAcquire (Long \*, Long)|
|[_interlockedbittestandreset_HLERelease](interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|Ganzzahl ohne Vorzeichen char _interlockedbittestandreset_HLERelease (Long \*, Long)|
|[_interlockedbittestandreset64](interlockedbittestandreset-intrinsic-functions.md)||intrin.h|Ganzzahl ohne Vorzeichen char _interlockedbittestandreset64 (\__int64 \*, \__int64)|
|[_interlockedbittestandreset64_HLEAcquire](interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|Ganzzahl ohne Vorzeichen char _interlockedbittestandreset64_HLEAcquire (\__int64 \*, \__int64)|
|[_interlockedbittestandreset64_HLERelease](interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|Ganzzahl ohne Vorzeichen char _interlockedbittestandreset64_HLERelease (\__int64 \*, \__int64)|
|[_interlockedbittestandset](interlockedbittestandset-intrinsic-functions.md)||intrin.h|Ganzzahl ohne Vorzeichen char _interlockedbittestandset (Long \*, Long)|
|[_interlockedbittestandset_HLEAcquire](interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|Ganzzahl ohne Vorzeichen char _interlockedbittestandset_HLEAcquire (Long \*, Long)|
|[_interlockedbittestandset_HLERelease](interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|Ganzzahl ohne Vorzeichen char _interlockedbittestandset_HLERelease (Long \*, Long)|
|[_interlockedbittestandset64](interlockedbittestandset-intrinsic-functions.md)||intrin.h|Ganzzahl ohne Vorzeichen char _interlockedbittestandset64 (\__int64 \*, \__int64)|
|[_interlockedbittestandset64_HLEAcquire](interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|Ganzzahl ohne Vorzeichen char _interlockedbittestandset64_HLEAcquire (\__int64 \*, \__int64)|
|[_interlockedbittestandset64_HLERelease](interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|Ganzzahl ohne Vorzeichen char _interlockedbittestandset64_HLERelease (\__int64 \*, \__int64)|
...
|[_InterlockedCompareExchange128](interlockedcompareexchange128.md)||intrin.h|nicht signiertes char-_InterlockedCompareExchange128 (\__int64 volatile \*, \__int64, \__int64, \__int64\*)|
|[_InterlockedCompareExchange128_np](interlockedcompareexchange128.md)||intrin.h|nicht signiertes char-_InterlockedCompareExchange128 (\__int64 volatile \*, \__int64, \__int64, \__int64\*)|
|[_InterlockedCompareExchange16](interlockedcompareexchange-intrinsic-functions.md)||intrin.h|kurz_InterlockedCompareExchange16 (kurzes flüchtiges \*, kurz, kurz)|
|[_InterlockedCompareExchange16_np](interlockedcompareexchange-intrinsic-functions.md)||intrin.h|kurz_InterlockedCompareExchange16_np (kurzes flüchtiges \*, kurz, kurz)|
...
|[_InterlockedDecrement](interlockeddecrement-intrinsic-functions.md)||intrin.h|Long-_InterlockedDecrement (langes flüchtiges \*)|
|[_InterlockedDecrement16](interlockeddecrement-intrinsic-functions.md)||intrin.h|kurz_InterlockedDecrement16 (kurzes flüchtiges \*)|
...
|[_InterlockedExchange](interlockedexchange-intrinsic-functions.md)||intrin.h|Long-_InterlockedExchange (langes flüchtiges \*, Long)|
|[_InterlockedExchange_HLEAcquire](interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|Long-_InterlockedExchange_HLEAcquire (langes flüchtiges \*, Long)|
|[_InterlockedExchange_HLERelease](interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|Long-_InterlockedExchange_HLERelease (langes flüchtiges \*, Long)|
|[_InterlockedExchange16](interlockedexchange-intrinsic-functions.md)||intrin.h|kurz_InterlockedExchange16 (kurzes flüchtiges \*, kurz)|
...
|[_InterlockedExchangeAdd](interlockedexchangeadd-intrinsic-functions.md)||intrin.h|Long-_InterlockedExchangeAdd (langes flüchtiges \*, Long)|
|[_InterlockedExchangeAdd_HLEAcquire](interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|Long-_InterlockedExchangeAdd_HLEAcquire (langes flüchtiges \*, Long)|
|[_InterlockedExchangeAdd_HLERelease](interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|Long-_InterlockedExchangeAdd_HLERelease (langes flüchtiges \*, Long)|
|[_InterlockedExchangeAdd16](interlockedexchangeadd-intrinsic-functions.md)||intrin.h|kurz_InterlockedExchangeAdd16 (kurzes flüchtiges \*, kurz)|
...
|[_InterlockedIncrement](interlockedincrement-intrinsic-functions.md)||intrin.h|Long-_InterlockedIncrement (langes flüchtiges \*)|
|[_InterlockedIncrement16](interlockedincrement-intrinsic-functions.md)||intrin.h|kurz_InterlockedIncrement16 (kurzes flüchtiges \*)|
...
|[_InterlockedOr](interlockedor-intrinsic-functions.md)||intrin.h|Long-_InterlockedOr (langes flüchtiges \*, Long)|
|[_InterlockedOr_HLEAcquire](interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|Long-_InterlockedOr_HLEAcquire (langes flüchtiges \*, Long)|
|[_InterlockedOr_HLERelease](interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|Long-_InterlockedOr_HLERelease (langes flüchtiges \*, Long)|
|[_InterlockedOr_np](interlockedor-intrinsic-functions.md)||intrin.h|Long-_InterlockedOr_np (Long \*, Long)|
|[_InterlockedOr16](interlockedor-intrinsic-functions.md)||intrin.h|kurz_InterlockedOr16 (kurzes flüchtiges \*, kurz)|
|[_InterlockedOr16_np](interlockedor-intrinsic-functions.md)||intrin.h|kurz_InterlockedOr16_np (kurz\*, kurz)|
...
|[_InterlockedXor](interlockedxor-intrinsic-functions.md)||intrin.h|Long-_InterlockedXor (langes flüchtiges \*, Long)|
|[_InterlockedXor_HLEAcquire](interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|Long-_InterlockedXor_HLEAcquire (langes flüchtiges \*, Long)|
|[_InterlockedXor_HLERelease](interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|Long-_InterlockedXor_HLERelease (langes flüchtiges \*, Long)|
|[_InterlockedXor_np](interlockedxor-intrinsic-functions.md)||intrin.h|Long-_InterlockedXor_np (Long \*, Long)|
|[_InterlockedXor16](interlockedxor-intrinsic-functions.md)||intrin.h|kurz_InterlockedXor16 (kurzes flüchtiges \*, kurz)|
|[_InterlockedXor16_np](interlockedxor-intrinsic-functions.md)||intrin.h|kurz_InterlockedXor16_np (kurz\*, kurz)|
...
|[__inword](inword.md)||intrin.h|Ganzzahl ohne Vorzeichen Short __inword (Ganzzahl ohne Vorzeichen Short)|
|[__inwordstring](inwordstring.md)||intrin.h|void __inwordstring (Kurzform ohne Vorzeichen, Ganzzahl ohne Vorzeichen Short \*, Ganzzahl ohne Vorzeichen long)|
|_lgdt||intrin.h|void-_lgdt (void\*)|
|[__lidt](lidt.md)||intrin.h|void-__lidt (void\*)|
|[__ll_lshift](ll-lshift.md)||intrin.h|Ganzzahl ohne Vorzeichen __int64 [Pascal/cdecl] \__ll_lshift (Ganzzahl ohne Vorzeichen \__int64, int)|
...
|_load_be_u16<br /><br /> [_loadbe_i16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_loadbe_i16&expand=3071)|MOVBE|immintrin.h|kurz_load_be_u16 ohne Vorzeichen (void Konstanten\*);<br /><br /> kurz_loadbe_i16 (void Konstanten\*); €|
|_load_be_u32<br /><br /> [_loadbe_i32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_loadbe_i32&expand=3072)|MOVBE|immintrin.h|Ganzzahl ohne Vorzeichen int _load_be_u32 (void Konstanten\*);<br /><br /> int-_loadbe_i32 (void Konstanten\*); €|
|_load_be_u64<br /><br /> [_loadbe_i64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_loadbe_i64&expand=3073)|MOVBE|immintrin.h|nicht signierte __int64 _load_be_u64 (void Konstanten\*);<br /><br /> \__int64 _loadbe_i64 (void Konstanten\*); €|
|__lwpins32|LWP [1]|ammintrin.h|Ganzzahl ohne Vorzeichen char __lwpins32 (Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int)|
|__lwpins64|LWP [1]|ammintrin.h|Ganzzahl ohne Vorzeichen char __lwpins64 (Ganzzahl ohne Vorzeichen \__int64, Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int)|
|__lwpval32|LWP [1]|ammintrin.h|void-__lwpval32 (Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int)|
|__lwpval64|LWP [1]|ammintrin.h|void __lwpval64 (Ganzzahl ohne Vorzeichen \__int64, Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int)|
...
|[_lzcnt_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_lzcnt_u64)|BMI|ammintrin.h, immintrin.h|nicht signierte __int64 _lzcnt_u64 (unsignierte \__int64)|
|[__lzcnt16](lzcnt16-lzcnt-lzcnt64.md)|LZCNT|intrin.h|unsigned short __lzcnt16(unsigned short)|
|[__lzcnt64](lzcnt16-lzcnt-lzcnt64.md)|LZCNT|intrin.h|nicht signierte __int64 \__lzcnt64 (unsignierte \__int64)|
...
|[_mm_aeskeygenassist_si128](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_aeskeygenassist_si128)|AESNI [2]|immintrin.h|__m128i _mm_aeskeygenassist_si128 (\__m128i, Konstante int)|
...
|[_mm_blend_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_blend_epi16)|SSE41|intrin.h|__m128i _mm_blend_epi16 (\__m128i, \__m128i, Konstante int)|
|[_mm_blend_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_blend_epi32)|AVX2 [2]|immintrin.h|__m128i _mm_blend_epi32 (\__m128i, \__m128i, Konstante int)|
|[_mm_blend_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_blend_pd)|SSE41|intrin.h|__m128d _mm_blend_pd (\__m128d, \__m128d, Konstante int)|
|[_mm_blend_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_blend_ps)|SSE41|intrin.h|__m128 _mm_blend_ps (\__m128, \__m128, Konstante int)|
...
|[_mm_broadcast_ss](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_broadcast_ss)|AVX [2]|immintrin.h|__m128 _mm_broadcast_ss (float-Konstante \*)|
...
|[_mm_clflush](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_clflush)|SSE2|intrin.h|void-_mm_clflush (void Konstanten \*)|
|[_mm_clmulepi64_si128](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_clmulepi64_si128)|PCLMULQDQ [2]|immintrin.h|__m128i _mm_clmulepi64_si128 (\__m128i, \__m128i, Konstante int)|
|_mm_cmov_si128|XOP [1]|ammintrin.h|__m128i _mm_cmov_si128 (\__m128i, \__m128i, \__m128i)|
|[_mm_cmp_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmp_pd)|AVX [2]|immintrin.h|__m128d _mm_cmp_pd (\__m128d, \__m128d, Konstante int)|
|[_mm_cmp_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmp_ps)|AVX [2]|immintrin.h|__m128 _mm_cmp_ps (\__m128, \__m128, Konstante int)|
|[_mm_cmp_sd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmp_sd)|AVX [2]|immintrin.h|__m128d _mm_cmp_sd (\__m128d, \__m128d, Konstante int)|
|[_mm_cmp_ss](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmp_ss)|AVX [2]|immintrin.h|__m128 _mm_cmp_ss (\__m128, \__m128, Konstante int)|
...
|[_mm_cmpestra](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpestra)|SSE42|intrin.h|int _mm_cmpestra (\__m128i, int, \__m128i, int, Konstanten int)|
|[_mm_cmpestrc](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpestrc)|SSE42|intrin.h|int _mm_cmpestrc (\__m128i, int, \__m128i, int, Konstanten int)|
|[_mm_cmpestri](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpestri)|SSE42|intrin.h|int _mm_cmpestri (\__m128i, int, \__m128i, int, Konstanten int)|
|[_mm_cmpestrm](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpestrm)|SSE42|intrin.h|__m128i _mm_cmpestrm (\__m128i, int, \__m128i, int, Konstanten int)|
|[_mm_cmpestro](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpestro)|SSE42|intrin.h|int _mm_cmpestro (\__m128i, int, \__m128i, int, Konstanten int)|
|[_mm_cmpestrs](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpestrs)|SSE42|intrin.h|int _mm_cmpestrs (\__m128i, int, \__m128i, int, Konstanten int)|
|[_mm_cmpestrz](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpestrz)|SSE42|intrin.h|int _mm_cmpestrz (\__m128i, int, \__m128i, int, Konstanten int)|
...
|[_mm_cmpistra](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpistra)|SSE42|intrin.h|int _mm_cmpistra (\__m128i, \__m128i, Konstanten int)|
|[_mm_cmpistrc](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpistrc)|SSE42|intrin.h|int _mm_cmpistrc (\__m128i, \__m128i, Konstanten int)|
|[_mm_cmpistri](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpistri)|SSE42|intrin.h|int _mm_cmpistri (\__m128i, \__m128i, Konstanten int)|
|[_mm_cmpistrm](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpistrm)|SSE42|intrin.h|__m128i _mm_cmpistrm (\__m128i, \__m128i, Konstante int)|
|[_mm_cmpistro](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpistro)|SSE42|intrin.h|int _mm_cmpistro (\__m128i, \__m128i, Konstanten int)|
|[_mm_cmpistrs](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpistrs)|SSE42|intrin.h|int _mm_cmpistrs (\__m128i, \__m128i, Konstanten int)|
|[_mm_cmpistrz](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cmpistrz)|SSE42|intrin.h|int _mm_cmpistrz (\__m128i, \__m128i, Konstanten int)|
...
|[_mm_crc32_u16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_crc32_u16)|SSE42|intrin.h|Ganzzahl ohne Vorzeichen int _mm_crc32_u16 (Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen Short)|
|[_mm_crc32_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_crc32_u32)|SSE42|intrin.h|Ganzzahl ohne Vorzeichen int _mm_crc32_u32 (Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int)|
|[_mm_crc32_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_crc32_u64)|SSE42|intrin.h|nicht signierte __int64 _mm_crc32_u64 (unsignierte \__int64, nicht signierte \__int64)|
|[_mm_crc32_u8](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_crc32_u8)|SSE42|intrin.h|Ganzzahl ohne Vorzeichen int-_mm_crc32_u8 (Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen Char)|
...
|[_mm_cvtps_ph](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cvtps_ph)|F16C [2]|immintrin.h|__m128i _mm_cvtps_ph (\__m128, Konstante int)|
|[_mm_cvtsd_f64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_cvtsd_f64)|SSSE3|intrin.h|doppelte _mm_cvtsd_f64 (\__m128d)|
...
|[_mm_dp_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_dp_pd)|SSE41|intrin.h|__m128d _mm_dp_pd (\__m128d, \__m128d, Konstante int)|
|[_mm_dp_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_dp_ps)|SSE41|intrin.h|__m128 _mm_dp_ps (\__m128, \__m128, Konstante int)|
...
|[_mm_extract_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_extract_epi32)|SSE41|intrin.h|int-_mm_extract_epi32 (\__m128i, Konstante int)|
|[_mm_extract_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_extract_epi64)|SSE41|intrin.h|__int64 _mm_extract_epi64 (\__m128i, Konstante int)|
|[_mm_extract_epi8](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_extract_epi8)|SSE41|intrin.h|int-_mm_extract_epi8 (\__m128i, Konstante int)|
|[_mm_extract_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_extract_ps)|SSE41|intrin.h|int-_mm_extract_ps (\__m128, Konstante int)|
...
|[_mm_i32gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i32gather_epi32)|AVX2 [2]|immintrin.h|__m128i _mm_i32gather_epi32 (int Konstanten \*, \__m128i, Konstante int)|
|[_mm_i32gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i32gather_epi64)|AVX2 [2]|immintrin.h|__m128i _mm_i32gather_epi64 (\__int64 Konstanten \*, \__m128i, Konstante int)|
|[_mm_i32gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i32gather_pd)|AVX2 [2]|immintrin.h|__m128d _mm_i32gather_pd (Double Konstanten \*, \__m128i, Konstante int)|
|[_mm_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i32gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm_i32gather_ps (float-Konstante \*, \__m128i, Konstante int)|
|[_mm_i64gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i64gather_epi32)|AVX2 [2]|immintrin.h|__m128i _mm_i64gather_epi32 (int Konstanten \*, \__m128i, Konstante int)|
|[_mm_i64gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i64gather_epi64)|AVX2 [2]|immintrin.h|__m128i _mm_i64gather_epi64 (\__int64 Konstanten \*, \__m128i, Konstante int)|
|[_mm_i64gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i64gather_pd)|AVX2 [2]|immintrin.h|__m128d _mm_i64gather_pd (Double Konstanten \*, \__m128i, Konstante int)|
|[_mm_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i64gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm_i64gather_ps (float-Konstante \*, \__m128i, Konstante int)|
...
|[_mm_insert_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_insert_epi32)|SSE41|intrin.h|__m128i _mm_insert_epi32 (\__m128i, int, Konstanten (int))|
|[_mm_insert_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_insert_epi64)|SSE41|intrin.h|__m128i _mm_insert_epi64 (\__m128i, \__int64, Konstante int)|
|[_mm_insert_epi8](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_insert_epi8)|SSE41|intrin.h|__m128i _mm_insert_epi8 (\__m128i, int, Konstanten (int))|
|[_mm_insert_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_insert_ps)|SSE41|intrin.h|__m128 _mm_insert_ps (\__m128, \__m128, Konstante int)|
...
|[_mm_lddqu_si128](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_lddqu_si128)|SSE3|intrin.h|__m128i _mm_lddqu_si128 (\__m128i Konstanten\*)|
...
|[_mm_loaddup_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_loaddup_pd)|SSE3|intrin.h|__m128d _mm_loaddup_pd (Double-Konstante\*)|
...
|[_mm_mask_i32gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i32gather_epi32)|AVX2 [2]|immintrin.h|__m128i _mm_mask_i32gather_epi32 (\__m128i, int Konstanten \*, \__m128i, \__m128i, Konstante int)|
|[_mm_mask_i32gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i32gather_epi64)|AVX2 [2]|immintrin.h|__m128i _mm_mask_i32gather_epi64 (\__m128i, \__int64 Konstanten \*, \__m128i, \__m128i, Konstanten int)|
|[_mm_mask_i32gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i32gather_pd)|AVX2 [2]|immintrin.h|__m128d _mm_mask_i32gather_pd (\__m128d, Double Konstanten \*, \__m128i, \__m128d, Konstanten int)|
|[_mm_mask_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i32gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm_mask_i32gather_ps (\__m128, float Konstanten \*, \__m128i, \__m128, Konstante int)|
|[_mm_mask_i64gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i64gather_epi32)|AVX2 [2]|immintrin.h|__m128i _mm_mask_i64gather_epi32 (\__m128i, int Konstanten \*, \__m128i, \__m128i, Konstante int)|
|[_mm_mask_i64gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i64gather_epi64)|AVX2 [2]|immintrin.h|__m128i _mm_mask_i64gather_epi64 (\__m128i, \__int64 Konstanten \*, \__m128i, \__m128i, Konstanten int)|
|[_mm_mask_i64gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i64gather_pd)|AVX2 [2]|immintrin.h|__m128d _mm_mask_i64gather_pd (\__m128d, Double Konstanten \*, \__m128i, \__m128d, Konstanten int)|
|[_mm_mask_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i64gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm_mask_i64gather_ps (\__m128, float Konstanten \*, \__m128i, \__m128, Konstante int)|
|[_mm_maskload_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_maskload_epi32)|AVX2 [2]|immintrin.h|__m128i _mm_maskload_epi32 (int Konstanten \*, \__m128i)|
|[_mm_maskload_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_maskload_epi64)|AVX2 [2]|immintrin.h|__m128i _mm_maskload_epi64 (\__int64 Konstanten \*, \__m128i)|
|[_mm_maskload_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_maskload_pd)|AVX [2]|immintrin.h|__m128d _mm_maskload_pd (Double Konstanten \*, \__m128i)|
|[_mm_maskload_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_maskload_ps)|AVX [2]|immintrin.h|__m128 _mm_maskload_ps (float-Konstante \*, \__m128i)|
...
|[_mm_monitor](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_monitor)|SSE3|intrin.h|void-_mm_monitor (void Konstanten\*, Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int)|
...
|[_mm_mpsadbw_epu8](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mpsadbw_epu8)|SSE41|intrin.h|__m128i _mm_mpsadbw_epu8 (\__m128i, \__m128i, Konstante int)|
...
|[_mm_mwait](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mwait)|SSE3|intrin.h|void-_mm_mwait (Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int)|
...
|[_mm_popcnt_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_popcnt_u64)|POPCNT|intrin.h|__int64 _mm_popcnt_u64 (unsignierte \__int64)|
...
|[_mm_round_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_round_pd)|SSE41|intrin.h|__m128d _mm_round_pd (\__m128d, Konstante int)|
|[_mm_round_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_round_ps)|SSE41|intrin.h|__m128 _mm_round_ps (\__m128, Konstante int)|
|[_mm_round_sd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_round_sd)|SSE41|intrin.h|__m128d _mm_round_sd (\__m128d, \__m128d, Konstante int)|
|[_mm_round_ss](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_round_ss)|SSE41|intrin.h|__m128 _mm_round_ss (\__m128, \__m128, Konstante int)|
...
|[_mm_set_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_set_epi16)|SSE2|intrin.h|__m128i _mm_set_epi16 (kurze, kurze, kurze, kurze, kurze, kurze, kurze, kurze)|
...
|[_mm_setr_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_setr_epi16)|SSE2|intrin.h|__m128i _mm_setr_epi16 (kurze, kurze, kurze, kurze, kurze, kurze, kurze, kurze)|
...
|[_mm_shuffle_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_shuffle_ps)|SSE|intrin.h|__m128 _mm_shuffle_ps (\__m128, \__m128, Ganzzahl ohne Vorzeichen int)|
...
|[_mm256_alignr_epi8](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_alignr_epi8)|AVX2 [2]|immintrin.h|__m256i _mm256_alignr_epi8 (\__m256i, \__m256i, Konstante int)|
...
|[_mm256_blend_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_blend_epi16)|AVX2 [2]|immintrin.h|__m256i _mm256_blend_epi16 (\__m256i, \__m256i, Konstante int)|
|[_mm256_blend_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_blend_epi32)|AVX2 [2]|immintrin.h|__m256i _mm256_blend_epi32 (\__m256i, \__m256i, Konstante int)|
|[_mm256_blend_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_blend_pd)|AVX [2]|immintrin.h|__m256d _mm256_blend_pd (\__m256d, \__m256d, Konstante int)|
|[_mm256_blend_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_blend_ps)|AVX [2]|immintrin.h|__m256 _mm256_blend_ps (\__m256, \__m256, Konstante int)|
...
|[_mm256_broadcast_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_broadcast_pd)|AVX [2]|immintrin.h|__m256d _mm256_broadcast_pd (\__m128d Konstanten \*)|
|[_mm256_broadcast_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_broadcast_ps)|AVX [2]|immintrin.h|__m256 _mm256_broadcast_ps (\__m128 Konstanten \*)|
|[_mm256_broadcast_sd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_broadcast_sd)|AVX [2]|immintrin.h|__m256d _mm256_broadcast_sd (Double-Konstante \*)|
|[_mm256_broadcast_ss](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_broadcast_ss)|AVX [2]|immintrin.h|__m256 _mm256_broadcast_ss (float-Konstante \*)|
...
|[_mm256_cmp_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_cmp_pd)|AVX [2]|immintrin.h|__m256d _mm256_cmp_pd (\__m256d, \__m256d, Konstante int)|
|[_mm256_cmp_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_cmp_ps)|AVX [2]|immintrin.h|__m256 _mm256_cmp_ps (\__m256, \__m256, Konstante int)|
...
|[_mm256_cvtps_ph](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_cvtps_ph)|F16C [2]|immintrin.h|__m128i _mm256_cvtps_ph (\__m256, Konstante int)|
...
|[_mm256_dp_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_dp_ps)|AVX [2]|immintrin.h|__m256 _mm256_dp_ps (\__m256, \__m256, Konstante int)|
|[_mm256_extractf128_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_extractf128_pd)|AVX [2]|immintrin.h|__m128d _mm256_extractf128_pd (\__m256d, Konstante int)|
|[_mm256_extractf128_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_extractf128_ps)|AVX [2]|immintrin.h|__m128 _mm256_extractf128_ps (\__m256, Konstante int)|
|[_mm256_extractf128_si256](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_extractf128_si256)|AVX [2]|immintrin.h|__m128i _mm256_extractf128_si256 (\__m256i, Konstante int)|
...
|[_mm256_i32gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i32gather_epi32)|AVX2 [2]|immintrin.h|__m256i _mm256_i32gather_epi32 (int Konstanten \*, \__m256i, Konstante int)|
|[_mm256_i32gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i32gather_epi64)|AVX2 [2]|immintrin.h|__m256i _mm256_i32gather_epi64 (\__int64 Konstanten \*, \__m128i, Konstante int)|
|[_mm256_i32gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i32gather_pd)|AVX2 [2]|immintrin.h|__m256d _mm256_i32gather_pd (Double Konstanten \*, \__m128i, Konstante int)|
|[_mm256_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i32gather_ps)|AVX2 [2]|immintrin.h|__m256 _mm256_i32gather_ps (float-Konstante \*, \__m256i, Konstante int)|
|[_mm256_i64gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i64gather_epi32)|AVX2 [2]|immintrin.h|__m256i _mm256_i64gather_epi32 (int Konstanten \*, \__m256i, Konstante int)|
|[_mm256_i64gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i64gather_epi64)|AVX2 [2]|immintrin.h|__m256i _mm256_i64gather_epi64 (\__int64 Konstanten \*, \__m256i, Konstante int)|
|[_mm256_i64gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i64gather_pd)|AVX2 [2]|immintrin.h|__m256d _mm256_i64gather_pd (Double Konstanten \*, \__m256i, Konstante int)|
|[_mm256_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i64gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm256_i64gather_ps (float-Konstante \*, \__m256i, Konstante int)|
...
|[_mm256_load_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_load_pd)|AVX [2]|immintrin.h|__m256d _mm256_load_pd (Double-Konstante \*)|
|[_mm256_load_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_load_ps)|AVX [2]|immintrin.h|__m256 _mm256_load_ps (float-Konstante \*)|
...
|[_mm256_loadu_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_loadu_pd)|AVX [2]|immintrin.h|__m256d _mm256_loadu_pd (Double-Konstante \*)|
|[_mm256_loadu_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_loadu_ps)|AVX [2]|immintrin.h|__m256 _mm256_loadu_ps (float-Konstante \*)|
...
|[_mm256_mask_i32gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i32gather_epi32)|AVX2 [2]|immintrin.h|__m256i _mm256_mask_i32gather_epi32 (\__m256i, int Konstanten \*, \__m256i, \__m256i, Konstante int)|
|[_mm256_mask_i32gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i32gather_epi64)|AVX2 [2]|immintrin.h|__m256i _mm256_mask_i32gather_epi64 (\__m256i, \__int64 Konstanten \\*, \__m128i, \__m256i, Konstanten int)|
|[_mm256_mask_i32gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i32gather_pd)|AVX2 [2]|immintrin.h|__m256d _mm256_mask_i32gather_pd (\__m256d, Double Konstanten \*, \__m128i, \__m256d, Konstanten int)|
|[_mm256_mask_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i32gather_ps)|AVX2 [2]|immintrin.h|__m256 _mm256_mask_i32gather_ps (\__m256, float Konstanten \*, \__m256i, \__m256, Konstante int)|
|[_mm256_mask_i64gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i64gather_epi32)|AVX2 [2]|immintrin.h|__m128i _mm256_mask_i64gather_epi32 (\__m128i, int Konstanten \*, \__m256i, \__m128i, Konstante int)|
|[_mm256_mask_i64gather_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i64gather_epi64)|AVX2 [2]|immintrin.h|__m256i _mm256_mask_i64gather_epi64 (\__m256i, \__int64 Konstanten \*, \__m256i, \__m256i, Konstanten int)|
|[_mm256_mask_i64gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i64gather_pd)|AVX2 [2]|immintrin.h|__m256d _mm256_mask_i64gather_pd (\__m256d, Double Konstanten \*, \__m256i, \__m256d, Konstanten int)|
|[_mm256_mask_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i64gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm256_mask_i64gather_ps (\__m128, float Konstanten \*, \__m256i, \__m128, Konstante int)|
|[_mm256_maskload_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_maskload_epi32)|AVX2 [2]|immintrin.h|__m256i _mm256_maskload_epi32 (int Konstanten \*, \__m256i)|
|[_mm256_maskload_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_maskload_epi64)|AVX2 [2]|immintrin.h|__m256i _mm256_maskload_epi64 (\__int64 Konstanten \*, \__m256i)|
|[_mm256_maskload_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_maskload_pd)|AVX [2]|immintrin.h|__m256d _mm256_maskload_pd (Double Konstanten \*, \__m256i)|
|[_mm256_maskload_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_maskload_ps)|AVX [2]|immintrin.h|__m256 _mm256_maskload_ps (float-Konstante \*, \__m256i)|
...
|[_mm256_mpsadbw_epu8](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mpsadbw_epu8)|AVX2 [2]|immintrin.h|__m256i _mm256_mpsadbw_epu8 (\__m256i, \__m256i, Konstante int)|
...
|[_mm256_permute2x128_si256](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_permute2x128_si256)|AVX2 [2]|immintrin.h|__m256i _mm256_permute2x128_si256 (\__m256i, \__m256i, Konstante int)|
|[_mm256_permute4x64_epi64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_permute4x64_epi64)|AVX2 [2]|immintrin.h|__m256i _mm256_permute4x64_epi64 (\__m256i, Konstante int)|
|[_mm256_permute4x64_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_permute4x64_pd)|AVX2 [2]|immintrin.h|__m256d _mm256_permute4x64_pd (\__m256d, Konstante int)|
...
|[_mm256_shuffle_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_shuffle_epi32)|AVX2 [2]|immintrin.h|__m256i _mm256_shuffle_epi32 (\__m256i, Konstante int)|
...
|[_mm256_shuffle_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_shuffle_pd)|AVX [2]|immintrin.h|__m256d _mm256_shuffle_pd (\__m256d, \__m256d, Konstante int)|
|[_mm256_shuffle_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_shuffle_ps)|AVX [2]|immintrin.h|__m256 _mm256_shuffle_ps (\__m256, \__m256, Konstante int)|
|[_mm256_shufflehi_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_shufflehi_epi16)|AVX2 [2]|immintrin.h|__m256i _mm256_shufflehi_epi16 (\__m256i, Konstante int)|
|[_mm256_shufflelo_epi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_shufflelo_epi16)|AVX2 [2]|immintrin.h|__m256i _mm256_shufflelo_epi16 (\__m256i, Konstante int)|
...
|[_mm256_stream_load_si256](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_stream_load_si256)|AVX2 [2]|immintrin.h|__m256i _mm256_stream_load_si256 (\__m256i Konstanten \*)|
...
|[__movsb](movsb.md)||intrin.h|VOID __movsb (Ganzzahl ohne Vorzeichen char \*, Ganzzahl ohne Vorzeichen char Konstanten \*, size_t)|
|[__movsd](movsd.md)||intrin.h|VOID __movsd (Ganzzahl ohne Vorzeichen long \*, Ganzzahl ohne Vorzeichen long Konstanten \*, size_t)|
|[__movsq](movsq.md)||intrin.h|VOID __movsq (unsignierte \__int64 \*, ohne Vorzeichen \__int64 Konstanten \*, size_t)|
|[__movsw](movsw.md)||intrin.h|VOID __movsw (kurz\*ohne Vorzeichen, unsignierte kurze Konstante \*size_t)|
|[_mul128](mul128.md)||intrin.h|__int64 _mul128 (\__int64, \__int64 \__int64 \*)|
|[__mulh](mulh.md)||intrin.h|__int64 \__mulh (\__int64, \__int64)|
|_mulx_u32|BMI [2]|immintrin.h|Ganzzahl ohne Vorzeichen int _mulx_u32 (Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int\*)|
|_mulx_u64|BMI [2]|immintrin.h|nicht signierte __int64 _mulx_u64 (nicht signierte \__int64, ohne Vorzeichen \__int64, unsignierte \__int64\*)|
...
|[__outbyte](outbyte.md)||intrin.h|void-__outbyte (Ganzzahl ohne Vorzeichen Short, Ganzzahl ohne Vorzeichen Char)|
|[__outbytestring](outbytestring.md)||intrin.h|void-__outbytestring (Ganzzahl ohne Vorzeichen Short, Ganzzahl ohne Vorzeichen char \*, Ganzzahl ohne Vorzeichen long)|
|[__outdword](outdword.md)||intrin.h|void-__outdword (Ganzzahl ohne Vorzeichen Short, Ganzzahl ohne Vorzeichen long)|
|[__outdwordstring](outdwordstring.md)||intrin.h|void-__outdwordstring (Ganzzahl ohne Vorzeichen Short, Ganzzahl ohne Vorzeichen long \*, Ganzzahl ohne Vorzeichen long)|
|[__outword](outword.md)||intrin.h|void-__outword (Ganzzahl ohne Vorzeichen Short, Ganzzahl ohne Vorzeichen Short)|
|[__outwordstring](outwordstring.md)||intrin.h|void __outwordstring (Kurzform ohne Vorzeichen, Ganzzahl ohne Vorzeichen Short \*, Ganzzahl ohne Vorzeichen long)|
|[_pdep_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pdep_u32)|BMI [2]|immintrin.h|Ganzzahl ohne Vorzeichen int _pdep_u32 (Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int)|
|[_pdep_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pdep_u64)|BMI [2]|immintrin.h|nicht signierte __int64 _pdep_u64 (unsignierte \__int64, nicht signierte \__int64)|
|[_pext_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pext_u32)|BMI [2]|immintrin.h|Ganzzahl ohne Vorzeichen int _pext_u32 (Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int)|
|[_pext_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_pext_u64)|BMI [2]|immintrin.h|nicht signierte __int64 _pext_u64 (unsignierte \__int64, nicht signierte \__int64)|
...
|[__popcnt64](popcnt16-popcnt-popcnt64.md)|POPCNT|intrin.h|nicht signierte __int64 \__popcnt64 (unsignierte \__int64)|
|[_rdrand16_step](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdrand16_step)|RDRAND [2]|immintrin.h|int-_rdrand16_step (kurz\*ohne Vorzeichen)|
...
|[_rdrand64_step](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdrand64_step)|RDRAND [2]|immintrin.h|int-_rdrand64_step (nicht signierte \__int64 \*)|
|[_rdseed16_step](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdseed16_step)|RDSEED [2]|immintrin.h|int-_rdseed16_step (kurz\*ohne Vorzeichen)|
...
|[_rdseed64_step](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_rdseed64_step)|RDSEED [2]|immintrin.h|int-_rdseed64_step (nicht signierte \__int64 \*)|
|[__rdtsc](rdtsc.md)||intrin.h|nicht signiertes __int64 \__rdtsc (void)|
|[__rdtscp](rdtscp.md)|RDTSCP|intrin.h|nicht signierte __int64 \__rdtscp (Ganzzahl ohne Vorzeichen int\*)|
|[_ReadBarrier](readbarrier.md)||intrin.h|void _ReadBarrier(void)|
|[__readcr0](readcr0.md)||intrin.h|nicht signiertes __int64 \__readcr0 (void)|
|[__readcr2](readcr2.md)||intrin.h|nicht signiertes __int64 \__readcr2 (void)|
|[__readcr3](readcr3.md)||intrin.h|nicht signiertes __int64 \__readcr3 (void)|
|[__readcr4](readcr4.md)||intrin.h|nicht signiertes __int64 \__readcr4 (void)|
|[__readcr8](readcr8.md)||intrin.h|nicht signiertes __int64 \__readcr8 (void)|
|[__readdr](readdr.md)||intrin.h|nicht signierte __int64 \__readdr (ohne Vorzeichen)|
|[__readeflags](readeflags.md)||intrin.h|nicht signiertes __int64 \__readeflags (void)|
...
|[__readgsbyte](readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|Ganzzahl ohne Vorzeichen char __readgsbyte (Ganzzahl ohne Vorzeichen long)|
|[__readgsdword](readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|Ganzzahl ohne Vorzeichen long-__readgsdword (Ganzzahl ohne Vorzeichen long)|
|[__readgsqword](readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|nicht signierte __int64 \__readgsqword (Ganzzahl ohne Vorzeichen long)|
|[__readgsword](readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|kurz__readgsword ohne Vorzeichen (Ganzzahl ohne Vorzeichen long)|
|[__readmsr](readmsr.md)||intrin.h|nicht signierte __int64 \__readmsr (Ganzzahl ohne Vorzeichen long)|
|[__readpmc](readpmc.md)||intrin.h|nicht signierte __int64 \__readpmc (Ganzzahl ohne Vorzeichen long)|
...
|_rorx_u32|BMI [2]|immintrin.h|Ganzzahl ohne Vorzeichen int _rorx_u32 (Ganzzahl ohne Vorzeichen int, Konstante ohne Vorzeichen)|
|_rorx_u64|BMI [2]|immintrin.h|nicht signierte __int64 _rorx_u64 (unsignierte \__int64, Konstante ohne Vorzeichen)|
|[_rotl16](rotl8-rotl16.md)||intrin.h|kurz_rotl16 ohne Vorzeichen (Ganzzahl ohne Vorzeichen Short, Ganzzahl ohne Vorzeichen Char)|
|[_rotl8](rotl8-rotl16.md)||intrin.h|Ganzzahl ohne Vorzeichen char _rotl8 (Ganzzahl ohne Vorzeichen Char, Ganzzahl ohne Vorzeichen Char)|
|[_rotr16](rotr8-rotr16.md)||intrin.h|kurz_rotr16 ohne Vorzeichen (Ganzzahl ohne Vorzeichen Short, Ganzzahl ohne Vorzeichen Char)|
|[_rotr8](rotr8-rotr16.md)||intrin.h|Ganzzahl ohne Vorzeichen char _rotr8 (Ganzzahl ohne Vorzeichen Char, Ganzzahl ohne Vorzeichen Char)|
|_rsm||intrin.h|void _rsm(void)|
|_sarx_i32|BMI [2]|immintrin.h|int _sarx_i32 (int, Ganzzahl ohne Vorzeichen int)|
|_sarx_i64|BMI [2]|immintrin.h|__int64 _sarx_i64 (\__int64, Ganzzahl ohne Vorzeichen int)|
|[__segmentlimit](segmentlimit.md)||intrin.h|Ganzzahl ohne Vorzeichen long-__segmentlimit (Ganzzahl ohne Vorzeichen long)|
|_sgdt||intrin.h|void-_sgdt (void\*)|
|[__shiftleft128](shiftleft128.md)||intrin.h|nicht signierte __int64 \__shiftleft128 (unsignierte \__int64, ohne Vorzeichen \__int64, Ganzzahl ohne Vorzeichen Char)|
|[__shiftright128](shiftright128.md)||intrin.h|nicht signierte __int64 \__shiftright128 (unsignierte \__int64, ohne Vorzeichen \__int64, Ganzzahl ohne Vorzeichen Char)|
|_shlx_u32|BMI [2]|immintrin.h|Ganzzahl ohne Vorzeichen int _shlx_u32 (Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int)|
|_shlx_u64|BMI [2]|immintrin.h|nicht signierte __int64 _shlx_u64 (unsignierte \__int64, Ganzzahl ohne Vorzeichen int)|
|_shrx_u32|BMI [2]|immintrin.h|Ganzzahl ohne Vorzeichen int _shrx_u32 (Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int)|
|_shrx_u64|BMI [2]|immintrin.h|nicht signierte __int64 _shrx_u64 (unsignierte \__int64, Ganzzahl ohne Vorzeichen int)|
|[__sidt](sidt.md)||intrin.h|void-__sidt (void\*)|
|__slwpcb|LWP [1]|ammintrin.h|void \*__slwpcb (void)|
|_stac|SMAP|intrin.h|void _stac(void)|
|_store_be_u16<br /><br /> [_storebe_i16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i16&expand=5141)|MOVBE|immintrin.h|void-_store_be_u16 (void \*, Ganzzahl ohne Vorzeichen Short);<br /><br /> void-_storebe_i16 (void \*, Short); €|
|_store_be_u32<br /><br /> [_storebe_i32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i32&expand=5142)|MOVBE|immintrin.h|void-_store_be_u32 (void \*, Ganzzahl ohne Vorzeichen int);<br /><br /> void-_storebe_i32 (void \*, int); €|
|_store_be_u64<br /><br /> [_storebe_i64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i64&expand=5143)|MOVBE|immintrin.h|void-_store_be_u64 (void \*, Ganzzahl ohne Vorzeichen \__int64);<br /><br /> void-_storebe_i64 (void \*, \__int64); €|
|_Store_HLERelease|HLE [2]|immintrin.h|void-_Store_HLERelease (langes flüchtiges \*, Long)|
...
|[__stosb](stosb.md)||intrin.h|void-__stosb (Ganzzahl ohne Vorzeichen char \*, Ganzzahl ohne Vorzeichen Char, size_t)|
|[__stosd](stosd.md)||intrin.h|void __stosd (Ganzzahl ohne Vorzeichen long \*, Ganzzahl ohne Vorzeichen long, size_t)|
|[__stosq](stosq.md)||intrin.h|void __stosq (nicht signierte \__int64 \*, ohne Vorzeichen \__int64, size_t)|
|[__stosw](stosw.md)||intrin.h|void-__stosw (Ganzzahl ohne Vorzeichen Short \*, Ganzzahl ohne Vorzeichen Short, size_t)|
|_subborrow_u16||intrin.h|Ganzzahl ohne Vorzeichen char _subborrow_u16 (Ganzzahl ohne Vorzeichen Char, Ganzzahl ohne Vorzeichen Short, Ganzzahl ohne Vorzeichen Short, Ganzzahl ohne Vorzeichen Short \*)|
|[_subborrow_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_subborrow_u32)||intrin.h|Ganzzahl ohne Vorzeichen char _subborrow_u32 (Ganzzahl ohne Vorzeichen Char, Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int \*)|
|[_subborrow_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_subborrow_u64)||intrin.h|Ganzzahl ohne Vorzeichen char _subborrow_u64 (unsigniertes Char, Ganzzahl ohne Vorzeichen \__int64, Ganzzahl ohne Vorzeichen \__int64, Ganzzahl ohne Vorzeichen \__int64 \*)|
|_subborrow_u8||intrin.h|Ganzzahl ohne Vorzeichen char _subborrow_u8 (Ganzzahl ohne Vorzeichen Char, Ganzzahl ohne Vorzeichen Char, Ganzzahl ohne Vorzeichen Char, Ganzzahl ohne Vorzeichen char \*)|
...
|_t1mskc_u64|ABM [1]|ammintrin.h|nicht signierte __int64 _t1mskc_u64 (unsignierte \__int64)|
...
|[_tzcnt_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_tzcnt_u64)|BMI|ammintrin.h, immintrin.h|nicht signierte __int64 _tzcnt_u64 (unsignierte \__int64)|
|_tzmsk_u32|ABM [1]|ammintrin.h|unsigned int _tzmsk_u32(unsigned int)|
|_tzmsk_u64|ABM [1]|ammintrin.h|nicht signierte __int64 _tzmsk_u64 (unsignierte \__int64)|
|[__ud2](ud2.md)||intrin.h|void __ud2(void)|
|[_udiv128](udiv128.md)||intrin.h|nicht signierte __int64 _udiv128 (nicht signierte \__int64, ohne Vorzeichen \__int64, unsignierte \__int64, unsignierte \__int64 \*)|
|[_udiv64](udiv64.md)||intrin.h|Ganzzahl ohne Vorzeichen int \_udiv64 (Ganzzahl ohne Vorzeichen \__int64, Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen int *)|
|[__ull_rshift](ull-rshift.md)||intrin.h|Ganzzahl ohne Vorzeichen __int64 [Pascal/cdecl] \__ull_rshift (Ganzzahl ohne Vorzeichen \__int64, int)|
|[_umul128](umul128.md)||intrin.h|nicht signierte __int64 _umul128 (nicht signierte \__int64, ohne Vorzeichen \__int64, unsignierte \__int64 \*)|
|[__umulh](umulh.md)||intrin.h|nicht signierte __int64 \__umulh (unsignierte \__int64, ohne Vorzeichen \__int64)|
|[__vmx_off](vmx-off.md)||intrin.h|void __vmx_off(void)|
|[__vmx_on](vmx-on.md)||intrin.h|nicht signiertes char-__vmx_on (nicht signierte \__int64\*)|
|[__vmx_vmclear](vmx-vmclear.md)||intrin.h|nicht signiertes char-__vmx_vmclear (nicht signierte \__int64\*)|
|[__vmx_vmlaunch](vmx-vmlaunch.md)||intrin.h|unsigned char __vmx_vmlaunch(void)|
|[__vmx_vmptrld](vmx-vmptrld.md)||intrin.h|nicht signiertes char-__vmx_vmptrld (nicht signierte \__int64\*)|
|[__vmx_vmptrst](vmx-vmptrst.md)||intrin.h|void-__vmx_vmptrst (nicht signierte \__int64 \*)|
|[__vmx_vmread](vmx-vmread.md)||intrin.h|Ganzzahl ohne Vorzeichen char __vmx_vmread (size_t, size_t\*)|
|[__vmx_vmresume](vmx-vmresume.md)||intrin.h|unsigned char __vmx_vmresume(void)|
|[__vmx_vmwrite](vmx-vmwrite.md)||intrin.h|Ganzzahl ohne Vorzeichen char __vmx_vmwrite (size_t, size_t)|
|[__wbinvd](wbinvd.md)||intrin.h|void __wbinvd(void)|
|[_WriteBarrier](writebarrier.md)||intrin.h|void _WriteBarrier(void)|
|[__writecr0](writecr0.md)||intrin.h|void-__writecr0 (nicht signierte \__int64)|
|[__writecr3](writecr3.md)||intrin.h|void-__writecr3 (nicht signierte \__int64)|
|[__writecr4](writecr4.md)||intrin.h|void-__writecr4 (nicht signierte \__int64)|
|[__writecr8](writecr8.md)||intrin.h|void-__writecr8 (nicht signierte \__int64)|
|[__writedr](writedr.md)||intrin.h|void __writedr (unsignierte, nicht signierte \__int64)|
|[__writeeflags](writeeflags.md)||intrin.h|void-__writeeflags (nicht signierte \__int64)|
...
|[_writefsbase_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_writefsbase_u64)|FSGSBASE [2]|immintrin.h|void-_writefsbase_u64 (nicht signierte \__int64)|
...
|[_writegsbase_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_writegsbase_u64)|FSGSBASE [2]|immintrin.h|void-_writegsbase_u64 (nicht signierte \__int64)|
|[__writegsbyte](writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void-__writegsbyte (Ganzzahl ohne Vorzeichen long, Ganzzahl ohne Vorzeichen Char)|
|[__writegsdword](writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void-__writegsdword (Ganzzahl ohne Vorzeichen long, Ganzzahl ohne Vorzeichen long)|
|[__writegsqword](writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsqword (unsignierte lange, unsignierte \__int64)|
|[__writegsword](writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void-__writegsword (Ganzzahl ohne Vorzeichen long, Ganzzahl ohne Vorzeichen Short)|
|[__writemsr](writemsr.md)||intrin.h|void __writemsr (unsignierte lange, unsignierte \__int64)|
...
|[_xrstor](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xrstor)|XSAVE [2]|immintrin.h|void-_xrstor (void Konstanten\*, nicht signierte \__int64)|
|[_xrstor64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xrstor64)|XSAVE [2]|immintrin.h|void-_xrstor64 (void Konstanten\*, nicht signierte \__int64)|
|[_xsave](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsave)|XSAVE [2]|immintrin.h|void-_xsave (void\*, Ganzzahl ohne Vorzeichen \__int64)|
|[_xsave64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsave64)|XSAVE [2]|immintrin.h|void-_xsave64 (void\*, Ganzzahl ohne Vorzeichen \__int64)|
|[_xsaveopt](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsaveopt)|XSAVEOPT [2]|immintrin.h|void-_xsaveopt (void\*, Ganzzahl ohne Vorzeichen \__int64)|
|[_xsaveopt64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsaveopt64)|XSAVEOPT [2]|immintrin.h|void-_xsaveopt64 (void\*, Ganzzahl ohne Vorzeichen \__int64)|
|[_xsetbv](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsetbv)|XSAVE [2]|immintrin.h|void _xsetbv (Ganzzahl ohne Vorzeichen int, Ganzzahl ohne Vorzeichen \__int64)|
...
Systeminterne [ARM64](arm64-intrinsics.md) -\
[systeminterne x86-Funktionen](x86-intrinsics-list.md)
