---
title: Intrinsische Funktionen für alle Architekturen
ms.date: 09/02/2019
helpviewer_keywords:
...
ms.locfileid: "70217539"
---
# <a name="intrinsics-available-on-all-architectures"></a>Intrinsische Funktionen für alle Architekturen

Der Microsoft C/C++ Compiler und die universelle C-Lauf Zeit Bibliothek (ucrt) machen einige systeminterne Funktionen in allen Architekturen verfügbar.

## <a name="compiler-intrinsics"></a>Intrinsische Compilerfunktionen

Die folgenden systeminternen Funktionen sind in den x86-, amd64-, Arm-und ARM64-Architekturen verfügbar:
...
## <a name="ucrt-intrinsics"></a>Systeminterne ucrt-Funktionen

Die folgenden ucrt-Funktionen verfügen über intrinsische Formulare in allen Architekturen:
