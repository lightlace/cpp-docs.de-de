...
## <a name="example"></a>Beispiel  
 Aus diesem Beispiel generierte Code verwendet nicht die Fused Multiply Add (**Fma**)-Anweisung auf Itanium-Prozessoren. Wenn Sie auskommentieren `#pragma fp_contract (off)`, der generierte Code verwendet die **Fma** Anweisung.  
