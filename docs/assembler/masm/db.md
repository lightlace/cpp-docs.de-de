...
ms.locfileid: "32052179"
---
# <a name="db"></a>DB
Zum Belegen und optional ein Byte des Speichers für die einzelnen initialisiert `initializer`. `DB` ist ein Synonym für [BYTE](../../assembler/masm/byte-masm.md)  
