---
title: Operator MOD | Microsoft-Dokumentation
ms.custom: ''
ms.date: 08/30/2018
ms.technology:
- cpp-masm
...
ms.locfileid: "43680437"
---
# <a name="operator-mod"></a>Operator MOD

Gibt den ganzzahligen Wert, der den Rest (modulo) zurück, bei der Division *expression1* von *expression2*.
