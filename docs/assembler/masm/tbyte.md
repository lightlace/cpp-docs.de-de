...
ms.locfileid: "32057992"
---
# <a name="tbyte"></a>TBYTE
Zum Belegen und optional initialisiert 10 Bytes des Speichers für die einzelnen `initializer`. Kann auch verwendet werden, als Typspezifizierer an einer beliebigen Stelle ist ein Typ zulässig.  
