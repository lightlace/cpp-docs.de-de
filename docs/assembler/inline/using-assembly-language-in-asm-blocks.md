---
title: Verwenden der Assemblysprache in __asm-Blöcken | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-masm
...
## <a name="microsoft-specific"></a>Microsoft-spezifisch  
 Der Inlineassembler hat viel auch in zahlreichen anderen Assembler. Es akzeptiert z. B. einen Ausdruck, der in MASM zulässig ist. Dieser Abschnitt beschreibt die Verwendung der Assemblysprache Funktionen in `__asm` blockiert.  
...
-   [Die _emit Pseudoinstruction](../../assembler/inline/emit-pseudoinstruction.md)  
