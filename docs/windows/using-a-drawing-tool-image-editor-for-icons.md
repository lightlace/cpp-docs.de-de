...
1. Wählen Sie die **Image** und wählen die **Tools** Befehl.
...
1. Auf der [Symbolleiste der Bildbearbeitung](../windows/toolbar-image-editor-for-icons.md) (oder von der **Image** Menü **Tools** Befehl), wählen Sie die **Zeile** Tool.
...
1. Auf der **Bild-Editor** Symbolleiste (oder von der **Image** Menü **Tools** Befehl), wählen eine **Zeichnen geschlossener Körper** Tool.
...
1. [Festlegen der Hintergrundfarbe](../windows/selecting-foreground-or-background-colors-image-editor-for-icons.md) auf die Farbe, in dem Sie zeichnen möchten.
