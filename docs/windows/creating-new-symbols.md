---
title: Erstellen neuer Symbole | Microsoft-Dokumentation
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
1. In der [Dialogfeld Ressourcensymbole](../windows/resource-symbols-dialog-box.md), wählen Sie **neu**.

2. In der **Namen** geben einen Symbolnamen an.

3. Akzeptieren Sie den zugewiesenen Symbolwert.

   - oder - 

   In der **Wert** geben einen neuen Wert.
