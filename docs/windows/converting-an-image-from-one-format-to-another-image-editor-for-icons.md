...
2. Von der **Datei** Menü wählen **speichern *Filename* als**.

3. In der **Datei speichern unter** Dialogfeld die **Dateiname** geben den Dateinamen und die Erweiterung ein, das Format angezeigt werden sollen.
