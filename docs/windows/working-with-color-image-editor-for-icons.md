...
- Zum Anzeigen der **Farben** Fenster mit der rechten Maustaste in ein **Bild-Editor** Bereich, und wählen Sie **Fenster "Farben" anzeigen**, oder wählen Sie **anzeigen Fenster "Farben"** auf die [des bildmenüs](../windows/image-menu-image-editor-for-icons.md).
...
1. Auf der **Bildbearbeitung** Symbolleiste (oder verwenden Sie **Image** > **Tools**), wählen die **füllen** Tool.
...
Umkehren von Farben in der aktuellen Auswahl, auf die **Image** , wählen Sie im Menü **Farben umkehren**.
