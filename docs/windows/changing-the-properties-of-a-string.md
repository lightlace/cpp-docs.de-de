---
title: Ändern der Eigenschaften einer Zeichenfolge | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "33860602"
---
# <a name="changing-the-properties-of-a-string"></a>Ändern der Eigenschaften einer Zeichenfolge
### <a name="to-change-a-string-or-its-identifier"></a>So ändern Sie eine Zeichenfolge oder seines Bezeichners  
...
2.  Wählen Sie die Zeichenfolge, die Sie bearbeiten möchten, und doppelklicken Sie auf die **ID**, **Wert**, oder **Beschriftung** Spalte. Jetzt können Sie:  
  
    -   Wählen Sie eine **ID** aus der **ID Dropdownelement** aus, oder geben Sie eine ID direkt.  
    ...
    -   Geben Sie die Änderungen in der **Beschriftung** Spalte.  
        ...
        > [!NOTE]
        >  Sie können auch Eigenschaften in einer Zeichenfolge bearbeiten der [Fenster "Eigenschaften"](/visualstudio/ide/reference/properties-window).  
