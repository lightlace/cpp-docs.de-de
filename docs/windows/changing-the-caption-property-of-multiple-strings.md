---
title: Ändern der Beschriftungseigenschaft "mehrerer Zeichenfolgen | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "33860280"
---
# <a name="changing-the-caption-property-of-multiple-strings"></a>Ändern der Eigenschaft "Beschriftung" mehrerer Zeichenfolgen
Das folgende Verfahren veranschaulicht das Ändern der Beschriftungseigenschaft mehrerer Zeichenfolgen.  
  
### <a name="to-change-the-caption-property-of-multiple-strings"></a>Ändern der Beschriftungseigenschaft mehrerer Zeichenfolgen  
...
2.  Wählen Sie die Zeichenfolgen, die Sie ändern, indem Sie sie gedrückt halten, möchten die **STRG** -Taste Sie jeweils klicken.  
