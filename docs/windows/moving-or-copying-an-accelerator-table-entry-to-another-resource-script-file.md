---
title: Verschieben oder Kopieren eines Eintrags in einer Zugriffstastentabelle in eine andere Ressourcenskriptdatei | Microsoft-Dokumentation
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "42603497"
---
# <a name="moving-or-copying-an-accelerator-table-entry-to-another-resource-script-file"></a>Verschieben oder Kopieren eines Eintrags in einer Zugriffstastentabelle in eine andere Ressourcenskriptdatei
...
2. Markieren Sie den Eintrag, der verschoben werden soll.

3. Von der **bearbeiten** Menü wählen **Kopie** oder **Ausschneiden**.

4. Markieren Sie einen Eintrag in der Ziel-Ressourcenskriptdatei.
