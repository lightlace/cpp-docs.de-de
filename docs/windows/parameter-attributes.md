---
title: Parameterattribute | Microsoft-Dokumentation
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
|[iid_is](../windows/iid-is.md)|Gibt den Index des ersten Arrayelements übertragen werden.|
