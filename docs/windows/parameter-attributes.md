---
title: Parameterattribute | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "33879395"
---
# <a name="parameter-attributes"></a>Parameterattribute
Die folgenden Attribute beziehen sich auf die Parameter einer Methode in einer Klasse oder Schnittstelle.  
...
|[iid_is](../windows/iid-is.md)|Gibt den Index des ersten Arrayelements übermittelt werden sollen.|  
