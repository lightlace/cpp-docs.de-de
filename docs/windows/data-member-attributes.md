...
Die folgenden Attribute gelten für die Datenmember in einer Klasse, einer Schnittstelle oder einer Co\-Klasse zu.  
  
|Attribut|Beschreibung|  
|--------------|------------------|  
|[db\_accessor](../windows/db-accessor.md)|Gruppen **db\_column**\-Attribute, die an er\-basiert Bindung `IAccessor`teilnehmen.|  
...
|[readonly](../windows/readonly-cpp.md)|Verhindert Zuweisung zu einem Datenmember.|  
