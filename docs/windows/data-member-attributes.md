---
title: Datenmemberattribute | Microsoft-Dokumentation
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
|---------------|-----------------|
|[db_accessor](../windows/db-accessor.md)|Gruppen `db_column` Attribute, die Teilnahme an `IAccessor`-basierten Bindung.|
