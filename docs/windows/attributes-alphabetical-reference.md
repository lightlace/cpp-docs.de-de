...
|[helpstring](../windows/helpstring.md)|Gibt die ID des Hilfethemas in eine .hlp oder CHM-Datei an.|
...
|[requires_category](../windows/requires-category.md)|Gibt Kategorien von erforderliche Komponente für die Klasse an.|
...
|[synchronize](../windows/synchronize.md)|Synchronisiert den Zugriff auf eine Methode.|
