...
### So kopieren Sie Schaltflächen von einer Symbolleiste  
  
1.  Halten Sie die STRG\-TASTE gedrückt.  
  
2.  Ziehen Sie die Schaltfläche in der **Symbolleistenansicht** entweder an die neue Position auf der Symbolleiste oder an eine Position auf einer anderen Symbolleiste.  
