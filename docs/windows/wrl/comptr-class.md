...
Der erste Konstruktor ist der Standardkonstruktor, der implizit ein leeres Objekt erstellt. Gibt an, der zweite Konstruktor [__nullptr](../nullptr-cpp-component-extensions.md), die explizit erstellt ein leeres Objekt.
