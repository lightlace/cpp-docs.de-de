...
> [!NOTE]
>  Diese Informationen gelten nicht für Ressourcen in Windows Store-Apps. Weitere Informationen finden Sie unter [Definieren von App-Ressourcen](http://msdn.microsoft.com/en-us/476ea844-632c-4467-9ce3-966be1350dd4).  
