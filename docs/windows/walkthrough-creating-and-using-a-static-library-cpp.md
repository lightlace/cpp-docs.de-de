...
1. Geben Sie einen Namen für das Projekt, z. B. *MathFuncsLib*– in der **Namen** Feld. Geben Sie einen Namen für die Lösung, z. B. *StaticLibrary*– in der **Projektmappenname** Feld. Klicken Sie auf die Schaltfläche **OK** .
