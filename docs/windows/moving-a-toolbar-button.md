---
title: Verschieben einer Symbolleisten-Schaltfläche (C++) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "44315716"
---
# <a name="moving-a-toolbar-button"></a>Verschieben einer Symbolleisten-Schaltfläche

### <a name="to-move-a-toolbar-button-c"></a>Verschieben eine Symbolleisten-Schaltfläche (C++)
