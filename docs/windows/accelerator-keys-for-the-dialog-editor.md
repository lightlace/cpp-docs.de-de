---
title: Zugriffstasten für den Dialog-Editor (C++) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "44313571"
---
# <a name="accelerator-keys-for-the-dialog-editor-c"></a>Zugriffstasten für den Dialog-Editor (C++)
