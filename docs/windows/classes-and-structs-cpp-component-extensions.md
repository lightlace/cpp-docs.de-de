...
Finden Sie unter [Verweisklassen und Strukturen](../cppcx/ref-classes-and-structs-c-cx.md) und [Wertklassen und Strukturen](http://msdn.microsoft.com/library/windows/apps/hh699861.aspx).
