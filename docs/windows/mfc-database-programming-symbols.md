...
Die in dieser Tabelle enthaltenen Symbole werden in einem MFC\-Projekt nur angezeigt, falls diesem Datenbankunterstützung hinzugefügt wurde.  Sie unterstützen die MFC\-Verbindung mit SQL\-Servern sowie die Datenbankprogrammierung.  
