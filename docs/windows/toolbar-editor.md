...
-   [Erstellen neuer Symbolleisten und Schaltflächen](../mfc/creating-new-toolbars.md)  
  
-   [Konvertieren von Bitmaps in Symbolleistenressourcen](../mfc/converting-bitmaps-to-toolbars.md)  
  
-   [Erstellen, Verschieben und Bearbeiten von Schaltflächen der Symbolleiste](../mfc/creating-moving-and-editing-toolbar-buttons.md)  
  
-   [Erstellen von QuickInfos](../mfc/creating-a-tool-tip-for-a-toolbar-button.md)  
