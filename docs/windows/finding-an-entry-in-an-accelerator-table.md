---
title: Suchen eines Eintrags in einer Zugriffstastentabelle | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
2.  Klicken Sie auf eine Spaltenüberschrift, um den Inhalt der Spalte alphabetisch zu sortieren. Klicken Sie beispielsweise auf **ID** auf alle IDs, die in der Zugriffstastentabelle in alphabetischer Reihenfolge anzuzeigen.  
