...
-   [Domänenfehler](../c-language/domain-errors.md)  
...
-   [Beenden von Zeilenumbruchzeichen](../c-language/terminating-newline-characters.md)  
...
-   [Dateizugriffsgrenzen](../c-language/file-access-limits.md)  
  
-   [Löschen von offenen Dateien](../c-language/deleting-open-files.md)  
  
-   [Umbenennen mit einem bereits vorhandenen Namen](../c-language/renaming-with-a-name-that-exists.md)  
  
-   [Lesen von Zeigerwerten](../c-language/reading-pointer-values.md)  
  
-   [Lesen von Bereichen](../c-language/reading-ranges.md)  
