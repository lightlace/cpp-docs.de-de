...
|[CWindow::GetWindowPlacement](#getwindowplacement)|Ansichtszustand und Positionen abgerufen.|  
...
|[CWindow::RedrawWindow](#redrawwindow)|Aktualisiert eine angegebene Rechteck oder die Region des Clientbereichs.|  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [SendMessage](http://msdn.microsoft.com/library/windows/desktop/ms644950) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="parameters"></a>Parameter  
 ...
 `bDeep`  
 [in] Wenn **TRUE** (Standardwert), wird die Nachricht an alle untergeordneten Fenster gesendet werden; andernfalls wird nur für die unmittelbar untergeordneten Fenster gesendet werden.  
  
### <a name="remarks"></a>Hinweise  
 Wenn `bDeep` ist **TRUE**, außerdem wird die Nachricht an alle anderen untergeordneten Fenster gesendet.  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [SendNotifyMessage](http://msdn.microsoft.com/library/windows/desktop/ms644953) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
 Wenn das Fenster vom aufrufenden Thread erstellt wurde `SendNotifyMessage` nicht zurückgegeben, bis die Fensterprozedur die Meldung verarbeitet hat. Andernfalls gibt es sofort.  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [SetActiveWindow](http://msdn.microsoft.com/library/windows/desktop/ms646311) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
### <a name="example"></a>Beispiel  
 [!code-cpp[NVC_ATL_Windowing&#30;](../../atl/codesnippet/cpp/cwindow-class_30.cpp)]  
  
##  <a name="setcapture"></a>CWindow::SetCapture  
 Sendet alle nachfolgenden Mauseingaben für das Fenster.  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [SetCapture](http://msdn.microsoft.com/library/windows/desktop/ms646262) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
##  <a name="setclipboardviewer"></a>CWindow::SetClipboardViewer  
 Die Kette der Zwischenablage-Viewer hinzugefügt Fenster.  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [SetClipboardViewer](http://msdn.microsoft.com/library/windows/desktop/ms649052) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
##  <a name="setdlgitemint"></a>CWindow::SetDlgItemInt  
 Ändert die Text in die String-Darstellung eines ganzzahligen Werts.  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [SetDlgItemInt](http://msdn.microsoft.com/library/windows/desktop/ms645518) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [SetDlgItemText](http://msdn.microsoft.com/library/windows/desktop/ms645521) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [SetFocus](http://msdn.microsoft.com/library/windows/desktop/ms646312) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="parameters"></a>Parameter  
 `wVirtualKeyCode`  
 [in] Die virtuellen Tastencode der Taste. Eine Liste der standardmäßigen virtuellen Tastencodes finden Sie in Winuser.h.  
  
 `wModifiers`  
 [in] Die Modifizierer für den aktiven Schlüssel. Eine Liste der möglichen Werte finden Sie unter **WM_SETHOTKEY** in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
### <a name="return-value"></a>Rückgabewert  
 Eine Liste der möglichen Werte zurückgeben, finden Sie unter [WM_SETHOTKEY](http://msdn.microsoft.com/library/windows/desktop/ms646284) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
##  <a name="seticon"></a>CWindow::SetIcon  
 Wird das Fenster große oder kleine Symbol auf das Symbol identifizierten `hIcon`.  
...
### <a name="parameters"></a>Parameter  
 ...
 `bBigIcon`  
 [in] Wenn **TRUE** (Standardwert), legt die Methode ein großes Symbol fest. Andernfalls wird ein kleines Symbol.  
...
##  <a name="setmenu"></a>CWindow::SetMenu  
 Ändert die aktuelle Fenstermenü.  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [SetMenu](http://msdn.microsoft.com/library/windows/desktop/ms647995) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [SetParent](http://msdn.microsoft.com/library/windows/desktop/ms633541) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
### <a name="example"></a>Beispiel  
 [!code-cpp[NVC_ATL_Windowing&#32;](../../atl/codesnippet/cpp/cwindow-class_32.cpp)]  
  
##  <a name="setredraw"></a>CWindow::SetRedraw  
 Aktiviert oder deaktiviert das Neuzeichnen Flag durch Senden einer [WM_SETREDRAW](http://msdn.microsoft.com/library/windows/desktop/dd145219) Meldung im Fenster.  
...
### <a name="parameters"></a>Parameter  
 `bRedraw`  
 [in] Gibt den Status des Flags liegt. Wenn **TRUE** (Standardwert), das Neuzeichnen Flag festgelegt ist, wenn **FALSE**, das Flag gelöscht wird.  
  
### <a name="remarks"></a>Hinweise  
 Rufen Sie `SetRedraw` zu Änderungen neu gezeichnet wird, oder um zu verhindern, dass die Änderungen neu gezeichnet wird.  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [SetScrollInfo](http://msdn.microsoft.com/library/windows/desktop/bb787595) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [SetScrollPos](http://msdn.microsoft.com/library/windows/desktop/bb787597) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [SetScrollRange](http://msdn.microsoft.com/library/windows/desktop/bb787599) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [SetTimer](http://msdn.microsoft.com/library/windows/desktop/ms644906) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [SetWindowContextHelpId](http://msdn.microsoft.com/library/windows/desktop/bb762101) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [SetWindowLong](http://msdn.microsoft.com/library/windows/desktop/ms633591) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
##  <a name="setwindowlongptr"></a>CWindow::SetWindowLongPtr  
 Ändert ein Attribut des angegebenen Fensters und stellt auch einen Wert am angegebenen Offset in den Speicher zusätzliche Fenster.  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [SetWindowLongPtr](http://msdn.microsoft.com/library/windows/desktop/ms644898) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
 Diese Funktion ersetzt die `CWindow::SetWindowLong` Methode. Verwenden Sie zum Schreiben von Code, die kompatibel mit 32-Bit- und 64-Bit-Versionen von Windows ist `CWindow::SetWindowLongPtr`.  
  
##  <a name="setwindowplacement"></a>CWindow::SetWindowPlacement  
 Ansichtszustand und Positionen festgelegt.  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [SetWindowPlacement](http://msdn.microsoft.com/library/windows/desktop/ms633544) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [SetWindowPos](http://msdn.microsoft.com/library/windows/desktop/ms633545) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
 Die zweite Version dieser Methode verwendet eine [RECT](http://msdn.microsoft.com/library/windows/desktop/dd162897) Struktur, um die neue Position, Breite und Höhe des Fensters festlegen.  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [SetWindowRgn](http://msdn.microsoft.com/library/windows/desktop/dd145102) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
##  <a name="setwindowtext"></a>CWindow::SetWindowText  
 Ändert das Fenster Text.  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [SetWindowText](http://msdn.microsoft.com/library/windows/desktop/ms633546) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [ShowCaret](http://msdn.microsoft.com/library/windows/desktop/ms648406) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [ShowOwnedPopups](http://msdn.microsoft.com/library/windows/desktop/ms633547) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [ShowScrollBar](http://msdn.microsoft.com/library/windows/desktop/bb787601) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [ShowWindow](http://msdn.microsoft.com/library/windows/desktop/ms633548) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
### <a name="example"></a>Beispiel  
 [!code-cpp[NVC_ATL_Windowing Nr.&36;](../../atl/codesnippet/cpp/cwindow-class_36.cpp)]  
  
##  <a name="showwindowasync"></a>CWindow::ShowWindowAsync  
 Legt den Anzeigezustand eines Fensters von einem anderen Thread erstellt.  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [ShowWindowAsync](http://msdn.microsoft.com/library/windows/desktop/ms633549) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [UpdateWindow](http://msdn.microsoft.com/library/windows/desktop/dd145167) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [ValidateRect](http://msdn.microsoft.com/library/windows/desktop/dd145194) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [ValidateRgn](http://msdn.microsoft.com/library/windows/desktop/dd145195) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 Finden Sie unter [WinHelp](http://msdn.microsoft.com/library/windows/desktop/bb762267) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
