...
## <a name="aggregation-and-class-factory-macrosaggregation-and-class-factory-macrosmd"></a>[Aggregation und Factory-Makros](aggregation-and-class-factory-macros.md)
## <a name="category-macroscategory-macrosmd"></a>[Kategorie-Makros](category-macros.md)
## <a name="com-map-macroscom-map-macrosmd"></a>[Makros für COM-Zuordnung](com-map-macros.md)
...
## <a name="connection-point-macrosconnection-point-macrosmd"></a>[Connection Point-Makros](connection-point-macros.md)
## <a name="debugging-and-error-reporting-macrosdebugging-and-error-reporting-macrosmd"></a>[Debuggen und die Fehlerberichterstattung Makros](debugging-and-error-reporting-macros.md)
## <a name="exception-handling-macrosexception-handling-macrosmd"></a>[Behandlung von Ausnahmemakros](exception-handling-macros.md)
## <a name="message-map-macros-atlmessage-map-macros-atlmd"></a>[Meldungszuordnungsmakros (ATL)](message-map-macros-atl.md)
## <a name="object-map-macrosobject-map-macrosmd"></a>[Map-Makros](object-map-macros.md)
## <a name="object-status-macrosobject-status-macrosmd"></a>[Status-Makros](object-status-macros.md)
## <a name="property-map-macrosproperty-map-macrosmd"></a>[Eigenschaftenmakros](property-map-macros.md)
## <a name="registry-data-exchange-macrosregistry-data-exchange-macrosmd"></a>[Registrierung Data Exchange-Makros](registry-data-exchange-macros.md)
## <a name="registry-macrosregistry-macrosmd"></a>[Registrierung von Makros](registry-macros.md)
## <a name="service-map-macrosservice-map-macrosmd"></a>[Dienst-Map-Makros](service-map-macros.md)
## <a name="snap-in-object-macrossnap-in-object-macrosmd"></a>[Snap-in-Makros](snap-in-object-macros.md)
## <a name="string-conversion-macrosstring-conversion-macrosmd"></a>[Zeichenfolgenkonvertierungsmakros](string-conversion-macros.md)
## <a name="window-class-macroswindow-class-macrosmd"></a>[Fenster-Makros](window-class-macros.md)
## <a name="windows-messages-macroswindows-messages-macrosmd"></a>[Windows-Nachrichten Makros](windows-messages-macros.md)
...
## <a name="catlautothreadmodule-classcatlautothreadmodule-classmd"></a>[CComModule-Klasse](catlautothreadmodule-class.md)
...
## <a name="catlmodule-classcatlmodule-classmd"></a>[Von CAtlModule-Klasse](catlmodule-class.md)
...
## <a name="ccomautothreadmodule-classccomautothreadmodule-classmd"></a>[Der CComAutoThreadModule-Klasse](ccomautothreadmodule-class.md)
...
## <a name="ccomcontrolbase-classccomcontrolbase-classmd"></a>[-Klasse](ccomcontrolbase-class.md)
...
## <a name="ccontainedwindowt-classccontainedwindowt-classmd"></a>[CContainedWindow-Klasse](ccontainedwindowt-class.md)
## <a name="ccrtallocator-classccrtallocator-classmd"></a>[CCRTAllocator-Klasse](ccrtallocator-class.md)
## <a name="ccrtheap-classccrtheap-classmd"></a>[CCRTHeap-Klasse](ccrtheap-class.md)
...
## <a name="crbmap-classcrbmap-classmd"></a>[CRBMultiMap-Klasse](crbmap-class.md)
...
## <a name="iobjectsafetyimpl-classiobjectsafetyimpl-classmd"></a>[Fügen Sie IObjectSafetyImpl-Klasse](iobjectsafetyimpl-class.md)
...
## <a name="com-map-global-functionscom-map-global-functionsmd"></a>[Globale Funktionen COM-Zuordnung](com-map-global-functions.md)
...
## <a name="connection-point-global-functionsconnection-point-global-functionsmd"></a>[Verbindungspunkt globale Funktionen](connection-point-global-functions.md)
## <a name="device-context-global-functionsdevice-context-global-functionsmd"></a>[Gerät Kontext globale Funktionen](device-context-global-functions.md)
...
## <a name="event-handling-global-functionsevent-handling-global-functionsmd"></a>[Globale Funktionen zur Verarbeitung von Ereignis](event-handling-global-functions.md)
## <a name="marshaling-global-functionsmarshaling-global-functionsmd"></a>[Marshalling globale Funktionen](marshaling-global-functions.md)
...
## <a name="registry-and-typelib-global-functionsregistry-and-typelib-global-functionsmd"></a>[Registrierung und TypeLib globale Funktionen](registry-and-typelib-global-functions.md)
## <a name="security-global-functionssecurity-global-functionsmd"></a>[Globale Funktionen für Sicherheit](security-global-functions.md)
## <a name="security-identifier-global-functionssecurity-identifier-global-functionsmd"></a>[Globaler Bezeichner Sicherheitsfunktionen](security-identifier-global-functions.md)
## <a name="server-registration-global-functionsserver-registration-global-functionsmd"></a>[Server-Registrierung globale Funktionen](server-registration-global-functions.md)
## <a name="winmodule-global-functionswinmodule-global-functionsmd"></a>[WinModule globale Funktionen](winmodule-global-functions.md)
# <a name="atl-global-variablesatl-global-variablesmd"></a>[ATL-globale Variablen](atl-global-variables.md)
...
## <a name="atlfuncinfo-structureatl-func-info-structuremd"></a>[Sie _ATL_FUNC_INFO-Struktur](atl-func-info-structure.md)
...
## <a name="worker-archetypeworker-archetypemd"></a>[Worker-Prototyp](worker-archetype.md)
# <a name="atl-wizards-and-dialog-boxesatl-wizards-and-dialog-boxesmd"></a>[ATL-Assistenten und Dialogfeldern](atl-wizards-and-dialog-boxes.md)
...
#### <a name="application-settings-atl-project-wizardapplication-settings-atl-project-wizardmd"></a>[ApplicationSettings, ATL-Projekt-Assistent](application-settings-atl-project-wizard.md)
...
### <a name="mfc-support-in-atl-projectsmfc-support-in-atl-projectsmd"></a>[MFC-Unterstützung in ATL-Projekte](mfc-support-in-atl-projects.md)
### <a name="com-10-support-in-atl-projectscom-plus-1-0-support-in-atl-projectsmd"></a>[COM+ 1.0-Unterstützung in ATL-Projekte](com-plus-1-0-support-in-atl-projects.md)
...
### <a name="specifying-compiler-optimization-for-an-atl-projectspecifying-compiler-optimization-for-an-atl-projectmd"></a>[Angeben von Compileroptimierungen für ein ATL-Projekt](specifying-compiler-optimization-for-an-atl-project.md)
...
### <a name="making-an-atl-object-noncreatablemaking-an-atl-object-noncreatablemd"></a>[Erstellen eines ATL-Objekts als nicht erstellbares](making-an-atl-object-noncreatable.md)
## <a name="adding-an-atl-simple-objectadding-an-atl-simple-objectmd"></a>[Ein einfaches ATL-Objekt hinzufügen](adding-an-atl-simple-object.md)
### <a name="atl-simple-object-wizardatl-simple-object-wizardmd"></a>[Einfaches ATL-Assistenten](atl-simple-object-wizard.md)
#### <a name="options-atl-simple-object-wizardoptions-atl-simple-object-wizardmd"></a>[Einfaches ATL-Assistenten-Optionen](options-atl-simple-object-wizard.md)
...
### <a name="atl-ole-db-provider-wizardatl-ole-db-provider-wizardmd"></a>[ATL-OLE DB-Anbieter-Assistenten](atl-ole-db-provider-wizard.md)
...
### <a name="atl-ole-db-consumer-wizardatl-ole-db-consumer-wizardmd"></a>[ATL-OLE DB-Consumer-Assistenten](atl-ole-db-consumer-wizard.md)
## <a name="adding-an-atl-dialog-boxadding-an-atl-dialog-boxmd"></a>[Hinzufügen einer ATL-Dialogfelds](adding-an-atl-dialog-box.md)
### <a name="atl-dialog-wizardatl-dialog-wizardmd"></a>[ATL-Dialogfeld-Assistenten](atl-dialog-wizard.md)
...
#### <a name="com-10-atl-com-10-component-wizardcom-plus-1-0-atl-com-plus-1-0-component-wizardmd"></a>[COM+ 1.0, ATL COM+ 1.0-Assistenten](com-plus-1-0-atl-com-plus-1-0-component-wizard.md)
## <a name="adding-an-atl-active-server-page-componentadding-an-atl-active-server-page-componentmd"></a>[Hinzufügen einer ATL Active Server Page-Komponente](adding-an-atl-active-server-page-component.md)
### <a name="atl-active-server-page-component-wizardatl-active-server-page-component-wizardmd"></a>[ATL Active Server Page-Komponente-Assistent](atl-active-server-page-component-wizard.md)
### <a name="options-atl-active-server-page-component-wizardoptions-atl-active-server-page-component-wizardmd"></a>[Optionen, ATL Active Server Page-Komponente-Assistent](options-atl-active-server-page-component-wizard.md)
### <a name="asp-atl-active-server-page-component-wizardasp-atl-active-server-page-component-wizardmd"></a>[ASP, ATL Active Server Page-Komponente-Assistent](asp-atl-active-server-page-component-wizard.md)
