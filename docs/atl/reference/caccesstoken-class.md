...
Zeiger auf eine [PROCESS_INFORMATION Struktur](/windows/win32/api/processthreadsapi/ns-processthreadsapi-process_information) , Identifikationsinformationen über den neuen Prozess empfängt.
