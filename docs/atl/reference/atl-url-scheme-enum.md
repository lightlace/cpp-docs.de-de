---
title: ATL_URL_SCHEME-Enumeration | Microsoft-Dokumentation
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Die Member dieser Enumeration Geben Sie Konstanten für die Schemas verständlich [CUrl](curl-class.md).  
