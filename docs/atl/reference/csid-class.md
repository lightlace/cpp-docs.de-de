...
|[operator \<](#operator_lt)|Vergleicht die relativen Wert von zwei Security Descriptor-Objekten.|
|[operator >](#operator_gt)|Vergleicht die relativen Wert von zwei Security Descriptor-Objekten.|
