...
`CComSafeArray` stellt einen Wrapper für die [SAFEARRAY Data Type](/windows/desktop/api/oaidl/ns-oaidl-tagsafearray) -Klasse bereit, wodurch sich ein- und mehrdimensionale Arrays von nahezu jedem der VARIANT-unterstützten Typen problemlos erstellen und verwalten lassen.
...
[SAFEARRAY-Datentyp](/windows/desktop/api/oaidl/ns-oaidl-tagsafearray)<br/>
