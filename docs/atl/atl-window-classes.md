---
title: ATL-Fensterklassen | Microsoft-Dokumentation
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-atl
...
ATL enthält mehrere Klassen, mit denen Sie zur Verwendung und Implementierung von Windows. Diese Klassen, wie anderen ATL-Klassen bieten eine effiziente Implementierung, die ein Mehraufwand für Ihren Code nicht verlangt.
