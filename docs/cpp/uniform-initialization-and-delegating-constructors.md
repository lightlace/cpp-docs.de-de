...
manager: "ghogen"
---
# Einheitliche Initialisierung und Delegierung von Konstruktoren
[!INCLUDE[vs2017banner](../assembler/inline/includes/vs2017banner.md)]

In modernem C\+\+ können Sie die *Initialisierung mit geschweiften Klammern* für jeden Typ ohne das Gleichheitszeichen verwenden.  Außerdem können Sie delegierende Konstruktoren verwenden, um den Code zu vereinfachen, wenn mehrere Konstruktoren ähnliche Aufgaben ausführen.  
...
## initializer\_list\-Konstruktoren  
 Das [initializer\_list Class](../standard-library/initializer-list-class.md)\-Objekt stellt eine Liste von Objekten eines angegebenen Typs dar, die in einem Konstruktor und in anderen Kontexten verwendet werden können.  Sie können ein initializer\_list\-Objekt durch Verwenden der Initialisierung mit geschweiften Klammern erstellen:  
...
> [!IMPORTANT]
>  Um diese Klasse zu verwenden, müssen Sie den [\<initializer\_list\>](../standard-library/initializer-list.md)\-Header einfügen.  
