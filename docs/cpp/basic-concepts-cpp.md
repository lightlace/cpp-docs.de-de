...
- [Bereich eines C++-Objekt oder -Funktion](../cpp/scope-visual-cpp.md)
...
- [L-Werte und der R-Werte](../cpp/lvalues-and-rvalues-visual-cpp.md)
...
- [Trivial, Standardlayout- und einfache Typen](../cpp/trivial-standard-layout-and-pod-types.md)
