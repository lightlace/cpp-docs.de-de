...
## Hinweise  
 ...
 Weitere Informationen finden Sie unter [static\_cast](../cpp/static-cast-operator.md). Dort wird der Unterschied zwischen den statischen und dynamischen Umwandlungskonvertierungen erklärt, und Sie erfahren, wann sie jeweils zu verwenden sind.  
...
```  
 ...
 ![Klassenhierarchie mit mehrfacher Vererbung](../cpp/media/vc39011.png "vc39011")  
...
```  
 ...
 Der Wert eines Fehlers bei einer Umwandlung in einen Zeigertyp ist der NULL\-Zeiger.  Ein Fehler bei einer Umwandlung in den Referenztyp löst eine [bad\_cast\-Ausnahme](../cpp/bad-cast-exception.md) aus. Wenn `expression` nicht auf ein gültiges Objekt zeigt oder verweist, wird eine `__non_rtti_object`\-Ausnahme ausgelöst.  
