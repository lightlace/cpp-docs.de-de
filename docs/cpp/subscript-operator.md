---
title: 'Subscript-Operator: | Microsoft-Dokumentation'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-language
...
```  
 ...
 Der Indexoperator ist kommutativ. Daher sind die Begriffe *Array*[*Index*] und *Array*[*Array*] sind garantiert gleichwertig so lange, wie der Index Operator ist nicht überladen (siehe [überladene Operatoren](../cpp/operator-overloading.md)). Die erste Form entspricht der gängigsten Codierungspraxis, aber beide funktionieren.  
