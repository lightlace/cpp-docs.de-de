...
> [!IMPORTANT]
>  Die [/Wp64](../build/reference/wp64-detect-64-bit-portability-issues.md) Compileroption und **__w64** -Schlüsselwort sind in Visual Studio 2010 und Visual Studio 2013 veraltet und entfernt in Visual Studio 2013. Bei Verwendung der `/Wp64` -Compileroption in der Befehlszeile, die der Compiler eine Befehlszeilenwarnung d9002. Die **__w64** -Schlüsselwort wird stillschweigend ignoriert. Verwenden Sie statt dieser Option und dieses Schlüsselworts zum Ermitteln von 64-Bit-Portabilitätsproblemen eine Microsoft C++ -Compiler, der eine 64-Bit-Plattform konzipiert ist. Weitere Informationen finden Sie unter [Konfigurieren von Visual C++ für 64-Bit-X64 Ziele](../build/configuring-programs-for-64-bit-visual-cpp.md).

Jede Typedef, die **__w64** auf es auf X86 32 Bit und 64-Bit auf X64 sein muss.

Um Portabilitätsprobleme mit Versionen von Microsoft zu erkennen C++ -Compiler vor Visual Studio 2010 die **__w64** Schlüsselwort muss angegeben werden, bei allen Typendefinitionen, deren Größe zwischen 32-Bit und 64-Bit-Plattformen ändert. Für einen solchen Typ **__w64** muss nur in der 32-Bit-Definition der Typedef angezeigt werden.
