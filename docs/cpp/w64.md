...
Um Portabilitätsprobleme mit Versionen des visuellen Elements zu erkennen C++ -Compiler vor Visual Studio 2010 die **__w64** Schlüsselwort muss angegeben werden, bei allen Typendefinitionen, deren Größe zwischen 32-Bit und 64-Bit-Plattformen ändert. Für einen solchen Typ **__w64** muss nur in der 32-Bit-Definition der Typedef angezeigt werden.
