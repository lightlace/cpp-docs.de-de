---
title: Verwenden der strukturierten Ausnahmebehandlung mit C++ | Microsoft-Dokumentation
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-language
