# [C++-Sprache und Standardbibliotheken](c-cpp-language-and-standard-libraries.md)
# [Willkommen zurück bei C++ (Modern C++)](welcome-back-to-cpp-modern-cpp.md)
## [Unterstützung für C++11/14/17-Funktionen (Modern C++)](support-for-cpp11-14-17-features-modern-cpp.md)
...
### [Gewusst wie: Erstellen und Verwenden von unique_ptr-Instanzen](how-to-create-and-use-unique-ptr-instances.md)
### [Gewusst wie: Erstellen und Verwenden von shared_ptr-Instanzen](how-to-create-and-use-shared-ptr-instances.md)
### [Gewusst wie: Erstellen und Verwenden von weak_ptr-Instanzen](how-to-create-and-use-weak-ptr-instances.md)
### [Gewusst wie: Erstellen und Verwenden von CComPtr- und CComQIPtr-Instanzen](how-to-create-and-use-ccomptr-and-ccomqiptr-instances.md)
## [pimpl für Compilierungszeitkapselung (Modern C++)](pimpl-for-compile-time-encapsulation-modern-cpp.md)
...
### [Gewusst wie: Entwurfsrichtlinien für sichere Ausnahmebehandlung](how-to-design-for-exception-safety.md)
### [Gewusst wie: Verbinden von Code, der Ausnahmen zulässt, mit Code ohne Ausnahmen](how-to-interface-between-exceptional-and-non-exceptional-code.md)
## [Portabilität an ABI-Grenzen (Modern C++)](portability-at-abi-boundaries-modern-cpp.md)
# [C++-Sprachreferenz](cpp-language-reference.md)
## [Lexikalische Konventionen](lexical-conventions.md)
### [Übersicht über die Dateiübersetzung](overview-of-file-translation.md)
### [Zeichensätze](character-sets2.md)
### [C++-Tokens](tokens-cpp.md)
### [C++-Kommentare](comments-cpp.md)
### [C++-Bezeichner](identifiers-cpp.md)
### [C++-Schlüsselwörter](keywords-cpp.md)
#### [Auto-Schlüsselwort](auto-keyword.md)
### [C++-Punktuatoren](punctuators-cpp.md)
### [Numerisch, Boolean und Zeigerliterale (C++)](numeric-boolean-and-pointer-literals-cpp.md)
...
#### [Spezifizierer](specifiers.md)
#### [Zeitpunkt der Deklaration in C++](point-of-declaration-in-cpp.md)
#### [Initialisierer](initializers.md)
#### [Aliase und Typedefs (C++)](aliases-and-typedefs-cpp.md)
#### [using-Deklaration](using-declaration.md)
#### [Auflösung von Mehrdeutigkeit](resolving-ambiguous-declarations-cpp.md)
...
##### [exit-Funktion](exit-function.md)
...
### [Lvalues und Rvalues](lvalues-and-rvalues-visual-cpp.md)
...
## [C++-Operatoren, Rangfolge und Assoziativität](cpp-built-in-operators-precedence-and-associativity.md)
...
### [Tiefgestellt-Operator:](subscript-operator.md)
...
#### [C++-Ausdrücke (konstant)](cpp-constant-expressions.md)
### [Semantik von Ausdrücken](semantics-of-expressions.md)
### [Umwandlung von Typen](casting.md)
...
## [Überladen von Operatoren](operator-overloading.md)
...
### [Übersicht über Klassenmember](class-member-overview.md)
...
#### [virtual-Spezifizierer](virtual-specifier.md)
...
### [Konvertierungen](user-defined-type-conversions-cpp.md)
...
## [Lambda-Ausdrücke in C++](lambda-expressions-in-cpp.md)
### [Lambda-Ausdruckssyntax](lambda-expression-syntax.md)
### [Beispiele für Lambda-Ausdrücke](examples-of-lambda-expressions.md)
...
#### [Verwendung von strukturierter Ausnahmebehandlung in C++](using-structured-exception-handling-with-cpp.md)
...
### [Friend-Vorlagen](template-friends.md)
...
### [Partielle Spezialisierung von Klassenvorlagen (C++)](template-specialization-cpp.md)
...
### [__raise](raise.md)
### [__unhook](unhook.md)
### [Ereignisbehandlung in systemeigenem C++](event-handling-in-native-cpp.md)
...
##### [Überlegungen zum Schreiben von Prolog- und Epilogcode](considerations-for-writing-prolog-epilog-code.md)
#### [Gleitkomma-Koprozessor und Aufrufkonventionen](floating-point-coprocessor-and-calling-conventions.md)
...
##### [Verwenden "dllimport" und "dllexport" in C++-Klassen](using-dllimport-and-dllexport-in-cpp-classes.md)
...
### [Globale Funktionen des Compiler-COM](compiler-com-global-functions.md)
...
###### [_bstr_t-Operatoren (relational)](bstr-t-relational-operators.md)
