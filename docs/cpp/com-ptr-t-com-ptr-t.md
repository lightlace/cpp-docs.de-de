...
#### Parameter  
 ...
 `fAddRef`  
 Bei **true** wird `AddRef` aufgerufen, um den Verweiszähler des gekapselten Schnittstellenzeigers zu inkrementieren.  
 ...
 *lpcStr*  
 ...
 `pOuter`  
 Die äußere Unbekannte für die [Aggregation](http://msdn.microsoft.com/library/windows/desktop/ms686558).  
