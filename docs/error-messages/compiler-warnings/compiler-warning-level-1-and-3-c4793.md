...
ms.locfileid: "34704931"
---
# <a name="compiler-warning-level-1-and-3-c4793"></a>Compilerwarnung (Stufe 1 und 3) C4793

> "*Funktion*': Funktion als systemeigenen Code kompiliert wird:"*Grund*"
...
Dies ist eine Warnung der Stufe 1, bei der Angabe der **/CLR: pure** -Compileroption.  Die **/CLR: pure** -Compileroption in Visual Studio 2015 als veraltet markiert und in Visual Studio 2017 nicht unterstützt wird.
