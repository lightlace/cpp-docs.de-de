...
C5028|"*Namen*': Ausrichtung angegeben wird, in vorheriger Deklaration (*Anzahl*) nicht in Definition angegeben.
...
C4451|"*Typ*": Verwendung von Ref-Klasse*Typ*"innerhalb dieser Kontext kann zu ungültigem Marshalling des Objekts in Kontexten führen
...
C4585|"*Typ*': eine WinRT"public Ref Class"muss entweder versiegelt werden, oder leiten Sie von einem vorhandenen nicht versiegelten Klasse
...
C4572|/ CLR [ParamArray]-Attribut ist veraltet, verwenden Sie '...' stattdessen
...
C4747|Aufrufen von verwalteten '*Typ*': verwalteter Code kann nicht ausgeführt werden, unter der Loadersperre, einschließlich des DLL-Einstiegspunkts und Aufrufen von DLL-Einstiegspunkt eingehen
...
C4274|#ident ignoriert. finden Sie in der Dokumentation zu #pragma Comment (Exestr, "String")
...
C4535|Calling _set_se_translator() erfordert/EHa
