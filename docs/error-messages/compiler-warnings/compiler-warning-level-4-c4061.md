...
Enumerator 'Identifier' in Switch Enumeration 'Enumeration' wird nicht explizit von einer Case-Bezeichnung behandelt.  
  
 Die Enumeration weist keinen verknüpften Handler in einer `switch` Anweisung.  
