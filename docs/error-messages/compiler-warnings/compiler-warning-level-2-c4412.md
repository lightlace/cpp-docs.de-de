...
'Funktion': Funktionssignatur enthält Typ 'Typ'; C++-Objekte sind nicht sicher zwischen reinem Code übergeben und gemischtem oder systemeigenem.  
 ...
 Die **/CLR: pure** -Compileroption in Visual Studio 2015 als veraltet markiert ist. Wenn Sie Code besitzen, "rein" sein muss, wird empfohlen, dass Sie es in c# portieren.  
