---
title: Compiler (Stufe 1) C4656 | Microsoft-Dokumentation
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
'Symbol': Datentyp ist neu, die seit dem letzten Build geändert hat oder an anderer Stelle unterschiedlich definiert ist  
