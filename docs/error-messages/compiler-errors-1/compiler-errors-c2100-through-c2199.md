---
title: Compilerfehlers C2100 through C2199 | Microsoft-Dokumentation
ms.custom: ''
ms.date: 11/17/2017
ms.technology:
- cpp-diagnostics
...
|Compilerfehler Fehler C2131|Ausdruck wurde nicht auf eine Konstante ausgewertet werden.|
