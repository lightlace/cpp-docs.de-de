---
title: Compilerfehler C2105 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "33171177"
---
# <a name="compiler-error-c2105"></a>Compilerfehler C2105
'Operator' benötigt l-Wert  
  
 Der Operator muss einen l-Wert als Operanden haben.  
  
 Im folgende Beispiel wird C2105 generiert:  
