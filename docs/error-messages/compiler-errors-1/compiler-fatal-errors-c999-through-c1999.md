---
title: Schwerwiegende Compilerfehler C999 bis C1999 | Microsoft-Dokumentation
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
|Schwerwiegender Fehler C1016|#Ifdef / #Ifndef wurde ein Bezeichner erwartet.|  
...
|[Schwerwiegender Fehler C1113](../../error-messages/compiler-errors-1/fatal-error-c1113.md)|#Fehler bei '`file`'|  
...
|[Schwerwiegender Fehler C1189](../../error-messages/compiler-errors-1/fatal-error-c1189.md)|#Fehler:`message`|  
...
|[Schwerwiegender Fehler C1192](../../error-messages/compiler-errors-1/fatal-error-c1192.md)|#Fehler bei '`file`'|  
