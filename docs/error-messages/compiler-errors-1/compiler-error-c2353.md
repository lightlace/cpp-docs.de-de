...
ms.locfileid: "74759957"
---
# <a name="compiler-error-c2353"></a>Compilerfehler C2353

die Ausnahme Spezifikation ist nicht zulässig.

Ausnahme Spezifikationen sind für Element Funktionen verwalteter Klassen nicht zulässig.
