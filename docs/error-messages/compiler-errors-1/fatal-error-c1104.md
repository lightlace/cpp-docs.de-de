...
ms.locfileid: "74747331"
---
# <a name="fatal-error-c1104"></a>Schwerwiegender Fehler C1104

Schwerwiegender Fehler beim Importieren der LibID: "Meldung"

Der Compiler hat beim Importieren einer Typbibliothek ein Problem festgestellt.  Sie können beispielsweise keine Typbibliothek mit LibID und gleichzeitig `no_registry`angeben.
