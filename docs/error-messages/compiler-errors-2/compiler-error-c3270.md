---
title: Compiler-Fehler C3270 generiert | Microsoft-Dokumentation
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Ein Feld mit gekennzeichnet wurde **FieldOffset**, das ist nur zulässig, wenn **StructLayout(Explicit)** gültig ist.  
