...
ms.locfileid: "74736164"
---
# <a name="compiler-error-c2882"></a>Compilerfehler C2882

"Name": Ungültige Verwendung des Namespace Bezeichners in Ausdruck.

Sie haben versucht, den Namen eines Namespace in einem Ausdruck zu verwenden.
