...
"Var": Die Variable wird in einer Datenfreigabeklausel nicht unter einer default(none)-Klausel angezeigt.  
 ...
 Wenn [default(none)](../../parallel/openmp/reference/default-openmp.md) wird verwendet, alle in einem strukturierten Block verwendete Variable explizit angegeben werden entweder als [freigegebenen](../../parallel/openmp/reference/shared-openmp.md) oder [private](../../parallel/openmp/reference/private-openmp.md).  
