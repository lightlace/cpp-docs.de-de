...
ms.locfileid: "74760901"
---
# <a name="compiler-error-c2890"></a>Compilerfehler C2890

"Class": eine Verweis Klasse kann nur eine nicht Schnittstellen-Basisklasse aufweisen.

Eine Verweis Klasse kann nur über eine Basisklasse verfügen.
