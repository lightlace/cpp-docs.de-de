...
|[Compilerfehler Fehler C3201](compiler-error-c3201.md)|Die Vorlagenparameterliste für Klassenvorlage "*Vorlage*"entspricht nicht die Vorlagenparameterliste für den Vorlagenparameter"*Parameter*"|
...
|[Compilerfehler C3210 generiert](compiler-error-c3210.md)|"*Bezeichner*': Zugriffsdeklaration kann nur auf ein Basisklassenmember angewendet werden|
...
|[Compilerfehler C3218 generiert](compiler-error-c3218.md)|"*Typ*': Typ ist nicht als Einschränkung zulässig.|
...
|Compilerfehler C3220|"*Schnittstelle*": Schnittstelle kann nicht "progid" besitzen|
|Compilerfehler C3221|"*Member*": mehrere "Default" und "Case"-Attribute auf ein Element nicht zulässig|
...
|[Compilerfehler C3224 generiert](compiler-error-c3224.md)|"*Typ*": keine überladene generische Klasse übernimmt*Anzahl*"generische Typargumente|
|[Compilerfehler C3225 generiert](compiler-error-c3225.md)|generische Typargument für "*Argument*'kann nicht angegeben werden'*Typ*", muss ein Werttyp oder ein Handle für ein Verweistyp sein|
...
|[Compilerfehler C3227 generiert](compiler-error-c3227.md)|"*Typ*": kann nicht verwendet '*Operator*"ein generisches Typs zugewiesen werden.|
...
|[Compilerfehler C3231 generiert](compiler-error-c3231.md)|"*Typ*': Template-Typargument kann keinen generischen Typparameter verwenden|
