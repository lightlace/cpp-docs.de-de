...
|[Compilerfehler C3201](compiler-error-c3201.md)|Die Vorlagenparameterliste für die Klassenvorlage "*Vorlage*"entspricht nicht die Vorlagenparameterliste für den Vorlagenparameter"*Parameter*"|
|[Compilerfehler C3202](compiler-error-c3202.md)|"*Bezeichner*': Ungültiges Argument. Klassenvorlage erwartet|
|[Compilerfehler C3203](compiler-error-c3203.md)|"*Bezeichner*': nicht spezialisierte Klasse Vorlagen-/generische kann nicht verwendet werden, als Argument für Vorlagen-/generische Parameter Vorlagen-/generische"*Parameter*", einen realen Typ erwartet|
...
|[Compilerfehler C3208](compiler-error-c3208.md)|"*Funktion*": Die Vorlagenparameterliste für die Klassenvorlage "*Vorlage*"entspricht nicht der Vorlagenparameterliste für den Vorlagenparameter"*Parameter*"|
|[Compilerfehler C3209](compiler-error-c3209.md)|"*Typ*': generische Klasse muss eine verwaltete/WinRT-Klasse|
|[Compilerfehler C3210](compiler-error-c3210.md)|"*Bezeichner*': Zugriffsdeklaration kann nur auf einen Member der Basisklasse angewendet werden|
...
|[Compilerfehler C3218](compiler-error-c3218.md)|"*Typ*': Typ nicht als Einschränkung zulässig.|
...
|Compilerfehler Fehler C3220|"*Schnittstelle*': keine Schnittstelle progid|
|Compilerfehler Fehler C3221|"*Member*': mehrere 'Default' und 'Case' Attribute für ein Element nicht zulässig.|
...
|[Compilerfehler C3225](compiler-error-c3225.md)|generisches Typargument für '*Argument*'kann nicht angegeben werden'*Typ*", muss er ein Werttyp oder ein Handle für einen Referenztyp darstellt|
...
|[Compilerfehler C3227](compiler-error-c3227.md)|"*Typ*": kann nicht verwendet "*Operator*" ein generischen Typs zugewiesen werden.|
|[Compilerfehler C3228](compiler-error-c3228.md)|"*Funktion*': generische Typargument für '*Argument*'kann nicht angegeben werden'*Typ*", es muss ein Werttyp oder ein Handletyp|
...
|[Compilerfehler C3230](compiler-error-c3230.md)|"*Funktion*": Template-Typargument für '*Argument*' darf keinen generischen Typparameter enthalten: "*Typ*"|
...
|[Compilerfehler C3274](compiler-error-c3274.md)|Schließlich /&#95;&#95;schließlich ohne übereinstimmende versuchen|
|[Compilerfehler C3275](compiler-error-c3275.md)|"*Bezeichner*": kann nicht zu verwendendes Symbol ohne Qualifizierer|
|[Compilerfehler C3276](compiler-error-c3276.md)|"*Schlüsselwort*":-Anweisungsblock Herausspringen schließlich /&#95;&#95;schließlich Block weist ein nicht definiertes Verhalten während der Abbruchbehandlung|
