---
title: Compilerfehler C3706 | Microsoft-Dokumentation
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "46110509"
---
# <a name="compiler-error-c3706"></a>Compilerfehler C3706

'Funktion': muss eine COM-Schnittstelle zum Auslösen von COM-Ereignisse

Die Schnittstelle, mit denen Sie COM-Ereignisse auslösen muss es sich um eine COM-Schnittstelle sein. In diesem Fall die Schnittstelle sollte entweder mit einem Visual C++-Attribut definiert werden oder über importiert [#import](../../preprocessor/hash-import-directive-cpp.md) aus einer Typbibliothek mit #import Embedded_idl-Attribut.
