...
ms.locfileid: "74755420"
---
# <a name="compiler-error-c2586"></a>Compilerfehler C2586

falsche benutzerdefinierte Konvertierungs Syntax: unzulässige Dereferenzierungen

Die Dereferenzierung eines Konvertierungs Operators ist nicht zulässig.
