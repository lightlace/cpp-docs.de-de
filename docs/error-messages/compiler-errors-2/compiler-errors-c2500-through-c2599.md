...
|Compilerfehler Fehler C2508|"*Bezeichner*": "__declspec (*spezifizierer1*)" kann nicht kombiniert werden, mit "__declspec (*Bezeichner2*)"|
...
|[Compilerfehler C2582](compiler-error-C2582.md)|"Operator *Operator*"-Funktion ist nicht verfügbar in"*Typ*"|
