...
Eine Schnittstelle, die com-Ereignisse unterstützt, kann nicht `IDispatch`erben. Weitere Informationen finden Sie unter [Ereignis Behandlung in com](../../cpp/event-handling-in-com.md).
