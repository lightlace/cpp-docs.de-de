...
|Fehler|Meldung|
|-----------|-------------|
|Compilerfehler C3300|"*Symbol*": Ungültiges Format für IDL "*Wert*"|
|Compilerfehler C3301|"*Co-Klasse*': Co-Klasse nicht möglich, eine"*Symbol*"Schnittstelle|
|Compilerfehler C3302|"*Bezeichner*": Bezeichner hat mehr als *Anzahl* Zeichen|
...
|Compilerfehler C3306|"*Vorlage*": unbenannte Klasse Vorlagen-/generische ist nicht zulässig.|
|Compilerfehler C3307|"*Modul*": kann nicht erstellt werden IDL-Modul|
|Compilerfehler C3308|" *Funktion*": direkter Aufruf durch importierte Klasse wird nicht unterstützt.|
|[Compilerfehler C3309](compiler-error-c3309.md)|"*Makro*/*Schlüsselwort*': Modulname kann kein Makro oder Schlüsselwort sein.|
|Compilerfehler C3310|"*Bezeichner*": modulnamenkonflikt|
|Compilerfehler C3311|Das Modulattribut muss im globalen Gültigkeitsbereich definiert werden|
|Compilerfehler C3312|keine aufrufbare "*Bezeichner*"-Funktion gefunden für Typ"*Typ*"|
|Compilerfehler C3313|"*Bezeichner*': Variable kann keinen der Typ"*Typ*"|
|Compilerfehler C3314|"*Symbol*': nicht unterstützter IDL-Modul-Typ|
|Compilerfehler C3315|" *Funktion*": muss eine Memberfunktion sein|
|Compilerfehler C3316|"*Typ*": ein Array Unbekannter Größe kann nicht in einer bereichsbasierten verwendet werden, für die Anweisung|
|Compilerfehler C3317|"*Bezeichner*': eine Overload-Funktion kann nicht als Ausdruck in einer bereichsbasierten verwendet werden, für die Anweisung|
|Compilerfehler C3318|"*Typ*": ein Array kein Elementtyps, der "auto" enthält|
...
|Compilerfehler C3324|"*Eigenschaft*": Eigenschaft tritt mehr als einmal im Attribut "*Attribut*"|
|Compilerfehler C3325|"*Attribut*": Attribut wurden zu viele Argumente|
|Compilerfehler C3326|"*Wert*": ist kein gültiger Wert für Eigenschaft '*Eigenschaft*"des Attributs"*Attribut*"|
|Compilerfehler C3327|"*Eigenschaft*": muss der Wert für die Eigenschaft des Attributs angegeben werden '*Attribut*"|
|Compilerfehler C3328|"*Attribut*": Attribut besitzt nicht genügend Argumente|
|Compilerfehler C3329|Syntaxfehler: erwartet "*ttoken1*"not"*token2*"|
|Compilerfehler C3330|" *Funktion*': eine Funktion kann keinem Array zurückgeben"*Typ*"|
|Compilerfehler C3331|"*Bezeichner*": Attribute für Parameter sind nur für COM-Schnittstellen und Co-Klassen zulässig|
|Compilerfehler C3332|"*Eigenschaft*': Grammatik inkonsistent, Eigenschaft"*Eigenschaft*"ist sowohl erforderlich und hat den Standardwert|
