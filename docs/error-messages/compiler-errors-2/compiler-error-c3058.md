...
"Symbol": Das Symbol kann erst als "threadprivate" deklariert werden, wenn es in der copyin-Klausel verwendet wird.  
 ...
 Ein Symbol muss zuerst deklariert werden [Threadprivate](../../parallel/openmp/reference/threadprivate.md) bevor in verwendet werden, kann eine [Copyin](../../parallel/openmp/reference/copyin.md) Klausel.  
