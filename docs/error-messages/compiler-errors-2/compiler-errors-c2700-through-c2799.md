...
|[Compilerfehler C2702](compiler-error-c2702.md)| __except möglicherweise nicht in Beendigung Block verwendet angezeigt.|
...
|[Compilerfehler C2706](compiler-error-c2706.md)|Ungültige __except ohne matching __try (fehlende "}" in __try Block?)|
...
|[Compilerfehler C2712](compiler-error-c2712.md)|Verwenden in Funktionen, die benötigen, kann nicht __try werden|
|[Compilerfehler C2713](compiler-error-c2713.md)|nur jeweils eine Art der Ausnahmebehandlung pro Funktion zulässig.|
|[Compilerfehler C2714](compiler-error-c2714.md)|alignof(void) ist nicht zulässig.|
|[Compilerfehler C2715](compiler-error-c2715.md)|"*Typ*': auslösen oder Erfassen von diesem Typ nicht möglich|
...
|Compilerfehler Fehler C2741|Größe des Quellframes zu groß|
...
|[Compilerfehler C2752](compiler-error-c2752.md)|"*Vorlage*': mehr als eine teilweiser Spezialisierung entspricht die Vorlagenargumentliste|
...
|[Compilerfehler C2773](compiler-error-c2773.md)|#import und #using verfügbar nur in C++-Compiler|
...
|[Compilerfehler C2778](compiler-error-c2778.md)|falsch formatierte GUID im __declspec(uuid())|
...
|Compilerfehler Fehler C2789|"*Bezeichner*": ein Objekt vom Typ "Const-qualified" muss initialisiert werden|
|[Compilerfehler C2790](compiler-error-c2790.md)|"Superuser": Dieses Schlüsselwort kann nur innerhalb eines Texts der Klassenmemberfunktion verwendet werden|
|[Compilerfehler C2791](compiler-error-c2791.md)|Unzulässige Verwendung von 'Super': '*Klasse*' besitzt keine Basisklassen|
|[Compilerfehler C2792](compiler-error-c2792.md)|'Superuser": Dieses Schlüsselwort muss darauf folgen '::'|
...
|Compilerfehler Fehler C2796|"Ref new" kann nur verwendet werden, um eine Instanz eines WinRT-Typs zu erstellen.|
