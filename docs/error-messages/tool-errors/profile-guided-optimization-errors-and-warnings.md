---
title: Fehler und Warnungen bei der profilgesteuerten Optimierung
ms.date: 04/17/2019
f1_keywords:
- PG0001
- PG0002
...
ms.locfileid: "62359747"
---
# <a name="profile-guided-optimization-errors-and-warnings-pgxxxx"></a>Profilgesteuerte Optimierung Fehler und Warnungen (PGxxxx)

Dieser Abschnitt ist ein Verweis auf die durch die profilgesteuerte Optimierung (PGO)-Tools generierten Fehler. PGO-Fehler und Warnungen sind, die Form PG*Xxxx*, wobei *Xxxx* eine vierstellige Zahl ist.

[!INCLUDE[error-boilerplate](../../error-messages/includes/error-boilerplate.md)]

## <a name="pgo-errors"></a>PGO-Fehler

[Fehler in profilgesteuerter Optimierung: PG0165](../../error-messages/tool-errors/profile-guided-optimization-error-pg0165.md)

## <a name="pgo-warnings"></a>PGO-Warnungen
