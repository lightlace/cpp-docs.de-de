---
title: Befehlszeilenfehler und -warnungen
ms.date: 04/17/2019
...
---
# <a name="command-line-errors-and-warnings"></a>Befehlszeilenfehler und -warnungen

Die Artikel in diesem Abschnitt enthalten, einen Verweis auf die Befehlszeile Fehler und Warnungen, die von den Buildtools generiert wird. Diese Nachrichten haben das Format `Dxxxx`, wobei *Xxxx* eine vierstellige Zahl ist.

[!INCLUDE[error-boilerplate](../../error-messages/includes/error-boilerplate.md)]

## <a name="command-line-error-messages"></a>Befehlszeilen-Fehlermeldungen
...
## <a name="command-line-warning-messages"></a>Verwenden von Warnmeldungen
