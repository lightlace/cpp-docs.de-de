---
title: ': Tn028 Bereitstellen kontextbezogener Hilfe | Microsoft-Dokumentation'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
Der Quellcode für MAKEHM finden Sie in der MFC-Programmierung Utilities-Beispiel [MAKEHM](../visual-cpp-samples.md).
