...
ms.locfileid: "62240236"
---
# <a name="header-control-examples"></a>Beispiele für Headersteuerelemente

Beispiele für Headersteuerelemente, finden Sie unter den [Headersteuerelemente](/windows/desktop/Controls/header-controls) im Windows SDK.
