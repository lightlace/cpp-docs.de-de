...
2.  In der **License Package Authoring Tool** Dialogfeld die **verfügbaren Steuerelemente** Listenfeld, wählen Sie die einzelnen lizenzierten ActiveX-Steuerelement, die auf der HTML-Seite verwendet werden, und klicken Sie auf **hinzufügen**.  
  
3.  Klicken Sie auf **speichern und beenden Sie** , und geben Sie einen Namen für die LPK-Datei. Dies erstellt die LPK-Datei und schließen Sie die Anwendung.  
...
2.  Fügen Sie der \<Objekt >-Tag für das lizenzierte Steuerelement nach dem Tag-Lizenz-Manager.  
...
3.  Fügen Sie der \<EINBETTEN >-Attribut für die LPK-Datei, wenn das NCompass ActiveX-Plug-in verwenden.  
