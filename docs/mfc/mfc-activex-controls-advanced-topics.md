...
1. In der **Eigenschaftennamen** geben `Array`.

1. In der **Eigenschaftentyp** Kontrollkästchen **kurze**.

1. Für **Implementierung** Typ, klicken Sie auf **Get/Set-Methoden**.

1. In der **Get-Funktion** und **Set-Funktion** Felder, geben Sie eindeutige Namen für die Get- und Set-Funktion, oder übernehmen Sie die Standardnamen.
