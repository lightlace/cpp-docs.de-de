...
```  
 ...
 Sie können zusätzliche schreibgeschützte Headerdateien einbinden, indem die **Ressourcenincludes** Befehl an der #include-Anweisung als zweite schreibgeschützten Symbol-Direktive wie in:  
