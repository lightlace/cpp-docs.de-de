---
title: "Internetinformation – nach Task | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
In diesem Thema aufgeführten Tasks werden basierend auf den Task sortiert, die Sie ausführen möchten.  
 ...
 In diesem Thema werden die folgenden Kategorien von Aufgaben aufgeführt:  
...
-   [Erfahren Sie mehr über den asynchronen Monikern](../mfc/asynchronous-monikers-on-the-internet.md)  
  
-   [Erfahren Sie mehr über ActiveX-Steuerelementen in der Internet-Kontext](../mfc/activex-controls-on-the-internet.md)  
  
-   [Erfahren Sie mehr über aktive Dokumente im Internetkontext](../mfc/active-documents-on-the-internet.md)  
  
-   [Optimieren der ActiveX-Steuerelement](../mfc/mfc-activex-controls-optimization.md)  
  
-   [Erstellen von signierten CAB-Dateien für MFC- und ATL-Steuerelementen](http://msdn.microsoft.com/en-us/14e50724-2505-4258-ae6b-326b706de409)  
...
-   [Überprüfen Sie, was mit WinInet zusammenhängt Programmierung](../mfc/win32-internet-extensions-wininet.md)  
