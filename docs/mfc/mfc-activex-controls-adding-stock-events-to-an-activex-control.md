...
3.  Klicken Sie im Kontextmenü auf **hinzufügen** , und klicken Sie dann auf **Ereignis hinzufügen**.  
  
     Daraufhin den Assistenten zum Hinzufügen eines Ereignisses.  
  
4.  In der **Ereignisnamen** Dropdown-Liste `KeyPress`.  
