...
*lpLogPen*<br/>
Verweist auf die Windows [LOGPEN](/windows/desktop/api/Wingdi/ns-wingdi-taglogpen) -Struktur, die Informationen über das Stifteingabe enthält.
