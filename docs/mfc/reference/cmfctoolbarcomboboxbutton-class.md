---
title: CMFCToolBarComboBoxButton-Klasse | Microsoft-Dokumentation
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
### <a name="parameters"></a>Parameter  
 [in] *LpszText*  
 Zeiger auf eine Zeichenfolge, die den Text für das Bearbeitungsfeld enthält.  
