 ...
 *pstrVerb*  
 Ein Zeiger auf eine Zeichenfolge, enthält die Methode, die beim Senden der Anforderung verwendet werden. Kann **POST**, **HEAD**, oder **abrufen**.  
