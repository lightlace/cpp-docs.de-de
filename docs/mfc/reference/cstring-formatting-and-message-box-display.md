...
### <a name="return-value"></a>Rückgabewert  
 True, wenn die Funktion die Teilzeichenfolge am angegebenen Index erfolgreich extrahiert. andernfalls "false".  
...
##  <a name="afxformatstring2"></a>  AfxFormatString2  
 Ersetzt die Zeichenfolge, die durch *lpsz1* für alle Instanzen der Zeichen "%1" und der Zeichenfolge verweist *lpsz2* für alle Instanzen der Zeichen "%2", in der Zeichenfolge Dialogfeldvorlagen-Ressource identifizierte *nIDS*.  
...
- Schaltfläche IDCANCEL der "Abbrechen" wurde ausgewählt.  
  
- Schaltfläche "IDIGNORE der ignorieren" wurde ausgewählt.  
  
- Schaltfläche "IDNO der Nein" ausgewählt wurde.  
  
- Schaltfläche "IDOK der OK" wurde ausgewählt.  
  
- Schaltfläche "IDRETRY der Wiederholen" wurde ausgewählt.  
  
- Schaltfläche "Ja der IDYES" wurde ausgewählt.  
  
 Verfügt ein Meldungsfeld über eine Schaltfläche "Abbrechen", wird der IDCANCEL-Wert zurückgegeben werden, wenn entweder die ESC-Taste gedrückt wird oder wenn die Schaltfläche "Abbrechen" aktiviert ist. Enthält das Meldungsfeld keine Schaltfläche "Abbrechen", hat das Drücken der ESC-TASTE keine Auswirkung.  
