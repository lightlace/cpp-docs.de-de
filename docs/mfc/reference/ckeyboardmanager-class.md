---
title: CKeyboardManager-Klasse | Microsoft-Dokumentation
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
Diese Methode schlägt fehl, wenn ein Aufruf von [GetKeyboardState](https://msdn.microsoft.com/library/windows/desktop/ms646299) ein Fehler auftritt.
