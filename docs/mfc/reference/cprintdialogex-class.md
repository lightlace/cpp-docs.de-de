...
Die INT_PTR zurück, dass der Wert tatsächlich ein HRESULT ist. Finden Sie im Abschnitt Return Values [PrintDlgEx](/previous-versions/windows/desktop/legacy/ms646942\(v=vs.85\)) im Windows SDK.
