...
[!code-cpp[NVC_MFC_StatusBarDemo Nr. 11](../../mfc/reference/codesnippet/cpp/cmfccolorbutton-class_2.cpp)]  
...
### <a name="remarks"></a>Hinweise  
 Klicken Sie auf die "other" Schaltfläche, um ein Farbendialogfeld anzuzeigen. Wenn die *bAltColorDlg* Parameter ist `TRUE`, die [CMFCColorDialog Klasse](../../mfc/reference/cmfccolordialog-class.md) wird angezeigt; andernfalls wird das Dialogfeld Farbe angezeigt.  
