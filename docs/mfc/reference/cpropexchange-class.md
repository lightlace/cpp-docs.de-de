 ...
 *pFontDesc*  
 Ein Zeiger auf eine [FONTDESC](http://msdn.microsoft.com/library/windows/desktop/ms692782) Struktur, die Werte zum Initialisieren der Standardzustand der Font-Eigenschaft bei *pFontDispAmbient* ist NULL.  
