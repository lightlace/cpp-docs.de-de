...
|*rect*|[in] Ein Verweis auf eine [RECT](/previous-versions/dd162897\(v=vs.85\)) Struktur, die die Position und Größe des Steuerelements in Clientkoordinaten enthält.|
