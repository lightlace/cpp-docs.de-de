...
|ON\_WM\_NCCALCSIZE\(\)|afx\_msg void [OnNcCalcSize](../Topic/CWnd::OnNcCalcSize.md)\(NCCALCSIZE\_PARAMS BOOL, FAR\*\);|  
...
|ON\_WM\_NCXBUTTONDBLCLK\(\)|ungültiges [OnNcXButtonDblClk](../Topic/CWnd::OnNcXButtonDblClk.md)\(kurz, UINT, CPoint\);|  
|ON\_WM\_NCXBUTTONDOWN\(\)|afx\_msg void [OnNcXButtonDown](../Topic/CWnd::OnNcXButtonDown.md)\(kurz, UINT, CPoint\);|  
|ON\_WM\_NCXBUTTONUP\(\)|afx\_msg void [OnNcXButtonUp](../Topic/CWnd::OnNcXButtonUp.md)\(kurz, UINT, CPoint\);|  
