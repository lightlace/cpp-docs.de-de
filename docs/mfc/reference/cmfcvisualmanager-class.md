...
Im folgenden Beispiel wird veranschaulicht, wie die `OnFillBarBackground` in die `CMFCVisualManager` Klasse. Dieser Codeausschnitt ist Teil der [Outlook Demobeispiel](../../overview/visual-cpp-samples.md).
