...
## <a name="remarks"></a>Hinweise  
 ...
 Diese allgemeinen Windows-Steuerelements (und somit die `CRichEditCtrl` Klasse) und höher verfügbar nur für Programme, die unter Windows 95-und Windows 98 und Windows NT, Version 3.51 ausgeführt wird. Die `CRichEditCtrl` Klasse unterstützt die Versionen 2.0 und 3.0 von der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)] Rich-edit-Steuerelement.  
...
### <a name="example"></a>Beispiel  
 [!code-cpp[NVC_MFC_CRichEditCtrl Nr. 1](../../mfc/reference/codesnippet/cpp/cricheditctrl-class_1.cpp)]  
...
### <a name="example"></a>Beispiel  
 [!code-cpp[NVC_MFC_CRichEditCtrl Nr. 3](../../mfc/reference/codesnippet/cpp/cricheditctrl-class_3.cpp)]  
...
### <a name="parameters"></a>Parameter  
 `dwStyle`  
 Gibt das Bearbeitungssteuerelement-Stil. Eine Kombination der Fensterstile abgelesen gelten die **"Hinweise"** Abschnitt unten, und [bearbeiten Steuerelementtypen für die](http://msdn.microsoft.com/library/windows/desktop/bb775464), beschrieben, in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 ...
 Übernehmen Sie die folgenden [Fensterstile](../../mfc/reference/window-styles.md) auf das Bearbeitungssteuerelement.  
...
### <a name="example"></a>Beispiel  
 [!code-cpp[NVC_MFC_CRichEditCtrl Nr. 5](../../mfc/reference/codesnippet/cpp/cricheditctrl-class_5.cpp)]  
...
### <a name="parameters"></a>Parameter  
 ...
 `dwStyle`  
 Gibt das Bearbeitungssteuerelement-Stil. Eine Kombination der Fensterstile abgelesen gelten die **"Hinweise"** Abschnitt [erstellen](#create) und [bearbeiten Steuerelementtypen für die](http://msdn.microsoft.com/library/windows/desktop/bb775464), in der beschriebenen der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="parameters"></a>Parameter  
 `nCode`  
 Gibt die auszuführende Aktion an. Eine Liste der möglichen Werte, finden Sie in der Beschreibung für den Parameter `code` in **EM_FINDWORDBREAK** in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
 `nStart`  
 Die nullbasierte Zeichenposition, ab.  
  
### <a name="return-value"></a>Rückgabewert  
 Basierend auf dem Parameter `nCode`. Weitere Informationen finden Sie unter [EM_FINDWORDBREAK](http://msdn.microsoft.com/library/windows/desktop/bb788018) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 Weitere Informationen finden Sie unter der **EM_GETCHARFORMAT** Nachricht und die **CHARFORMAT** und **CHARFORMAT2** Strukturen in den [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 ...
 Weitere Informationen finden Sie unter [EM_GETEVENTMASK](http://msdn.microsoft.com/library/windows/desktop/bb788032) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="example"></a>Beispiel  
 [!code-cpp[NVC_MFC_CRichEditCtrl Nr. 11](../../mfc/reference/codesnippet/cpp/cricheditctrl-class_11.cpp)]  
...
### <a name="remarks"></a>Hinweise  
 ...
 Weitere Informationen finden Sie unter [EM_GETOLEINTERFACE](http://msdn.microsoft.com/library/windows/desktop/bb788041) Nachricht und [IRichEditOle](http://msdn.microsoft.com/library/windows/desktop/bb774306) -Schnittstelle in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="example"></a>Beispiel  
 [!code-cpp[NVC_MFC_CRichEditCtrl Nr. 14](../../mfc/reference/codesnippet/cpp/cricheditctrl-class_14.cpp)]  
...
### <a name="return-value"></a>Rückgabewert  
 Eine Kombination der aktuellen Optionswerte-Flag. Eine Liste der folgenden Werte sind, finden Sie unter der *fOptions* Parameter in der [EM_SETOPTIONS](http://msdn.microsoft.com/library/windows/desktop/bb774254) Nachricht, wie beschrieben in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="parameters"></a>Parameter  
 `fType`  
 Satzzeichen Typ-Flag, wie beschrieben in der `fType` Parameter [EM_GETPUNCTUATION](http://msdn.microsoft.com/library/windows/desktop/bb774184) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
 `lpPunc`  
 Ein Zeiger auf eine [SATZZEICHEN](http://msdn.microsoft.com/library/windows/desktop/bb787944) strukturieren, wie beschrieben in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
- **Memberfunktion GetSel (** `cr` **)** dieses Formular verwendet die **CHARRANGE** Struktur mit seiner **CpMin** und **CpMax** die Grenzen zurückzugebenden Elemente.  
...
### <a name="remarks"></a>Hinweise  
 ...
 Weitere Informationen finden Sie unter der [EM_GETCHARFORMAT](http://msdn.microsoft.com/library/windows/desktop/bb788026) Nachricht und die **CHARFORMAT** und **CHARFORMAT2** Strukturen in den [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 Weitere Informationen finden Sie unter [EM_SELECTIONTYPE](http://msdn.microsoft.com/library/windows/desktop/bb774223) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
### <a name="example"></a>Beispiel  
 [!code-cpp[NVC_MFC_CRichEditCtrl Nr. 16](../../mfc/reference/codesnippet/cpp/cricheditctrl-class_16.cpp)]  
...
### <a name="parameters"></a>Parameter  
 `dwFlags`  
 Der Wert gibt die Methode zum Bestimmen der Länge verwendet werden. Dieser Member kann eine oder mehrere der Werte im Flags-Mitglied der aufgeführten [GETTEXTLENGTHEX](http://msdn.microsoft.com/library/windows/desktop/bb787915) beschrieben, die der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 `GetTextLengthEx`Stellt zusätzliche Methoden zum Bestimmen der Länge des Texts an. Die Funktionalität des Rich Edit 2.0 unterstützt. Finden Sie unter [über Rich-Edit-Steuerelemente](http://msdn.microsoft.com/library/windows/desktop/bb787873) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]für Weitere Informationen.  
...
### <a name="return-value"></a>Rückgabewert  
 Ein Satz von Bitflags aus der [TEXTMODE](http://msdn.microsoft.com/library/windows/desktop/bb774364) Enumerationstyp, wie beschrieben in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]. Die Flags geben den aktuellen SMS-Modus und rückgängig-Ebene des Steuerelements.  
...
### <a name="remarks"></a>Hinweise  
 ...
 `GetTextRange`unterstützt die Funktionalität des Rich Edit 2.0. Finden Sie unter [über Rich-Edit-Steuerelemente](http://msdn.microsoft.com/library/windows/desktop/bb787873) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]für Weitere Informationen.  
...
### <a name="return-value"></a>Rückgabewert  
 Die aktuelle Wortumbruch und die Optionen für die wörtertrennung. Diese Optionen werden in beschrieben [EM_SETWORDWRAPMODE](http://msdn.microsoft.com/library/windows/desktop/bb774294) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="example"></a>Beispiel  
 [!code-cpp[NVC_MFC_CRichEditCtrl Nr. 18](../../mfc/reference/codesnippet/cpp/cricheditctrl-class_18.cpp)]  
...
### <a name="example"></a>Beispiel  
 [!code-cpp[NVC_MFC_CRichEditCtrl Nr. 20](../../mfc/reference/codesnippet/cpp/cricheditctrl-class_20.cpp)]  
...
### <a name="parameters"></a>Parameter  
 ...
 `nChars`  
 Gibt die Anzahl von Zeichenpositionen einen horizontalen Bildlauf durchführen. Dieser Wert wird ignoriert, wenn das rich-Edit-Steuerelement entweder verfügt die **ES_RIGHT** oder **ES_CENTER** Stil. [Bearbeiten von Stilen](../../mfc/reference/edit-styles.md) werden in angegeben [erstellen](#create).  
...
### <a name="remarks"></a>Hinweise  
 Wenn aktiviert, durchsucht das rich-Edit-Steuerelement den Text, um zu bestimmen, ob sie einen standard-URL-Format übereinstimmt. Eine Liste dieser URL-Formate, finden Sie unter [EM_AUTOURLDETECT](http://msdn.microsoft.com/library/windows/desktop/bb787991) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 ...
 Weitere Informationen finden Sie unter der [EM_SETCHARFORMAT](http://msdn.microsoft.com/library/windows/desktop/bb774230) Nachricht und die **CHARFORMAT** und **CHARFORMAT2** Strukturen in den [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
- `ECOOP_XOR`Behalten Sie nur die aktuellen Optionen, die *nicht* gemäß `dwFlags`.  
...
### <a name="remarks"></a>Hinweise  
 ...
 Weitere Informationen finden Sie unter der [EM_SETPARAFORMAT](http://msdn.microsoft.com/library/windows/desktop/bb774276) Nachricht und die **PARAFORMAT** und **PARAFORMAT2** Strukturen in den [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
- **Memberfunktion SetSel (** `cr` **)** dieses Formular verwendet die **CHARRANGE** Struktur mit seiner **CpMin** und **CpMax** Mitglieder des gültigen Bereichs festlegen.  
...
### <a name="parameters"></a>Parameter  
 ...
 In der zweiten Version, ein Zeiger auf eine [CHARFORMAT2](http://msdn.microsoft.com/library/windows/desktop/bb787883) -Struktur, die eine Rich Edit 2.0-Erweiterung ist auf die **CHARFORMAT** Struktur, die die neue zeichenformatierung-Attribute für die aktuelle Auswahl enthält.  
...
### <a name="remarks"></a>Hinweise  
 ...
 Weitere Informationen finden Sie unter der [EM_SETCHARFORMAT](http://msdn.microsoft.com/library/windows/desktop/bb774230) und **CHARFORMAT** und **CHARFORMAT2** Strukturen in den [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="parameters"></a>Parameter  
 *fMode*  
 Gibt die neuen Einstellungen für das Steuerelement Text-Modus und Rückgängigmachen Ebene Parameter an. Eine Liste der möglichen Werte finden Sie in der Mode-Parameter für [EM_SETTEXTMODE](http://msdn.microsoft.com/library/windows/desktop/bb774286) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
### <a name="return-value"></a>Rückgabewert  
 NULL Wenn erfolgreich, andernfalls ungleich NULL.  
  
### <a name="remarks"></a>Hinweise  
 Eine Beschreibung der Modi für Text, finden Sie unter **EM_SETTEXTMODE** in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="parameters"></a>Parameter  
 ...
 In der zweiten Version, ein Zeiger auf eine [CHARFORMAT2](http://msdn.microsoft.com/library/windows/desktop/bb787883) -Struktur, die eine Rich Edit 2.0-Erweiterung ist auf die **CHARFORMAT** Struktur, die Attribute für das aktuell ausgewählte Wort für die neue zeichenformatierung enthält.  
...
### <a name="parameters"></a>Parameter  
 `uFlags`  
 Die Optionen für den Zeilenumbruch und die wörtertrennung festgelegt. Eine Liste der möglichen Optionen, finden Sie unter [EM_SETWORDWRAPMODE](http://msdn.microsoft.com/library/windows/desktop/bb774294) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
