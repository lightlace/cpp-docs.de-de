...
##  <a name="a-namecreatethreada--cwinthreadcreatethread"></a><a name="createthread"></a>CreateThread  
...
##  <a name="a-nameruna--cwinthreadrun"></a><a name="run"></a>Hauptmeldungsschleife  
