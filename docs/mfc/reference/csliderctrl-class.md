...
|[CSliderCtrl::CreateEx](#createex)|Erstellt ein Schieberegler-Steuerelement mit der angegebenen erweiterten Fensterstile und fügt es einer `CSliderCtrl` Objekt.|  
...
### <a name="parameters"></a>Parameter  
 *dwStyle*  
 Gibt das Schieberegler-Steuerelement-Stil. Wenden Sie eine beliebige Kombination von [Stile der Schieberegler-Steuerelement](http://msdn.microsoft.com/library/windows/desktop/bb760147), in das Windows-SDK, auf das Steuerelement beschrieben.  
...
### <a name="remarks"></a>Hinweise  
 Sie erstellen eine `CSliderCtrl` in zwei Schritten. Zunächst rufen Sie den Konstruktor, und rufen Sie anschließend `Create`, die das Schieberegler-Steuerelement erstellt, und fügt es der `CSliderCtrl` Objekt.  
...
### <a name="remarks"></a>Hinweise  
 Diese Memberfunktion implementiert das Verhalten der Win32-Nachricht [TBM_GETBUDDY](http://msdn.microsoft.com/library/windows/desktop/bb760178)gemäß der Beschreibung im Windows SDK. Eine Beschreibung der Stile der Schieberegler-Steuerelemente, finden Sie unter [Trackbar-Steuerelementtypen](http://msdn.microsoft.com/library/windows/desktop/bb760147) im Windows SDK.  
...
### <a name="remarks"></a>Hinweise  
 Diese Memberfunktion implementiert das Verhalten der Win32-Nachricht [TBM_GETTOOLTIPS](http://msdn.microsoft.com/library/windows/desktop/bb760209)gemäß der Beschreibung im Windows SDK. Beachten Sie, die diese Memberfunktion gibt ein `CToolTipCtrl` Objekt anstatt ein Handle für ein Steuerelement.  
  
 Eine Beschreibung der Stile der Schieberegler-Steuerelemente, finden Sie unter [Trackbar-Steuerelementtypen](http://msdn.microsoft.com/library/windows/desktop/bb760147) im Windows SDK.  
...
### <a name="remarks"></a>Hinweise  
 Diese Memberfunktion implementiert das Verhalten der Win32-Nachricht [TBM_SETBUDDY](http://msdn.microsoft.com/library/windows/desktop/bb760213)gemäß der Beschreibung im Windows SDK. Beachten Sie, dass diese Memberfunktion Zeiger auf verwendet `CWnd` Objekte anstelle von Fensterhandles hinsichtlich der Rückgabewert und die Parameter.  
...
### <a name="parameters"></a>Parameter  
 *%nspeicherort*  
 Wert, der die Position, an dem das QuickInfo-Steuerelement angezeigt darstellt. Eine Liste der möglichen Werte finden Sie unter der Win32-Meldung [TBM_SETTIPSIDE](http://msdn.microsoft.com/library/windows/desktop/bb760240)gemäß der Beschreibung im Windows SDK.  
  
### <a name="return-value"></a>Rückgabewert  
 Ein Wert, der vorherigen Position das QuickInfo-Steuerelement darstellt. Der zurückgegebene Wert entspricht einer der möglichen Werte für *%nspeicherort*.  
  
### <a name="remarks"></a>Hinweise  
 Diese Memberfunktion implementiert das Verhalten der Win32-Nachricht **TBM_SETTIPSIDE**gemäß der Beschreibung im Windows SDK. Schieberegler-Steuerelemente, verwenden die **TBS_TOOLTIPS** formatieren Sie QuickInfos anzeigen. Eine Beschreibung der Stile der Schieberegler-Steuerelemente, finden Sie unter [Trackbar-Steuerelementtypen](http://msdn.microsoft.com/library/windows/desktop/bb760147) im Windows SDK.  
...
### <a name="remarks"></a>Hinweise  
 Diese Memberfunktion implementiert das Verhalten der Win32-Nachricht [TBM_SETTOOLTIPS](http://msdn.microsoft.com/library/windows/desktop/bb760242)gemäß der Beschreibung im Windows SDK. Wenn ein Schieberegler-Steuerelement erstellt wird, mit der **TBS_TOOLTIPS** Stil erstellt ein Standard-QuickInfo-Steuerelement, das neben dem Schieberegler, Anzeigen der aktuellen Position des Schiebereglers angezeigt wird. Eine Beschreibung der Stile der Schieberegler-Steuerelemente, finden Sie unter [Trackbar-Steuerelementtypen](http://msdn.microsoft.com/library/windows/desktop/bb760147) im Windows SDK.  
