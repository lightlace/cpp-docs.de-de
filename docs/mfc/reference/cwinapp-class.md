...
### <a name="parameters"></a>Parameter  
 ...
 `nCmd`  
 Gibt den Typ der angeforderten Hilfe an. Eine Liste der möglichen Werte und deren Einfluss auf die `dwData` Parameter, finden Sie unter der `uCommand` Parameter beschrieben, die im über die HTMLHelp-API-Funktion in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="parameters"></a>Parameter  
 ...
 `nIDResource`  
 Die ID der Cursorressource. Eine Liste der Ressourcen, finden Sie unter [LoadCursor](http://msdn.microsoft.com/library/windows/desktop/ms648391) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
