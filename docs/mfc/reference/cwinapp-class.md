...
### <a name="remarks"></a>Hinweise  
 ...
 Diese Methode gibt `NULL` unter Betriebssystemen vor Windows Vista. Der Neustart-Manager wird unter Betriebssystemen vor Windows Vista nicht unterstützt.  
