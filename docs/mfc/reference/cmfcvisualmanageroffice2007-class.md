---
title: Klasse CMFCVisualManagerOffice2007 | Microsoft-Dokumentation
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
`CMFCVisualManagerOffice2007`Wendet eine Anwendung eine Microsoft Office 2007-Darstellung.  
...
|`CMFCVisualManagerOffice2007::GetStyle`|Gibt das aktuelle Farbschema der `CMFCVisualManagerOffice2007` GUI, die wiederum die Microsoft Office 2007-GUI imitiert.|  
...
## <a name="remarks"></a>Hinweise  
 Verwendung `CMFCVisualManagerOffice2007` so ändern Sie das Erscheinungsbild Ihrer Anwendung, die von Microsoft Office 2007 ähneln. Diese visuellen Manager erfordert, dass Sie das Format festlegen, bevor Sie sie verwenden. Bevor Sie dieses visual-Manager übergeben `CMFCVisualManager::SetDefaultManager`, müssen Sie die statische Funktion aufrufen `CMFCVisualManagerOffice2007::SetStyle`.  
  
## <a name="example"></a>Beispiel  
 Im folgenden Beispiel wird veranschaulicht, wie den visuellen Manager Office 2007 verwenden. Dieser Codeausschnitt ist Teil der [Desktop Warnung Demobeispiel](../../visual-cpp-samples.md).  
