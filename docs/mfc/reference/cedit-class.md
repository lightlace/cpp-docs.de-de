...
|[CEdit::SetCueBanner](#setcuebanner)|Legt den Text, der angezeigt wird, wie der Text Cue bzw. Tipp, in ein Bearbeitungssteuerelement, wenn das Steuerelement leer ist und verfügt nicht über den Fokus.|  
...
## <a name="remarks"></a>Hinweise  
 ...
 `CEdit`erbt die wichtigsten Features von `CWnd`. Festlegen und Abrufen von Text aus einer `CEdit` -Objekts die `CWnd` Memberfunktionen [SetWindowText](cwnd-class.md#setwindowtext) und [GetWindowText](cwnd-class.md#getwindowtext), das Festlegen oder Abrufen der gesamte Inhalt eines Bearbeitungssteuerelements, selbst wenn es sich um ein mehrzeiliges Steuerelement handelt. Textzeilen in einem mehrzeiligen Steuerelement werden durch '\r\n' Zeichensequenzen getrennt. Auch wenn ein Bearbeitungssteuerelement mehrzeilig ist, abrufen und festlegen Teil der Text des Steuerelements durch Aufrufen der `CEdit` Memberfunktionen [GetLine](#getline), [Memberfunktion SetSel](#setsel), [Memberfunktion GetSel](#getsel), und [ReplaceSel](#replacesel).  
...
### <a name="example"></a>Beispiel  
 [!code-cpp[NVC_MFC_CEdit Nr. 1](../../mfc/reference/codesnippet/cpp/cedit-class_1.cpp)]  
...
### <a name="example"></a>Beispiel  
 [!code-cpp[NVC_MFC_CEdit Nr. 3](../../mfc/reference/codesnippet/cpp/cedit-class_2.cpp)]  
...
### <a name="example"></a>Beispiel  
 [!code-cpp[NVC_MFC_CEdit Nr. 5](../../mfc/reference/codesnippet/cpp/cedit-class_4.cpp)]  
...
### <a name="remarks"></a>Hinweise  
 ...
 Übernehmen Sie die folgenden [Fensterstile](window-styles.md) auf das Bearbeitungssteuerelement.  
...
### <a name="remarks"></a>Hinweise  
 Diese Methode sendet die [EM_GETHILITE](http://msdn.microsoft.com/library/windows/desktop/bb761578) Nachricht, die in beschrieben ist die [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="example"></a>Beispiel  
 [!code-cpp[NVC_MFC_CEdit Nr. 11](../../mfc/reference/codesnippet/cpp/cedit-class_11.cpp)]  
...
### <a name="remarks"></a>Hinweise  
 ...
 Diese Methode sendet die [EM_GETPASSWORDCHAR](http://msdn.microsoft.com/library/windows/desktop/bb761594) Nachricht, die in beschrieben ist die [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
### <a name="example"></a>Beispiel  
 [!code-cpp[NVC_MFC_CEdit Nr. 14](../../mfc/reference/codesnippet/cpp/cedit-class_14.cpp)]  
...
### <a name="remarks"></a>Hinweise  
 Diese Funktion sendet die [EM_HIDEBALLOONTIP](http://msdn.microsoft.com/library/windows/desktop/bb761604) Nachricht, die in beschrieben ist die [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="example"></a>Beispiel  
 [!code-cpp[NVC_MFC_CEdit Nr. 18](../../mfc/reference/codesnippet/cpp/cedit-class_17.cpp)]  
...
### <a name="remarks"></a>Hinweise  
 Diese Methode unterstützt die [EM_LINELENGTH](http://msdn.microsoft.com/library/windows/desktop/bb761613) Nachricht, die in beschrieben wird die [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="example"></a>Beispiel  
 [!code-cpp[NVC_MFC_CEdit Nr. 20](../../mfc/reference/codesnippet/cpp/cedit-class_19.cpp)]  
...
> **GetHandle** funktioniert nicht mit Windows 95-und Windows 98. Beim Aufrufen **GetHandle** in Windows 95-und Windows 98, wird zurückgegeben, **NULL**. **GetHandle** funktioniert wie beschrieben unter Windows NT, Version 3.51 und höher.  
 ...
 Weitere Informationen finden Sie unter [EM_SETHANDLE](http://msdn.microsoft.com/library/windows/desktop/bb761641), [LocalAlloc](http://msdn.microsoft.com/library/windows/desktop/aa366723), und [LocalAlloc](http://msdn.microsoft.com/library/windows/desktop/aa366730) in der [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 Diese Methode sendet die [EM_SETHILITE](http://msdn.microsoft.com/library/windows/desktop/bb761643) Nachricht, die in beschrieben ist die [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Hinweise  
 Der Text-Grenzwert ist die Höchstmenge des Textes in Zeichen, d. h., die das Steuerelement zum Bearbeiten akzeptieren kann.  
...
### <a name="remarks"></a>Hinweise  
 ...
 Wenn das Bearbeitungssteuerelement erstellt wird, mit der [ES_PASSWORD](edit-styles.md) Format, das standardmäßige Kennwortzeichen auf ein Sternchen festgelegt ist ( **\***). Dieses Format wird entfernt, wenn `SetPasswordChar` aufgerufen wird und *ch* auf 0 festgelegt.  
...
### <a name="remarks"></a>Hinweise  
 Die aktuelle Einstellung verwendbaren durch Testen der [ES_READONLY](edit-styles.md) -Flag in der Rückgabewert der [CWnd::GetStyle](cwnd-class.md#getstyle).  
...
### <a name="example"></a>Beispiel  
 ...
 [!code-cpp[NVC_MFC_CEdit_s1 Nr. 1](../../mfc/reference/codesnippet/cpp/cedit-class_25.h)]  
...
### <a name="example"></a>Beispiel  
 ...
 [!code-cpp[NVC_MFC_CEdit_s1 Nr. 3](../../mfc/reference/codesnippet/cpp/cedit-class_26.cpp)]  
