...
### <a name="example"></a>Beispiel  
 Dieses Beispiel veranschaulicht die Verwendung von der `CArchive` Operator zum Einfügen << mit der `int` und `long` Typen.  
