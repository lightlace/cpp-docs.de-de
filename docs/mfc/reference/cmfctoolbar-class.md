...
2.  Wenn Sie die WM_CREATE-Meldung für das Hauptrahmenfenster verarbeiten, rufen Sie entweder [CMFCToolBar::Create](#create) oder [CMFCToolBar::CreateEx](#createex) , erstellen Sie die Symbolleiste, und geben Sie den Stil.  
