...
2.  In der **neues Projekt** wählen Sie im Dialogfeld **MFC-Anwendung** im Bereich "Vorlagen" um den Assistenten zu öffnen.  
  
3.  Definieren Sie Ihre Anwendungseinstellungen mit dem [MFS-Anwendungsassistenten](../../mfc/reference/mfc-application-wizard.md).  
...
## <a name="see-also"></a>Siehe auch  
 [Vorbereitung zum Debuggen: Visual C++-Windows-Anwendungen](https://msdn.microsoft.com/a8bc54de-41a3-464d-9a12-db9bdcbc1ad5)   
 ...
 [Bereitstellen von Anwendungen](https://msdn.microsoft.com/4ff8881d-0daf-47e7-bfe7-774c625031b4)
