...
### <a name="return-value"></a>Rückgabewert  
 `TRUE` Wenn die Schaltfläche "" die Nachricht WM_COMMAND verarbeitet oder `FALSE` um anzugeben, dass die Nachricht vom übergeordneten Symbolleiste behandelt werden sollen.  
