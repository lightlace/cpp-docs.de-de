...
### <a name="parameters"></a>Parameter  
 ...
 [in] *pTimeNew*  
 Ein Zeiger auf die [SYSTEMTIME](https://msdn.microsoft.com/library/windows/desktop/ms724950) Struktur, die die Zeit enthält, auf den das Steuerelement festgelegt werden.  
