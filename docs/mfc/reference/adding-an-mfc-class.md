...
3.  Definieren Sie die Einstellungen für die neue Klasse in der [MFC-Klassenassistent](../../mfc/reference/mfc-add-class-wizard.md) Dialogfeld.  
  
4.  Klicken Sie auf **Fertig stellen** um den Assistenten zu schließen und die neue Klasse in der Klassenansicht. Sie können auch anzeigen, die vom in-Assistenten erstellten Dateien **Projektmappen-Explorer**.  
