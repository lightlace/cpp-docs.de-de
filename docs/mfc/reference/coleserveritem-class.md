...
### <a name="remarks"></a>Hinweise  
 Diese Funktion ruft die [GetEmbedSourceData](#getembedsourcedata) Member-Funktion zum Abrufen der systemeigenen Daten für die OLE-Element und ruft die [AddOtherClipboardData](#addotherclipboarddata) Member-Funktion zum Abrufen der Präsentationsformat und eine unterstützte konvertierungsformate. Wenn `bIncludeLink` ist **"true"**, ruft die Funktion auch [GetLinkSourceData](#getlinksourcedata) die Link-Daten für das Element abgerufen werden.  
