...
##  <a name="dragenter"></a>  CImageList::DragEnter  
 Sperren Sie während eines Ziehvorgangs Updates vom angegebenen Fensters *pWndLock* und zeigt das Bild an der Position angegeben *zeigen*.  
