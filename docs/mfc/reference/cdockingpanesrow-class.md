---
title: Klasse CDockingPanesRow | Microsoft-Dokumentation
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
##  <a name="arrangepanes"></a>CDockingPanesRow::ArrangePanes  
 Ordnet die andockbare Bereiche in einer Zeile entsprechend den angegebenen Rand und Abstand von Parametern.  
...
### <a name="parameters"></a>Parameter  
 ...
 [in] `nSpacing`  
 Gibt den Abstand in Pixel zwischen Bereichen.  
  
### <a name="remarks"></a>Hinweise  
 Rufen Sie diese Methode, um Bereiche in der Zeile anzuordnen, wo sie andocken werden. Nach dem Aufruf dieser Methode müssen Sie aufrufen `CDockingPanesRow::FixupVirtualRects(FALSE, NULL)`.  
