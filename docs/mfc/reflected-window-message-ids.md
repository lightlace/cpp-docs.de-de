...
> [!NOTE]
>  Wenn das Steuerelement auf einem Win32-System ausgeführt wird, gibt es mehrere Typen von **WM_CTLCOLOR\***  Nachrichten empfangen kann. Weitere Informationen finden Sie unter **WM_CTLCOLORBTN**, **WM_CTLCOLORDLG**, **WM_CTLCOLOREDIT**, **WM_CTLCOLORLISTBOX**,  **WM_CTLCOLORMSGBOX**, **WM_CTLCOLORSCROLLBAR**, **WM_CTLCOLORSTATIC**.  
