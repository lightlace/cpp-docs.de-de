...
5.  In der **Methodenname** geben *PtInCircle*.  
  
6.  In der **Interner Name** Feld, geben Sie den Namen der internen Funktion der Methode oder den Standardwert (in diesem Fall *PtInCircle*).  
