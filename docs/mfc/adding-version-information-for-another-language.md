...
### So fügen Sie Versionsinformationen für eine andere Sprache hinzu \(neuer Infoblock\)  
...
2.  Klicken Sie mit der rechten Maustaste in der Versionsinformationstabelle, und wählen Sie aus dem Kontextmenü **Neuer Versionsinformationsblock** aus.  
     ...
     Dieser Befehl fügt der aktuellen Versionsinformationsressource einen zusätzlichen Informationsblock hinzu und öffnet dessen entsprechende Eigenschaften im [Eigenschaftenfenster](../Topic/Properties%20Window.md).  
