...
## <a name="why-migrate-from-odbc-to-dao"></a>Warum migrieren von ODBC nach DAO
...
## <a name="differences-between-odbc-and-dao-mfc-classes"></a>Unterschiede zwischen ODBC und MFC-DAO-Klassen
...
|`RFX_Date`<sup>1</sup>|`DFX_Date` (`COleDateTime`-Basis)|
|`RFX_Text`|`DFX_Text`|
