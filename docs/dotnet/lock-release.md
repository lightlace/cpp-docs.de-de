...
## Hinweise  
 Wenn keine Sperre angehalten wird, hat `release` keine Auswirkungen.  
  
 Sie müssen diese Funktion nicht explizit aufrufen; wenn ein `lock`\-Objekt den Bereich verlässt, ihr Destruktor `release` auf.  
