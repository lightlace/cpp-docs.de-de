...
## [Exemplarische Vorgehensweise: Kompilieren eines C++-/CLI-Programms, das auf die CLR abzielt](walkthrough-compiling-a-cpp-program-that-targets-the-clr-in-visual-studio.md)
## [C++/CLI-Aufgaben](cpp-cli-tasks.md)
### [Vorgehensweise: Erstellen von leeren CLR-Projekten](how-to-create-clr-empty-projects.md)
### [Vorgehensweise: Erstellen von CLR-Konsolenanwendungen](how-to-create-clr-console-applications-cpp-cli.md)
...
### [Vorgehensweise: Definieren und Verarbeiten von Klassen und Strukturen](how-to-define-and-consume-classes-and-structs-cpp-cli.md)
### [C++-Stack-Semantik für Referenztypen](cpp-stack-semantics-for-reference-types.md)
### [Benutzerdefinierte Operatoren](user-defined-operators-cpp-cli.md)
### [User-Defined Conversions (Benutzerdefinierte Konvertierungen)](user-defined-conversions-cpp-cli.md)
### [initonly](initonly-cpp-cli.md)
### [Vorgehensweise: Definieren und Verwenden von Delegaten](how-to-define-and-use-delegates-cpp-cli.md)
...
### [Vorgehensweise: Definieren eines statischen Schnittstellenkonstruktors](how-to-define-an-interface-static-constructor-cpp-cli.md)
### [Vorgehensweise: Deklarieren von Überschreibungsbezeichnern in nativen Kompilierungen](how-to-declare-override-specifiers-in-native-compilations-cpp-cli.md)
...
### [Reguläre Ausdrücke von .NET](regular-expressions-cpp-cli.md)
### [Dateibehandlung und E/A](file-handling-and-i-o-cpp-cli.md)
### [Grafikvorgänge](graphics-operations-cpp-cli.md)
### [Windows-Vorgänge](windows-operations-cpp-cli.md)
### [Datenzugriff mit ADO.NET](data-access-using-adonet-cpp-cli.md)
## [Interoperabilität von nativem Code und .NET](native-and-dotnet-interoperability.md)
### [Interoperabilität mit anderen .NET-Sprachen](interoperability-with-other-dotnet-languages-cpp-cli.md)
...
## [Reiner und überprüfbarer Code](pure-and-verifiable-code-cpp-cli.md)
### [Vorgehensweise: Erstellen überprüfbarer C++-Projekte](how-to-create-verifiable-cpp-projects-cpp-cli.md)
### [Verwenden überprüfbarer Assemblys mit SQL Server](using-verifiable-assemblies-with-sql-server-cpp-cli.md)
...
## [Serialisierung](serialization-cpp-cli.md)
## [Friend-Assemblys (C++)](friend-assemblies-cpp.md)
## [Verwaltete Typen](managed-types-cpp-cli.md)
## [Reflexion](reflection-cpp-cli.md)
## [Assemblys mit starken Namen (Assemblysignierung)](strong-name-assemblies-assembly-signing-cpp-cli.md)
## [Debug-Klasse](debug-class-cpp-cli.md)
