...
### [Gewusst wie: Erstellen von leeren CLR-Projekten](how-to-create-clr-empty-projects.md)
### [Gewusst wie: Erstellen von CLR-Konsolenanwendungen (C++/CLI)](how-to-create-clr-console-applications-cpp-cli.md)
### [Gewusst wie: Verwenden von Nachverfolgungsverweisen in C++/CLI](how-to-use-tracking-references-in-cpp-cli.md)
### [Gewusst wie: Verwenden von Arrays in C++/CLI](how-to-use-arrays-in-cpp-cli.md)
### [Gewusst wie: definieren und Verarbeiten von Klassen und Strukturen (C++-CLI)](how-to-define-and-consume-classes-and-structs-cpp-cli.md)
...
### [Gewusst wie: Definieren und Verwenden von Delegaten (C++/CLI)](how-to-define-and-use-delegates-cpp-cli.md)
### [Gewusst wie: Definieren und Verarbeiten von Enumerationen in C++/CLI](how-to-define-and-consume-enums-in-cpp-cli.md)
### [Gewusst wie: Verwenden von Ereignissen in C++/CLI](how-to-use-events-in-cpp-cli.md)
### [Gewusst wie: Definieren eines statischen Schnittstellenkonstruktors (C++/CLI)](how-to-define-an-interface-static-constructor-cpp-cli.md)
### [Gewusst wie: Deklarieren von Überschreibungsbezeichnern in nativen Kompilierungen (C++/CLI)](how-to-declare-override-specifiers-in-native-compilations-cpp-cli.md)
### [Gewusst wie: Verwenden von Eigenschaften in C++/CLI](how-to-use-properties-in-cpp-cli.md)
### [Gewusst wie: Verwenden von safe_cast in C++/CLI](how-to-use-safe-cast-in-cpp-cli.md)
## [Interoperabilität von systemeigenem Code und .NET](native-and-dotnet-interoperability.md)
### [Gemischte (systemeigene und verwaltete) Assemblys](mixed-native-and-managed-assemblies.md)
#### [Gewusst wie: Migrieren zu /clr](how-to-migrate-to-clr.md)
#### [Gewusst wie: Kompilieren von MFC-Code und ATL-Code mit /clr](how-to-compile-mfc-and-atl-code-by-using-clr.md)
...
#### [Gewusst wie: Erstellen einer teilweise vertrauenswürdigen Anwendung durch Entfernen der Abhängigkeit der CRT-Bibliotheks-DLL](create-a-partially-trusted-application.md)
...
##### [Gewusst wie: Erstellen des Benutzersteuerelements und des Hosts in einem Dialogfeld](how-to-create-the-user-control-and-host-in-a-dialog-box.md)
##### [Gewusst wie: DDX-/DDV-Datenbindung mit Windows Forms](how-to-do-ddx-ddv-data-binding-with-windows-forms.md)
##### [Gewusst wie: Auffangen von Windows Forms-Ereignissen aus systemeigenen C++-Klassen](how-to-sink-windows-forms-events-from-native-cpp-classes.md)
#### [Hosten eines Windows Forms-Benutzersteuerelements als MFC-Ansicht](hosting-a-windows-forms-user-control-as-an-mfc-view.md)
##### [Gewusst wie: Erstellen des Benutzersteuerelements und Hosten der MDI-Ansicht](how-to-create-the-user-control-and-host-mdi-view.md)
##### [Gewusst wie: Hinzufügen von Befehlsrouting zum Windows Forms-Steuerelement](how-to-add-command-routing-to-the-windows-forms-control.md)
##### [Gewusst wie: Aufrufen von Ereignissen und Methoden des Windows Forms-Steuerelements](how-to-call-properties-and-methods-of-the-windows-forms-control.md)
...
### [Aufrufen systemeigener Funktionen aus verwaltetem Code](calling-native-functions-from-managed-code.md)
#### [Verwenden von explizitem PInvoke in C++ (DllImport-Attribut)](using-explicit-pinvoke-in-cpp-dllimport-attribute.md)
##### [Gewusst wie: Aufrufen von systemeigenen DLLs in verwaltetem Code mithilfe von PInvoke](how-to-call-native-dlls-from-managed-code-using-pinvoke.md)
##### [Gewusst wie: Marshallen von Zeichenfolgen mit PInvoke](how-to-marshal-strings-using-pinvoke.md)
##### [Gewusst wie: Marshallen von Strukturen mit PInvoke](how-to-marshal-structures-using-pinvoke.md)
##### [Gewusst wie: Marshallen von Arrays mit PInvoke](how-to-marshal-arrays-using-pinvoke.md)
##### [Gewusst wie: Marshallen von Funktionszeigern mit PInvoke](how-to-marshal-function-pointers-using-pinvoke.md)
##### [Gewusst wie: Marshallen eingebetteter Zeiger mit PInvoke](how-to-marshal-embedded-pointers-using-pinvoke.md)
#### [Verwenden von C++-Interop (implizites PInvoke)](using-cpp-interop-implicit-pinvoke.md)
##### [Gewusst wie: Marshallen von ANSI-Zeichenfolgen mit C++-Interop](how-to-marshal-ansi-strings-using-cpp-interop.md)
##### [Gewusst wie: Marshallen von Unicode-Zeichenfolgen mit C++-Interop](how-to-marshal-unicode-strings-using-cpp-interop.md)
##### [Gewusst wie: Marshallen von COM-Zeichenfolgen mit C++-Interop](how-to-marshal-com-strings-using-cpp-interop.md)
##### [Gewusst wie: Marshallen von Strukturen mit C++-Interop](how-to-marshal-structures-using-cpp-interop.md)
##### [Gewusst wie: Marshallen von Arrays mit C++-Interop](how-to-marshal-arrays-using-cpp-interop.md)
##### [Gewusst wie: Marshallen von Rückrufen und Delegaten mit C++-Interop](how-to-marshal-callbacks-and-delegates-by-using-cpp-interop.md)
##### [Gewusst wie: Marshallen von eingebetteten Zeigern mit C++-Interop](how-to-marshal-embedded-pointers-using-cpp-interop.md)
##### [Gewusst wie: Erweitern der Marshallingbibliothek](how-to-extend-the-marshaling-library.md)
##### [Gewusst wie: Zugriff auf Zeichen in einem System::String](how-to-access-characters-in-a-system-string.md)
##### [Gewusst wie: Umwandeln von char * String nach System::Byte Array](how-to-convert-char-star-string-to-system-byte-array.md)
##### [Gewusst wie: Umwandeln von System::String nach wchar_t* oder char*](how-to-convert-system-string-to-wchar-t-star-or-char-star.md)
##### [Gewusst wie: Konvertieren von System::String zu Standardzeichenfolge](how-to-convert-system-string-to-standard-string.md)
##### [Gewusst wie: Konvertieren einer Standardzeichenfolge nach System::String](how-to-convert-standard-string-to-system-string.md)
##### [Gewusst wie: Abrufen eines Zeigers auf ein Byte-Array](how-to-obtain-a-pointer-to-byte-array.md)
##### [Gewusst wie: Laden von nicht verwalteten Ressourcen in ein Byte-Array](how-to-load-unmanaged-resources-into-a-byte-array.md)
##### [Gewusst wie: Ändern der Verweisklasse in einer systemeigenen Funktion](how-to-modify-reference-class-in-a-native-function.md)
##### [Gewusst wie: Ermitteln, ob ein Bild systemeigen oder CLR ist](how-to-determine-if-an-image-is-native-or-clr.md)
##### [Gewusst wie: Hinzufügen einer systemeigenen DLL zum globalen Assemblycache](how-to-add-native-dll-to-global-assembly-cache.md)
##### [Gewusst wie: Verweis auf Werttyp in systemeigenem Typ](how-to-hold-reference-to-value-type-in-native-type.md)
##### [Gewusst wie: Objektverweis in nicht verwaltetem Arbeitsspeicher](how-to-hold-object-reference-in-unmanaged-memory.md)
##### [Gewusst wie: Erkennen der /clr-Kompilierung](how-to-detect-clr-compilation.md)
##### [Gewusst wie: Konvertieren zwischen System::Guid und _GUID](how-to-convert-between-system-guid-and-guid.md)
##### [Gewusst wie: Angeben eines out-Parameters](how-to-specify-an-out-parameter.md)
##### [Gewusst wie: Verwenden eines systemeigenen Typs in einer /clr-Kompilierung](how-to-use-a-native-type-in-a-clr-compilation.md)
##### [Gewusst wie: Deklarieren von Handles in systemeigenen Typen](how-to-declare-handles-in-native-types.md)
##### [Gewusst wie: Kapseln einer systemeigenen Klasse zur Verwendung in C#](how-to-wrap-native-class-for-use-by-csharp.md)
...
#### [Zeichenfolgenliterale](string-literal.md)
...
### [Featurevergleich zwischen "gemischt", "rein" und "überprüfbar" (C++/CLI)](mixed-pure-and-verifiable-feature-comparison-cpp-cli.md)
### [Gewusst wie: Migrieren auf /clr:pure (C++/CLI)](how-to-migrate-to-clr-pure-cpp-cli.md)
### [Gewusst wie: Erstellen überprüfbarer C++-Projekte (C++/CLI)](how-to-create-verifiable-cpp-projects-cpp-cli.md)
### [Gewusst wie: Migrieren auf /clr:safe (C++/CLI)](how-to-migrate-to-clr-safe-cpp-cli.md)
...
### [Gewusst wie: Verwenden regulärer Ausdrücke für einfache Gleichheitsprüfung (C++/CLI)](how-to-use-regular-expressions-for-simple-matching-cpp-cli.md)
### [Gewusst wie: Verwenden von regulären Ausdrücken zum Extrahieren von Datenfeldern (C++/CLI)](how-to-use-regular-expressions-to-extract-data-fields-cpp-cli.md)
### [Gewusst wie: Verwenden von regulären Ausdrücken zum Ändern der Anordnung von Daten (C++/CLI)](how-to-use-regular-expressions-to-rearrange-data-cpp-cli.md)
### [Gewusst wie: Verwenden von regulären Ausdrücken zum Suchen und Ersetzen (C++/CLI)](how-to-use-regular-expressions-to-search-and-replace-cpp-cli.md)
### [Gewusst wie: Verwenden von regulären Ausdrücken zur Überprüfung der Datenformatierung (C++/CLI)](how-to-use-regular-expressions-to-validate-data-formatting-cpp-cli.md)
### [Gewusst wie: Analysieren von Zeichenfolgen mithilfe der split-Methode (C++/CLI)](how-to-parse-strings-using-the-split-method-cpp-cli.md)
### [Gewusst wie: Analysieren von Zeichenfolgen mithilfe von regulären Ausdrücken (C++/CLI)](how-to-parse-strings-using-regular-expressions-cpp-cli.md)
## [Dateibehandlung und E/A (C++/CLI)](file-handling-and-i-o-cpp-cli.md)
### [Gewusst wie: Auflisten von Dateien in einem Verzeichnis (C++/CLI)](how-to-enumerate-files-in-a-directory-cpp-cli.md)
### [Gewusst wie: Überprüfen von Dateisystemänderungen (C++/CLI)](how-to-monitor-file-system-changes-cpp-cli.md)
### [Gewusst wie: Lesen einer Binärdatei (C++/CLI)](how-to-read-a-binary-file-cpp-cli.md)
### [Gewusst wie: Lesen einer Textdatei (C++/CLI)](how-to-read-a-text-file-cpp-cli.md)
### [Gewusst wie: Abrufen von Dateiinformationen (C++/CLI)](how-to-retrieve-file-information-cpp-cli.md)
### [Gewusst wie: Schreiben einer Binärdatei (C++/CLI)](how-to-write-a-binary-file-cpp-cli.md)
### [Gewusst wie: Schreiben einer Textdatei (C++/CLI)](how-to-write-a-text-file-cpp-cli.md)
## [Grafikoperationen (C++/CLI)](graphics-operations-cpp-cli.md)
### [Gewusst wie: Konvertieren von Bilddateiformaten mit .NET Framework](how-to-convert-image-file-formats-with-the-dotnet-framework.md)
### [Gewusst wie: Anzeigen von Bildern mit .NET Framework](how-to-display-images-with-the-dotnet-framework.md)
### [Gewusst wie: Zeichnen von Formen mit .NET Framework](how-to-draw-shapes-with-the-dotnet-framework.md)
### [Gewusst wie: Drehen von Bildern mit .NET Framework](how-to-rotate-images-with-the-dotnet-framework.md)
## [Windows-Vorgänge (C++/CLI)](windows-operations-cpp-cli.md)
### [Gewusst wie: Ermitteln, ob das Herunterfahren begonnen hat (C++/CLI)](how-to-determine-if-shutdown-has-started-cpp-cli.md)
### [Gewusst wie: Ermitteln des interaktiven Zustands (C++/CLI)](how-to-determine-the-user-interactive-state-cpp-cli.md)
### [Gewusst wie: Lesen von Daten aus der Windows-Registrierung (C++/CLI)](how-to-read-data-from-the-windows-registry-cpp-cli.md)
### [Gewusst wie: Lesen von Windows-Leistungsindikatoren (C++/CLI)](how-to-read-windows-performance-counters-cpp-cli.md)
### [Gewusst wie: Abrufen von Text aus der Zwischenablage (C++/CLI)](how-to-retrieve-text-from-the-clipboard-cpp-cli.md)
### [Gewusst wie: Abrufen der .NET Framework-Version (C++/CLI)](how-to-retrieve-the-dotnet-framework-version-cpp-cli.md)
### [Gewusst wie: Abrufen des aktuellen Benutzernamens (C++/CLI)](how-to-retrieve-the-current-username-cpp-cli.md)
### [Gewusst wie: Abrufen des lokalen Computernamens (C++/CLI)](how-to-retrieve-the-local-machine-name-cpp-cli.md)
### [Gewusst wie: Abrufen der Windows-Version (C++/CLI)](how-to-retrieve-the-windows-version-cpp-cli.md)
### [Gewusst wie: Abrufen der seit dem Start vergangenen Zeit (C++/CLI)](how-to-retrieve-time-elapsed-since-startup-cpp-cli.md)
### [Gewusst wie: Speichern von Text in der Zwischenablage (C++/CLI)](how-to-store-text-in-the-clipboard-cpp-cli.md)
### [Gewusst wie: Schreiben von Daten in die Windows-Registrierung (C++/CLI)](how-to-write-data-to-the-windows-registry-cpp-cli.md)
## [Datenzugriff mit ADO.NET (C++/CLI)](data-access-using-adonet-cpp-cli.md)
### [Gewusst wie: Marshallen von ANSI-Zeichenfolgen für ADO.NET (C++/CLI)](how-to-marshal-ansi-strings-for-adonet-cpp-cli.md)
### [Gewusst wie: Marshallen von BSTR-Zeichenfolgen für ADO.NET (C++/CLI)](how-to-marshal-bstr-strings-for-adonet-cpp-cli.md)
### [Gewusst wie: Marshallen von Unicode-Zeichenfolgen für ADO.NET (C++/CLI)](how-to-marshal-unicode-strings-for-adonet-cpp-cli.md)
### [Gewusst wie: Marshallen eines VARIANT für ADO.NET (C++/CLI)](how-to-marshal-a-variant-for-adonet-cpp-cli.md)
### [Gewusst wie: Marshallen eines SAFEARRAY für ADO.NET (C++/CLI)](how-to-marshal-a-safearray-for-adonet-cpp-cli.md)
## [Interoperabilität mit anderen .NET-Sprachen (C++/CLI)](interoperability-with-other-dotnet-languages-cpp-cli.md)
### [Gewusst wie: Implementieren der C#-Schlüsselwörter "is" und "as" (C++/CLI)](how-to-implement-is-and-as-csharp-keywords-cpp-cli.md)
### [Gewusst wie: Implementieren des C#-Schlüsselworts "lock" (C++/CLI)](how-to-implement-the-lock-csharp-keyword-cpp-cli.md)
### [Gewusst wie: Verwenden eines C#-Indexers (C++/CLI)](how-to-consume-a-csharp-indexer-cpp-cli.md)
...
### [.NET Framework-Entsprechungen der systemeigenen Typen in C++ (C++/CLI)](dotnet-framework-equivalents-to-cpp-native-types-cpp-cli.md)
### [Versionsprobleme bei in systemeigenen Typen geschachtelten Werttypen (C++/CLI)](version-issues-for-value-types-nested-in-native-types-cpp-cli.md)
### [Gewusst wie: Test auf Gleichheit (C++/CLI)](how-to-test-for-equality-cpp-cli.md)
### [Gewusst wie: Diagnose und Behebung von Kompatibilitätsproblemen bei Assemblys (C++/CLI)](how-to-diagnose-and-fix-assembly-compatibility-problems-cpp-cli.md)
## [Reflektion (C++/CLI)](reflection-cpp-cli.md)
### [Gewusst wie: Implementieren einer Plug-In-Komponentenarchitektur mit Reflektion (C++/CLI)](how-to-implement-a-plug-in-component-architecture-using-reflection-cpp-cli.md)
### [Gewusst wie: Auflisten von Datentypen in Assemblys mit Reflektion (C++/CLI)](how-to-enumerate-data-types-in-assemblies-using-reflection-cpp-cli.md)
...
### [Gewusst wie: Umwandeln einer .Net-Auflistung in einen STL/CLR-Container](how-to-convert-from-a-dotnet-collection-to-a-stl-clr-container.md)
### [Gewusst wie: Umwandeln eines STL/CLR-Containers in eine .NET-Auflistung](how-to-convert-from-a-stl-clr-container-to-a-dotnet-collection.md)
### [Gewusst wie: Einen STL/CLR-Container einer Assembly verfügbar machen](how-to-expose-an-stl-clr-container-from-an-assembly.md)
...
#### [Eine STL-Auflistung mit der for-each-Klausel durchlaufen](iterating-over-stl-collection-by-using-for-each.md)
#### [Gewusst wie: Durchlaufen von Arrays mit der for-each-Klausel](how-to-iterate-over-arrays-with-for-each.md)
#### [Gewusst wie: Durchlaufen einer generischen Auflistung mit der for-each-Klausel](how-to-iterate-over-a-generic-collection-with-for-each.md)
#### [Gewusst wie: Durchlaufen einer benutzerdefinierten Auflistung mit der for-each-Klausel](how-to-iterate-over-a-user-defined-collection-with-for-each.md)
...
## [C++-Unterstützungsbibliothek](cpp-support-library.md)
### [Übersicht über das Marshaling in C++](overview-of-marshaling-in-cpp.md)
...
###### [auto_handle-Member](auto-handle-members.md)
...
### [finally](finally.md)
### [Gewusst wie: Abfangen von Ausnahmen, die von der MSIL ausgelöst wurden, in systemeigenem Code](how-to-catch-exceptions-in-native-code-thrown-from-msil.md)
### [Gewusst wie: Definieren und Installieren eines globalen Ausnahmehandlers](how-to-define-and-install-a-global-exception-handler.md)
## [Boxing (C++/CLI)](boxing-cpp-cli.md)
### [Gewusst wie: Explizites Anfordern von Boxing](how-to-explicitly-request-boxing.md)
### [Gewusst wie: Verwenden von gcnew zum Erstellen von Werttypen und für implizites Boxing](how-to-use-gcnew-to-create-value-types-and-use-implicit-boxing.md)
### [Gewusst wie: Unboxing](how-to-unbox.md)
