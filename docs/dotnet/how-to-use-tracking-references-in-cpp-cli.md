---
title: 'Vorgehensweise: Verwenden von Nachverfolgungsverweisen in C++ / CLI | Microsoft-Dokumentation'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
Das nächste Beispiel zeigt, dass die Verwendung der Adresse einer nachverfolgungsverweisvariablen gibt ein [Interior_ptr (C++ / CLI)](../windows/interior-ptr-cpp-cli.md), ändern und den Datenzugriff über ein Nachverfolgungsverweis veranschaulicht.
