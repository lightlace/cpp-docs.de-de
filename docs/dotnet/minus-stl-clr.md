...
Die Vorlagenklasse beschreibt ein Funktionselement, die, wenn sie aufgerufen wird, das erste Argument minus des zweiten zurückgibt.  Sie verwenden sie angeben einem Funktionsobjekt hinsichtlich den Argumenttyp.  
...
## Hinweise  
 Die Vorlagenklasse beschreibt ein ZweiArgumentfunktionselement.  Sie definiert den Memberoperator, `operator()`, wenn das Objekt als Funktion aufgerufen wird, dem ersten Argument minus des zweiten zurückgibt.  
