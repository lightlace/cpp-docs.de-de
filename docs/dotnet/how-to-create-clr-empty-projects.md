---
title: 'Vorgehensweise: Erstellen von leeren CLR-Projekten | Microsoft-Dokumentation'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
1. Klicken Sie unter **installierte Vorlagen**, klicken Sie auf die **Visual C++** Knotens klicken Sie dann auf die **CLR** Knoten. Wählen Sie die **leeres CLR-Projekt** Symbol.

1. Geben Sie im Feld **Name** einen eindeutigen Namen für die Anwendung ein.

    > [!NOTE]
    >  Sie können auch angeben, andere Projekt- und Projektmappendateien Einstellungen aus der **neues Projekt** (Dialogfeld), aber diese Einstellungen sind nicht erforderlich.
