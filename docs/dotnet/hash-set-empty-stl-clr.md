...
## Hinweise  
 Die Memberfunktionsrückgaben true für eine leere gesteuerte Sequenz.  Er besteht darin [hash\_set::size](../dotnet/hash-set-size-stl-clr.md)`() == 0`.  Sie verwenden sie, um zu testen, ob das hash\_set leer ist.  
