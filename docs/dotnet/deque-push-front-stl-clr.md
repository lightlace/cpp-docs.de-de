...
## Hinweise  
 Die Memberfunktion wird ein Element mit dem Wert `val` zu Anfang der gesteuerten Sequenz.  Sie verwenden sie, um ein weiteres Element zur Doppelschlange voranzustellen.  
