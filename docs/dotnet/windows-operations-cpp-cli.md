---
title: Windows-Vorgänge (C++ / CLI) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
## <a name="see-also"></a>Siehe auch  
 ...
 [Einführung in die Überwachung der Leistung](https://msdn.microsoft.com/d40f10b9-e2b7-4ec8-a9b3-706929e5bf35) 