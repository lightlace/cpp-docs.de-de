---
title: "C++-Unterstützungsbibliothek | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Der C++-Standardbibliothek unterstützen enthält Klassen, die verwaltete Programmierung in C++ zu unterstützen.  
