---
title: 'Vorgehensweise: Zugreifen auf Zeichen in einem System:: String | Microsoft-Dokumentation'
...
Betrachten Sie folgenden Code.  Anheften von Zertifikaten ist nicht erforderlich, da `ppchar` ein innerer Zeiger ist, und wenn der Garbage Collector die Zeichenfolge das Objekt zeigt verschiebt auf, auch aktualisiert `ppchar`. Ohne eine [Pin_ptr (C++ / CLI)](../windows/pin-ptr-cpp-cli.md), funktioniert der Code, und haben nicht die potenziellen Leistungseinbußen durch Anheften von verursacht.
