...
## Hinweise  
 Die Memberfunktionsrückgaben true für eine leere gesteuerte Sequenz.  Es ist zu [hash\_multimap::size](../dotnet/hash-multimap-size-stl-clr.md)`() == 0`.  Sie verwenden sie, um zu testen, ob das hash\_multimap leer ist.  
