...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "set_difference-Funktion [STL/CLR]"
...
## Hinweise  
 Diese Funktion verhält sich genauso wie die STL\-Funktion `set_difference`.  Weitere Informationen finden Sie unter [set\_difference](../Topic/set_difference.md).  
