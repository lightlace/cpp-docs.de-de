---
title: "Gewusst wie: Branding eines VSPackage (C++)"
ms.custom: na
ms.date: "12/15/2016"
...
Um im Dialogfeld **Hilfe zu** und im Begrüßungsbildschirm angezeigt wird, muss die VSPackages <xref:Microsoft.VisualStudio.Shell.Interop.IVsInstalledProduct>\-Schnittstelle implementieren.  Auf diese Weise werden die folgenden Informationen an [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)]bereit:  
