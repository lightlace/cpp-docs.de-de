...
Es tut uns leid, aber wir haben keine spezifischen Informationen zu diesem Fehler.  Sie können für die Fehler\-Nummer und \-Nachricht nach Informationen im Web suchen.  Oder Sie können andere Entwickler, die eines der folgenden Foren nutzen, Fragen stellen:  
 ...
 Bietet ein Forum für Fragen und allgemeine Diskussionen zu [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)]\-Sprachsyntax und \-Compiler.  
  
 [Visual Basic\-Interop und \-Upgrade](http://go.microsoft.com/fwlink/?LinkId=145966)  
 Bietet ein Forum für Fragen und Probleme beim Aktualisieren auf [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] und für die Arbeit mit Interoperabilitätsfunktionen.  
  
 [Visual Basic\-IDE](http://go.microsoft.com/fwlink/?LinkId=145971)  
 Bietet ein Forum für Fragen zum Arbeiten in der [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)]\-Umgebung.  
  
 [Visual Basic – Allgemein](http://go.microsoft.com/fwlink/?LinkId=145973)  
 Bietet ein Forum für Fragen und Probleme in Bezug auf [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)], die in anderen Foren nicht diskutiert werden.  
  
 [StackOverflow](http://stackoverflow.com/questions/tagged/vb.net)  
 Bietet ein Forum für Fragen und Probleme in Bezug auf [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)].  
