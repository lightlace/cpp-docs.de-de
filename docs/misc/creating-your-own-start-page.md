---
title: "Erstellen einer eigenen Startseite"
ms.custom: na
ms.date: "11/17/2016"
...
4.  Entfernen Sie alle Hilfsdateien, die Sie nicht benötigen.  
 ...
 Alternativ können Sie eine leere Startseite erstellen, indem Sie eine XAML\-Datei mit der korrekten, von Visual Studio zu erkennenden Tagstruktur erstellen. Sie können dann Markup und CodeBehind hinzufügen, um die gewünschte Darstellung und die erforderlichen Funktionen zu erhalten. Weitere Informationen finden Sie unter [Erstellen einer benutzerdefinierten Startseite](../Topic/Creating%20a%20Custom%20Start%20Page.md).  
