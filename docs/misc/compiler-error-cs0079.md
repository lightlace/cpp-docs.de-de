...
Das Ereignis "Ereignis" kann nur links von \+\= oder \-\= verwendet werden  
 ...
 Ein [Ereignis](../Topic/event%20\(C%23%20Reference\).md) wurde falsch aufgerufen. Weitere Informationen finden Sie unter [Ereignisse](../Topic/Events%20\(C%23%20Programming%20Guide\).md) und [Delegaten](../Topic/Delegates%20\(C%23%20Programming%20Guide\).md).  
