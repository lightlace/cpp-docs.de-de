---
title: "Problembehandlung bei Ausnahmen: System.Net.WebException"
ms.custom: na
ms.date: "12/15/2016"
 ...
 **Überprüfen Sie die Response\-Eigenschaft der Ausnahme, um zu bestimmen, warum die Anforderung nicht ausgeführt werden konnte.**  
 Wenn eine <xref:System.Net.WebException>\-Ausnahme durch eine Ableitung der <xref:System.Net.WebRequest>\-Klasse ausgelöst wird, stellt die <xref:System.Net.WebException.Response*>\-Eigenschaft die Internetantwort für die Anwendung bereit.  
  
 **Überprüfen Sie die Status\-Eigenschaft, um zu bestimmen, warum die Anforderung nicht ausgeführt werden konnte.**  
 Die <xref:System.Net.WebException.Status*>\-Eigenschaft der Ausnahme enthält Statusinformationen für den Fehler. Weitere Informationen finden Sie unter <xref:System.Net.WebExceptionStatus>.  
 ...
 **Wenn Sie bei der schrittweisen Ausführung eines XML\-Webdiensts das Zeitlimit überschreiten, legen Sie den Timeoutwert für den XML\-Webdienstaufruf auf unendlich fest.**  
 Weitere Informationen finden Sie unter [Fehler: Timeout während des Debuggens von Webdiensten](../Topic/Error:%20Timeout%20While%20Debugging%20Web%20Services.md).  
