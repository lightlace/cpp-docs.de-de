...
Verzeichnis nicht gefunden.  
 ...
 Diese Warnung kann ausgegeben werden, wenn Sie mithilfe der **CodeAnalysisDependentAssemblyPaths**\-Eigenschaft von [!INCLUDE[vstecmsbuild](../build/includes/vstecmsbuild_md.md)] zusätzliche Verweisassemblysuchpfade angeben und einer der Pfade nicht vorhanden ist.  
