 ...
 *Projektordner*\\obj\\`configname`\\temppe  
 ...
 outputdir  
 Das von der **OutputPath**\-Eigenschaft angegebene Verzeichnis.  Weitere Informationen finden Sie unter [Seite "Erstellen", Projekt\-Designer \(C\#\)](../Topic/Build%20Page,%20Project%20Designer%20\(C%23\).md).  
