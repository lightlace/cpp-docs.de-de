---
title: "Problembehandlung bei Ausnahmen: System.IO.FileNotFoundException"
ms.custom: na
ms.date: "10/29/2016"
 ...
 **Stellen Sie sicher, dass die Datei am angegebenen Speicherort vorhanden ist.**  
 Wenn die Datei nicht vorhanden ist, wird diese Ausnahme ausgelöst. Weitere Informationen finden Sie unter <xref:Microsoft.VisualBasic.FileIO.FileSystem.FileExists*>.  
