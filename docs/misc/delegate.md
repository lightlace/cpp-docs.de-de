...
---
# __delegate
**Hinweis** Dieses Thema gilt nur für Version 1 von Managed Extensions für C\+\+. Diese Syntax sollte nur verwendet werden, um Code von Version 1 beizubehalten. Finden Sie unter [delegate](../windows/delegate-cpp-component-extensions.md) Informationen zur Verwendung der entsprechenden Funktionalität in der neuen Syntax.  
