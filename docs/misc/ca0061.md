...
## CodeAnalysisRules\-Eigenschaft in MSBuild  
 In der Codeanalyse von [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)] können mit der CodeAnalysisRules\-Eigenschaft von MSBuild Regeln im folgenden Format angegeben werden:  
