---
title: "&#39;&lt;Typname&gt;&#39; kann nicht von einem in ihr bzw. ihm geschachtelten Typ erben."
ms.custom: na
ms.date: "12/15/2016"
...
Die Definition einer Klasse oder Schnittstelle enthält eine [Inherits Statement](../Topic/Inherits%20Statement.md), die einen Typ angibt, der in ihr geschachtelt ist.  
 ...
 Eine verwandte Einschränkung ist, dass ein Typ nicht von einem Typ erben kann, der noch nicht definiert wurde. Ein Merkmal von Vererbung ist die Fähigkeit, Member der Basisklasse wiederzuverwenden. Dies setzt wiederum voraus, dass diese Member definiert sind. Aus diesem Grund kann [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] keinen Code wie im folgenden Beispiel kompilieren.  
...
-   Wenn der innere Typ im äußeren Typ geschachtelt sein muss, kann der äußere Typ nicht von ihm erben. Entfernen Sie die [Inherits Statement](../Topic/Inherits%20Statement.md).  
