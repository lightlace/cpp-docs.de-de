...
3.  Fügen Sie für [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] der Liste der importierten Namespaces im generierten Projekt die folgenden Namespaces hinzu:  
