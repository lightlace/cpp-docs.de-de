---
title: "Problembehandlung bei Ausnahmen: System.IndexOutOfRangeException"
ms.custom: na
ms.date: "11/16/2016"
 ...
 **Stellen Sie sicher, dass die Spaltennamen richtig sind.**  
 Diese Ausnahme wird möglicherweise ausgelöst, wenn ein ungültiger Datenspaltenname an die <xref:System.Data.DataView.Sort*?displayProperty=fullName>\-Eigenschaft übergeben wird. Weitere Informationen finden Sie in den Ausführungen zur <xref:System.Data.DataView>\-Klasse.  
