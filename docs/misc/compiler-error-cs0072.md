...
'ereignis': Überschreiben nicht möglich; 'methode' ist kein Ereignis  
 ...
 Ein [Ereignis](../Topic/event%20\(C%23%20Reference\).md) kann nur ein anderes Ereignis überschreiben. Weitere Informationen finden Sie unter [Ereignisse](../Topic/Events%20\(C%23%20Programming%20Guide\).md).  
