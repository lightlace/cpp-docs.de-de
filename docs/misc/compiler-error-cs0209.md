...
Der Typ einer in einer fixed\-Anweisung deklarierten lokalen Variablen muss ein Zeigertyp sein.  
 ...
 Die in einer [fixed\-Anweisung](../Topic/fixed%20Statement%20\(C%23%20Reference\).md) deklarierte lokale Variable muss ein Zeiger sein. Weitere Informationen finden Sie unter [Unsicherer Code und Zeiger](../Topic/Unsafe%20Code%20and%20Pointers%20\(C%23%20Programming%20Guide\).md).  
