...
-   Starten Sie [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)] neu.  Wenn es immer noch nicht funktioniert, wenden Sie sich mit diesem Problem an den Microsoft\-Produktsupport.  
