---
title: "Abrufen von Feldbeschreibungen im Eigenschaftenfenster"
ms.custom: na
ms.date: "11/17/2016"
...
```  
 ...
 Eine weitere Möglichkeit zum Abrufen des lokalisierten Namens und der lokalisierten Beschreibung einer Eigenschaft besteht darin, <xref:Microsoft.VisualStudio.Shell.Interop.IVsPerPropertyBrowsing.GetLocalizedPropertyInfo*> zu implementieren. Weitere Informationen über die Implementierung dieser Methode finden Sie unter [Eigenschaften\-Fenster Felder und Schnittstellen](../Topic/Properties%20Window%20Fields%20and%20Interfaces.md).  
