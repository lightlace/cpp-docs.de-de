...
"function1" implementiert den geerbten abstrakten Member "function2" nicht  
 ...
 Eine Klasse ist erforderlich, um alle [abstrakten](../Topic/abstract%20\(C%23%20Reference\).md) Member in der Basisklasse zu implementieren, es sei denn, die Klasse ist auch abstrakt.  
