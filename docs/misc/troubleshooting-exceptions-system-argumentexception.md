---
title: "Problembehandlung bei Ausnahmen: System.ArgumentException"
ms.custom: na
ms.date: "10/29/2016"
...
```  
 ...
 Weitere Informationen über diese Ausnahme sowie Beispiele in anderen Sprachen finden Sie unter <xref:System.ArgumentException>. Eine Liste mit weiteren Konstruktoren finden Sie unter <xref:System.ArgumentException.#ctor*>.  
