...
Eine Typparameterdeklaration enthält mindestens ein Typkennzeichen.  
 ...
 Ein Typparameter eines generischen Typs muss ein gültiger Visual Basic\-Name sein. Die Typkennzeichen \(`%`, `&`, `@`, `!`, `#` und `$`\) sind keine zulässigen Zeichen. Siehe [Declared Element Names](../Topic/Declared%20Element%20Names%20\(Visual%20Basic\).md).  
