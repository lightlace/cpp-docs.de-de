---
title: "Erweitern von Toolfenstern"
ms.custom: na
ms.date: "11/17/2016"
...
## Grundlegendes zu Toolfenstern  
 Wenn Sie ein Toolfenster bereitstellen möchten, müssen Sie es mit Visual Studio registrieren und sein Standardformat sowie den Speicherort angeben. Weitere Informationen finden Sie unter [Toolfenster in der Registrierung](../Topic/Tool%20Windows%20in%20the%20Registry.md).  
 ...
 Toolfensterbereiche können WPF\-Benutzersteuerelemente hosten und Symbolleisten unterstützen. Sie können die <xref:Microsoft.VisualStudio.Shell.WindowPane.Window*>\-Eigenschaft außer Kraft setzen, um das Handle des gehosteten Steuerelements zurückzugeben.  
  
 Toolfenster können *dynamisch* sein \(auch als *automatisch sichtbar* bezeichnet\). Dynamische Toolfenster werden angezeigt, wenn ihr zugehöriger Benutzeroberflächenkontext gilt. Die Verwendung der automatischen Sichtbarkeit kann die Übersichtlichkeit hinsichtlich der Fenster in der IDE verbessern. Weitere Informationen finden Sie unter [Öffnen ein dynamisches Tool\-Fenster](../Topic/Opening%20a%20Dynamic%20Tool%20Window.md).  
...
## Siehe auch  
 ...
 [Dokumentfenster](../Topic/Document%20Windows.md)   
 [Hinzufügen von Suchfunktionen zu einem Toolfenster](../Topic/Adding%20Search%20to%20a%20Tool%20Window.md)