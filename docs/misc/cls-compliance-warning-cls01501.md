---
title: "CLS-Kompatibilit&#228;t: Warnung CLS01501"
ms.custom: na
ms.date: "11/16/2016"
...
```  
 ...
 Sie können CLS01501 auflösen, indem Sie ein Parameterarray verwenden.  Weitere Informationen finden Sie unter [Variable Argument Lists \(...\) \(C\+\+\/CLI\)](../windows/variable-argument-lists-dot-dot-dot-cpp-cli.md).