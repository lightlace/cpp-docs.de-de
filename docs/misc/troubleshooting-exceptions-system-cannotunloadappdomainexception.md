---
title: "Problembehandlung bei Ausnahmen: System.CannotUnloadAppDomainException"
ms.custom: na
ms.date: "10/29/2016"
 ...
 **Stellen Sie sicher, dass die Anwendungsdomäne, die Sie entladen möchten, nicht die Standardanwendungsdomäne ist, nicht über einen laufenden Thread verfügt oder nicht schon entladen wurde.**  
 Die Ausnahme wird ausgelöst, sofern eine dieser Bedingungen erfüllt ist. Weitere Informationen finden Sie unter <xref:System.AppDomain.Unload*>.  
