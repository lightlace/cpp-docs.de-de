...
'Methode': Nicht alle Codepfade geben einen Wert zurück.  
 ...
 Eine Methode, die einen Wert zurückgibt, muss eine `return`\-Anweisung in allen Codepfaden enthalten. Weitere Informationen finden Sie unter [Methoden](../Topic/Methods%20\(C%23%20Programming%20Guide\).md).  
