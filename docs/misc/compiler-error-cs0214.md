...
Zeiger und Puffer fester Größe können nur in einem unsicheren Kontext verwendet werden.  
 ...
 Zeiger können nur mit dem [unsafe](../Topic/unsafe%20\(C%23%20Reference\).md)\-Schlüsselwort verwendet werden. Weitere Informationen finden Sie unter [Unsicherer Code und Zeiger](../Topic/Unsafe%20Code%20and%20Pointers%20\(C%23%20Programming%20Guide\).md).  
