---
title: "Umbenennen von Knoten in der Projekthierarchie (C++)"
ms.custom: na
ms.date: "11/16/2016"
...
Sie können einen Projektordner Knoten hierarchien umbenennen, indem Sie das Framework für HierUtil7 des Projekts nicht verwaltetes C\+\+ verwenden.  Weitere Informationen finden Sie unter [HierUtil7 Sample](assetId:///29c15184-a70c-4813-86c2-fb1d47442d11).  
...
2.  Benennen Sie den Ordner, indem Sie den Befehl Umbenennen verwenden, indem Sie <xref:Microsoft.VisualStudio.Shell.Interop.IVsUIShell.PostExecCommand*>senden  
...
## Siehe auch  
 [Erstellen von Projekttypen](../Topic/Creating%20Project%20Types.md)   
