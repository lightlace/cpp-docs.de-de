---
title: Verteilen von Datenbankunterstützungsdateien | Microsoft-Dokumentation
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-ide
...
## <a name="installing-dao-support-files"></a>Installieren von DAO-Unterstützungsdateien  
 Die neueste Version von DAO finden Sie unter [Article 239114: How to obtain the latest service pack for the Microsoft Jet 4.0 Database Engine (Artikel 239114: Verfügbarkeit des aktuellen Service Pack für die Microsoft Jet 4.0-Datenbank-Engine)](http://go.microsoft.com/fwlink/p/?linkid=198014) auf der Microsoft Support-Website.  
