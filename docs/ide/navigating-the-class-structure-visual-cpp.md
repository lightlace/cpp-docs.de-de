...
ms.locfileid: "33330232"
---
# <a name="navigating-the-class-structure-visual-c"></a>Navigieren in der Klassenstruktur (Visual C++)
Mithilfe der [Klassenansicht](http://msdn.microsoft.com/en-us/8d7430a9-3e33-454c-a9e1-a85e3d2db925) oder dem [Objektkatalog](http://msdn.microsoft.com/en-us/f89acfc5-1152-413d-9f56-3dc16e3f0470) können Sie in der Projektklassenstruktur und den enthaltenen Funktionen, Vererbungen und Schnittstellen navigieren.  
