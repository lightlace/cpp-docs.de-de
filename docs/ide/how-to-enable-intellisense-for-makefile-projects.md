---
title: 'Vorgehensweise: Aktivieren von IntelliSense für Makefile-Projekte | Microsoft-Dokumentation'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-ide
...
3.  Wählen Sie die Eigenschaftenseite **NMake** aus, und ändern Sie dann die Eigenschaften unter **IntelliSense** nach Bedarf.  
...
5.  Verwenden Sie den Befehl **Alle speichern**, um die geänderten Projekteinstellungen zu speichern.  
