...
3.  Um die Anwendung bereitzustellen, müssen Sie die DLL an einer geeigneten Stelle platzieren. Folgende Möglichkeiten stehen zur Auswahl:  
    ...
    3.  In der parallelen Assembly. Weitere Informationen finden Sie unter [Building C/C++ Side-by-side Assemblies (Erstellen von parallelen C/C++-Assemblys)](../build/building-c-cpp-side-by-side-assemblies.md).  
