...
# [Schreiben und Umgestalten von Code (C++)](writing-and-refactoring-code-cpp.md)
# [Visual C++-Tools und -Vorlagen in Visual Studio-Editionen](visual-cpp-tools-and-templates-in-visual-studio-editions.md)
...
### [Erstellen eines benutzerdefinierten Assistenten](creating-a-custom-wizard.md)
#### [Benutzerdefinierter Assistent](custom-wizard.md)
##### [Anwendungseinstellungen, Benutzerdefinierter Assistent](application-settings-custom-wizard.md)
### [Entwerfen eines Assistenten](designing-a-wizard.md)
#### [Schritte zum Entwerfen eines Assistenten](steps-to-designing-a-wizard.md)
##### [Untersuchen des grundlegenden Assistentenprojekts](examining-the-basic-wizard-project.md)
##### [Untersuchen der Mechanismen eines Assistenten](examining-the-mechanics-of-a-wizard.md)
##### [Anpassen des Assistenten](customizing-your-wizard.md)
##### [Lokalisieren eines Assistenten in mehrere Sprachen](localizing-a-wizard-to-multiple-languages.md)
##### [Bereitstellen kontextbezogener Hilfe](providing-context-sensitive-help.md)
#### [Für den Assistenten erstellte Dateien](files-created-for-your-wizard.md)
##### [VSZ-Datei (Projektsteuerung)](dot-vsz-file-project-control.md)
###### [Benutzerdefinierte Parameter in der VSZ-Assistentendatei](custom-parameters-in-the-wizard-dot-vsz-file.md)
##### [HTML-Dateien](html-files.md)
##### [Vorlagendateien](template-files.md)
###### [INF-Vorlagendatei](templates-inf-file.md)
###### [Vorlagendirektiven](template-directives.md)
##### [JScript-Datei](jscript-file.md)
###### [Anpassen von C++-Assistenten mit allgemeinen JScript-Funktionen](customizing-cpp-wizards-with-common-jscript-functions.md)
####### [JScript-Funktionen für C++-Assistenten](jscript-functions-for-cpp-wizards.md)
...
#### [Behandeln von Fehlern in Assistenten](handling-errors-in-wizards.md)
##### [Fehlerbehandlung in HTML-Assistentendateien](error-handling-in-wizard-html-files.md)
##### [Fehlerbehandlung in JScript-Assistentendateien](error-handling-in-wizard-jscript-files.md)
...
#### [Gewusst wie: Aktivieren von IntelliSense für Makefile-Projekte](how-to-enable-intellisense-for-makefile-projects.md)
...
#### [Eigenschaftenseiten des Manifesttools](manifest-tool-property-pages.md)
...
## [Gewusst wie: Organisieren von Projektausgabedateien für Builds](how-to-organize-project-output-files-for-builds.md)
# [Bereitstellen von systemeigenen Desktopanwendungen (Visual C++)](deploying-native-desktop-applications-visual-cpp.md)
...
### [Verteilen der MFC-Bibliothek](redistributing-the-mfc-library.md)
### [Verteilen von ATL-Anwendungen](redistributing-an-atl-application.md)
...
## [ClickOnce-Bereitstellung für Visual C++-Anwendungen](clickonce-deployment-for-visual-cpp-applications.md)
...
## [Makros für Buildbefehle und -eigenschaften](common-macros-for-build-commands-and-properties.md)
