...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - ".NET Framework (C++), Verweise hinzufügen (Dialogfeld)"
  - "Verweise hinzufügen (Dialogfeld) [C++]"
...
manager: "ghogen"
---
# Hinzuf&#252;gen von Verweisen in Visual C++-Projekten
...
Es kommt bei Programmen sehr häufig vor, dass in anderen Binärdateien \(z. B. DLL\-Dateien, Windows\-Runtime\-Komponenten, SDK\-Erweiterungen, COM\-Komponenten und .NET\-Assemblys\) APIs aufgerufen werden. Die Methode, mit der Ihr Programm diese anderen Binärdateien findet, hängt sowohl vom Projekttyp als auch vom Typ der Binärdatei ab.  
 ...
 ![Visual C&#43;&#43;&#45;Verweis&#45;Manager &#40;ATL&#45;Projekte&#41;](../Image/Visual%20C++%20Reference%20Manager%20\(ATL%20Projects\).png "Visual C\+\+ Reference Manager \(ATL Projects\)")  
  
 In einem C\+\+\/CLI\- oder UWP\-Projekt \(universelle Windows\-Plattform\) gilt das Konzept der Verweise zusätzlich zu anderen Projekten in der Projektmappe für verschiedene Arten von Binärdateien.  Diese werden alle im **Verweis\-Manager** verfügbar gemacht:  
  
 ![Visual C&#43;&#43;&#45;Verweis&#45;Manager für C&#43;&#43;&#47;CLI&#45;Projekte](../Image/Visual%20C++%20Reference%20Manager%20for%20C++/CLI%20projects.png "Visual C\+\+ Reference Manager for C\+\+\/CLI projects")  
...
### Assemblyverweiseigenschaften  
 Assemblyverweiseigenschaften sind nur für Verweise auf [!INCLUDE[dnprdnshort](../error-messages/tool-errors/includes/dnprdnshort_md.md)]\-Assemblys in C\+\+\-\/CLI\-Projekten verfügbar. Diese Eigenschaften werden nur angezeigt, wenn eine [!INCLUDE[dnprdnshort](../error-messages/tool-errors/includes/dnprdnshort_md.md)]\-Assembly im Bereich **Verweise** ausgewählt ist. Die Eigenschaften können nicht geändert werden.  
...
### Interprojektverweiseigenschaften  
 Die folgenden Eigenschaften definieren einen *Verweis zwischen Projekten* von dem im Bereich **Verweise** ausgewählten Projekt auf ein anderes Projekt in derselben Projektmappe. Weitere Informationen finden Sie unter [Verwalten von Verweisen in einem Projekt](../Topic/Managing%20references%20in%20a%20project.md).  
 ...
 **Identity**  
 Für die [!INCLUDE[dnprdnshort](../error-messages/tool-errors/includes/dnprdnshort_md.md)]\-Assemblys wird der vollständige Pfad angezeigt. Zeigt die GUID für COM\-Komponenten an.  
