...
# [Erstellen und Verwalten von Visual C++-Projekten](creating-and-managing-visual-cpp-projects.md)

## [Visual C++-Projekttypen](visual-cpp-project-types.md)

## [Verwenden von Vorlagen zum Hinzufügen neuer Elemente in Visual C++](using-visual-cpp-add-new-item-templates.md)
