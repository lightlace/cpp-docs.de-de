...
**Wichtig:** bei Auswahl eine .vcxproj-Datei manuell bearbeiten, werden folgende Aspekte berücksichtigen:
1. Die Struktur der Datei muss eine vorgeschriebenen Form folgen, die in diesem Artikel beschrieben wird.
2. Das Visual C++-Projektsystem unterstützt derzeit keine Platzhalter in Projektelementen. Dies wird z. B. nicht unterstützt:
```xml
<ClCompile Include="*.cpp"/>
```
3. Das Visual C++-Projektsystem unterstützt derzeit nicht Makros in Project Item Pfaden. Dies wird z. B. nicht unterstützt:
```xml
<ClCompile Include="$(IntDir)\generated.cpp"/>
```
4. Um Projekteigenschaften ordnungsgemäß hinzugefügt, entfernt oder geändert werden, wenn im bearbeitet haben die **Projekteigenschaften** im Dialogfeld die Datei muss getrennte Gruppen für jede Projektkonfiguration enthalten, und die Bedingungen in dieser Form sein:

```xml
Condition=”'$(Configuration)|$(Platform)'=='Debug|Win32'”
```
 
5. Jede Eigenschaft muss in der Gruppe mit den richtigen Bezeichnung, entsprechend den Angaben in der Regel Eigenschaftendatei angegeben werden. Weitere Informationen finden Sie unter [Seite XML-Regel Eigenschaftendateien] (https://review.docs.microsoft.com/en-us/cpp/ide/property-page-xml-files). 
...
```
 ...
 Der folgende Abschnitt beschreibt den Zweck jedes dieser Elemente und warum sie auf diese Weise angeordnet sind:
...
Sie können den Build deaktivieren und Befehle für jede Konfiguration im Projektmappen-Konfigurations-Manager bereitstellen.
...
Die Metadaten müssen Configuration Bedingungen für jede Konfiguration auf, selbst wenn Theyare dieselben. Zum Beispiel:
...
[Eigenschaft Seite XML-Dateien](property-page-xml-files.md)