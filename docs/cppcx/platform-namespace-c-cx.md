---
title: "Plattformnamespace (C++/CX) | Microsoft Docs"
ms.custom: ""
ms.date: "12/30/2016"
...
## Mitglieder  
 Der Namespace "Platform" erbt von der IUnknown\-Schnittstelle, hat jedoch keine zusätzlichen Member.  
...
|[Platform::FailureException\-Klasse](../cppcx/platform-failureexception-class.md)|Wird ausgelöst, wenn bei dem Vorgang ein Fehler aufgetreten ist. Dies entspricht dem E\_FAIL HRESULT.|  
