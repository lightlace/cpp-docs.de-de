...
Windows-Runtime unterstützt universelle Windows-Plattform-apps, die nur in einer vertrauenswürdigen betriebssystemumgebung ausgeführt und verwenden autorisierte Funktionen, Datentypen und Geräte verteilt werden, über die [!INCLUDE[win8_appstore_long](../cppcx/includes/win8-appstore-long-md.md)]. Die C + c++ / CX vereinfachen die Verfassung von apps für Windows-Runtime. Dieser Artikel ist eine Kurzübersicht; umfassendere Dokumentation finden Sie unter [Typsystem](../cppcx/type-system-c-cx.md) und [Komponentenerweiterungen für Laufzeitplattformen](http://go.microsoft.com/fwlink/?LinkId=228720).  
