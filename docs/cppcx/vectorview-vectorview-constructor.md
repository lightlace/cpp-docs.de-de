...
#### Parameter  
 ...
 `v`  
 Ein [Lvalues und Rvalues](../Topic/Lvalues%20and%20Rvalues%20\(Visual%20C++\).md) zu [::std::vector](../Topic/vector%20Class%201.md), der verwendet wird, um die aktuelle VectorView zu initialisieren.  
 ...
 `first`  
 Das erste Element in einer Sequenz von Objekten, die verwendet werden, um die aktuelle VectorView zu initialisieren. Der Typ von `first` wird mittels *perfekter Weiterleitung* übergeben. Weitere Informationen finden Sie unter [Rvalue\-Verweisdeklarator: &&](../Topic/Rvalue%20Reference%20Declarator:%20&&.md).  
  
 `last`  
 Das letzte Element in einer Sequenz von Objekten, die verwendet werden, um die aktuelle VectorView zu initialisieren. Der Typ von `last` wird mittels *perfekter Weiterleitung* übergeben. Weitere Informationen finden Sie unter [Rvalue\-Verweisdeklarator: &&](../Topic/Rvalue%20Reference%20Declarator:%20&&.md).  
