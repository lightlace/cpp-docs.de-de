...
Dies ist eine unvollständige Liste der Eigenschaften, dir in einem Linux Makefile-Projekt verfügbar sind. Viele Eigenschaften des MakeFile-Projekts sind identisch mit 
...
### <a name="pre-build-event"></a>Präbuildereignisse
...
Zusätzliche zu kopierende Dateien | Gibt zusätzliche Dateien an, die auf das Remotesystem kopiert werden sollen. Optional kann die Liste als Zuordnungspaare zwischen lokal und remote mit der folgenden Syntax bereitgestellt werden: fulllocalpath1:=fullremotepath1;fulllocalpath2:=fullremotepath2. Dabei kann eine lokale Datei an den angegebenen Remotespeicherort auf dem Remotesystem kopiert werden kann.

### <a name="post-build-event"></a>Postbuildereignisse
...
### <a name="remote-pre-build-event"></a>Remote-Präbuildereignisse
...
Die IntelliSense-Eigenschaften können auf Projekt- oder Dateiebene festgelegt werden, um Hinweise für das IntelliSense-Modul bereitzustellen. Sie wirken sich nicht auf die Kompilierung aus.
