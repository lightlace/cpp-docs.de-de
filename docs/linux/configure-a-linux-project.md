...
* **Zu kopierende Quellen** legt fest, welche Quellen auf den Remotecomputer kopiert werden.  Standardmäßig gilt **@(SourcesToCopyRemotely)** für alle Dateien im Projekt.
