...
In diesem Thema wird vorausgesetzt, dass Sie den Artikel [CMake projects in Visual Studio (CMake-Projekte in Visual Studio)](../build/cmake-projects-in-visual-studio.md) gelesen haben. 
