---
title: Automatische Parallelisierung und automatische Vektorisierung | Microsoft-Dokumentation
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-parallel
...
Ein Beispiel dafür, wie die Vektorisierung in der Praxis funktioniert, finden Sie unter [Austin-Projekt Teil 2 von 6: wenden von Seiten](http://blogs.msdn.com/b/vcblog/archive/2012/09/27/10348494.aspx)  
...
[/ Qvec-Report (Auto-Vektorisierer Berichtebene)](../build/reference/qvec-report-auto-vectorizer-reporting-level.md)   
