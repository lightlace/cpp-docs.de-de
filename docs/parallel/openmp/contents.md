...
[1. Einführung](../../parallel/openmp/1-introduction.md)  
 ...
 [Eine einfache Schleife parallel ausgeführten a. 1](../../parallel/openmp/a-1-executing-a-simple-loop-in-parallel.md)  
  
 [Angeben der bedingten Kompilierung a. 2](../../parallel/openmp/a-2-specifying-conditional-compilation.md)  
  
 [Verwenden von parallelen Bereichen a. 3](../../parallel/openmp/a-3-using-parallel-regions.md)  
  
 [A. 4 mit der Nowait-Klausel](../../parallel/openmp/a-4-using-the-nowait-clause.md)  
  
 [Die critical-Direktive mit a. 5](../../parallel/openmp/a-5-using-the-critical-directive.md)  
  
 [Lastprivate-Klausel mit a. 6](../../parallel/openmp/a-6-using-the-lastprivate-clause.md)  
  
 [A. 7 mithilfe der Reduction-Klausel](../../parallel/openmp/a-7-using-the-reduction-clause.md)  
  
 [Angeben von parallelen Abschnitten A.8](../../parallel/openmp/a-8-specifying-parallel-sections.md)  
  
 [Einzelne 9 Dokumentieren Using-Direktiven](../../parallel/openmp/a-9-using-single-directives.md)  
  
 [Angeben der sequenziellen Reihenfolge A.10](../../parallel/openmp/a-10-specifying-sequential-ordering.md)  
  
 [Festlegen einer festen Anzahl von Threads A.11](../../parallel/openmp/a-11-specifying-a-fixed-number-of-threads.md)  
  
 [A.12 mit atomic-Direktive](../../parallel/openmp/a-12-using-the-atomic-directive.md)  
  
 [A13 fallen mithilfe der flush-Direktive mit einer Liste](../../parallel/openmp/a-13-using-the-flush-directive-with-a-list.md)  
  
 [A14 mit ohne eine Liste der flush-Direktive](../../parallel/openmp/a-14-using-the-flush-directive-without-a-list.md)  
  
 [Bestimmen der Anzahl der verwendeten Threads A.15](../../parallel/openmp/a-15-determining-the-number-of-threads-used.md)  
  
 [A.16 Sperren](../../parallel/openmp/a-16-using-locks.md)  
  
 [A.17 Omp_nest_lock_t mit Sperren](../../parallel/openmp/a-17-using-nestable-locks.md)  
  
 [Geschachtelte for Direktiven A.18](../../parallel/openmp/a-18-nested-for-directives.md)  
  
 [A.19 Beispiele, falsche Schachtelung von Direktiven Freigeben von Arbeit](../../parallel/openmp/a-19-examples-showing-incorrect-nesting-of-work-sharing-directives.md)  
  
 [A.20 Bindung der Barriere-Direktiven](../../parallel/openmp/a-20-binding-of-barrier-directives.md)  
  
 [A.21 Bereichsdefinition von Variablen mit der private-Klausel](../../parallel/openmp/a-21-scoping-variables-with-the-private-clause.md)  
  
 [Mit der Klausel default(none) A.22](../../parallel/openmp/a-22-using-the-default-none-clause.md)  
  
 [A.23 Beispiele für die geordnete-Direktive](../../parallel/openmp/a-23-examples-of-the-ordered-directive.md)  
  
 [Beispiel für die private-Klausel A.24](../../parallel/openmp/a-24-example-of-the-private-clause.md)  
  
 [Beispiele für die A.25 der Copyprivate-Klausel Data-Attribut](../../parallel/openmp/a-25-examples-of-the-copyprivate-data-attribute-clause.md)  
  
 [A.26 mithilfe der Threadprivate-Direktive](../../parallel/openmp/a-26-using-the-threadprivate-directive.md)  
  
 [A.27 Verwendung von Arrays mit variabler Länge C99](../../parallel/openmp/a-27-use-of-c99-variable-length-arrays.md)  
  
 [A.28 Verwendung von Num_threads-Klausel](../../parallel/openmp/a-28-use-of-num-threads-clause.md)  
  
 [A.29 Verwendung der Arbeit Freigabe erstellt innerhalb einer critical-Konstrukt](../../parallel/openmp/a-29-use-of-work-sharing-constructs-inside-a-critical-construct.md)  
  
 [A.30 Verwendung von Reprivatization](../../parallel/openmp/a-30-use-of-reprivatization.md)  
