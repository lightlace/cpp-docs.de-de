...
Das folgende C++-Beispiel veranschaulicht, wie ein Array von Sperren in einem parallelen Bereich zu initialisieren, indem Sie mithilfe von [Omp_init_lock](3-run-time-library-functions.md#321-omp_init_lock-and-omp_init_nest_lock-functions).
