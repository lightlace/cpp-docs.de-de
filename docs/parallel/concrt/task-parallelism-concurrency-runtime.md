...
##  <a name="lambdas"></a>Verwenden von Lambdaausdrücken  
...
> [!TIP]
>  Ausführliche Informationen über Details, die bestimmte Aufgaben in [!INCLUDE[win8_appname_long](../../build/includes/win8_appname_long_md.md)] apps, finden Sie unter [asynchrone Programmierung in C++](http://msdn.microsoft.com/en-us/512700b7-7863-44cc-93a2-366938052f31) und [Erstellen von asynchronen Vorgängen in C++ für Windows Store-Apps](../../parallel/concrt/creating-asynchronous-operations-in-cpp-for-windows-store-apps.md).  
...
###  <a name="when-all"></a>Die Funktion "when_all"  
...
> `when_all` ist eine nicht blockierende Funktion, die `task` als Ergebnis erzeugt. Im Gegensatz zu [Task:: wait](reference/task-class.md#wait), es ist sicherer, rufen Sie diese Funktion in einer [!INCLUDE[win8_appname_long](../../build/includes/win8_appname_long_md.md)] app auf dem ASTA-(Application STA-) Thread.  

  
###  <a name="when-any"></a>Die Funktion "when_any"  
