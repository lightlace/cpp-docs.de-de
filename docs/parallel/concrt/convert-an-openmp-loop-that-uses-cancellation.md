---
title: 'Vorgehensweise: Konvertieren einer OpenMP-Schleife, die Abbruch verwendet wird, um die Verwendung der Concurrency Runtime | Microsoft-Dokumentation'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-concrt
