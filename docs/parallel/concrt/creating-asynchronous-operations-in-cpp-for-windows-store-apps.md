---
title: "Erstellen von asynchronen Vorgängen in C++ für Windows 8.x-Apps | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="creating-asynchronous-operations-in-c-for-windows-8x-apps"></a>Erstellen von asynchronen Vorgängen in C++ für Windows 8.x-Apps
...
##  <a name="create-async"></a> Erstellen von asynchronen Operationen  
 ...
 Windows-Runtime ist eine Programmierschnittstelle, die Sie verwenden können, erstellen [!INCLUDE[win8_appname_long](../../build/includes/win8_appname_long_md.md)] apps, die nur in einer bestimmten betriebssystemumgebung ausgeführt werden. Solche Apps verwenden autorisierte Funktionen, Datentypen und Geräte und werden über den [!INCLUDE[win8_appstore_long](../../build/reference/includes/win8_appstore_long_md.md)]vertrieben. Windows-Runtime wird dargestellt, indem die *Application Binary Interface* (ABI). Die ABI ist ein zugrunde liegender binärer Vertrag, der Windows-Runtime-APIs für Programmiersprachen wie Visual C++ verfügbar macht.  
