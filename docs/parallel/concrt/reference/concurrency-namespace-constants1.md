---
title: Concurrency-Namespace-Konstanten | Microsoft-Dokumentation
ms.custom: ''
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
Diese Kategorie von Ereignissen ist nicht aktuell von der Concurrency Runtime ausgelöst.
