...
|Name|BESCHREIBUNG|
|----------|-----------------|
|[concurrent_unordered_multiset](#ctor)|Ist überladen. Erstellt eine gleichzeitige ungeordnete Multimenge.|
...
|[insert](#insert)|Ist überladen. Fügt dem `concurrent_unordered_multiset`-Objekt Elemente hinzu.|
...
|[unsafe_erase](#unsafe_erase)|Ist überladen. Entfernt Elemente aus der `concurrent_unordered_multiset` an angegebenen Positionen. Diese Methode ist nicht nebenläufigkeitssicher.|

### <a name="public-operators"></a>Öffentliche Operatoren

|Name|BESCHREIBUNG|
|----------|-----------------|
|[operator=](#operator_eq)|Ist überladen. Weist den Inhalt eines anderen `concurrent_unordered_multiset`-Objekts diesem Objekt zu. Diese Methode ist nicht nebenläufigkeitssicher.|
