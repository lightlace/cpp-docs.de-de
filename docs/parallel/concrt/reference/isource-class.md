...
|Name|Beschreibung|  
|----------|-----------------|  
|[akzeptieren](#accept)|Ruft beim Überschreiben in einer abgeleiteten Klasse akzeptiert eine Meldung, die von diesem angebotenen wurde `ISource` -Block übertragen des Besitzes an den Aufrufer.|  
