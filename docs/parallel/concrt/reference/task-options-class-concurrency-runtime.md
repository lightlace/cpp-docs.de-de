---
title: Task_options-Klasse (Concurrency Runtime) | Microsoft Docs
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
##  <a name="get_cancellation_token">task_options:: get_cancellation_token-Methode (Concurrency Runtime)</a>  
...
##  <a name="get_scheduler">task_options:: get_scheduler-Methode (Concurrency Runtime)</a>  
...
##  <a name="has_cancellation_token">task_options:: has_cancellation_token-Methode (Concurrency Runtime)</a>  
...
##  <a name="has_scheduler">task_options:: has_scheduler-Methode (Concurrency Runtime)</a>  
...
##  <a name="set_cancellation_token">task_options:: set_cancellation_token-Methode (Concurrency Runtime)</a>  
...
##  <a name="set_continuation_context">task_options:: set_continuation_context-Methode (Concurrency Runtime)</a>  
