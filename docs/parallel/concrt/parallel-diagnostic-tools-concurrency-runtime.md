...
|[Concurrency::ConcRT_ProviderGuid](reference/concurrency-namespace-constants1.md#concrt_providerguid)| Die ETW-Anbieter-ID für die Concurrency Runtime. |`f7b697a3-4db5-4d3b-be71-c4d284e6592f`|  
...
|[Concurrency::VirtualProcessorEventGuid](reference/concurrency-namespace-constants1.md#virtualprocessoreventguid)| Ereignisse, die im Zusammenhang mit virtuellen Prozessoren markiert. |`2f27805f-1676-4ecc-96fa-7eb09d44302f`|  
