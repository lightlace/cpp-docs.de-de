...
### [Vorgehensweise: Verwenden von vorhandenem C++-Code in einer UWP-App (Universelle Windows-Plattform)](how-to-use-existing-cpp-code-in-a-universal-windows-platform-app.md)
